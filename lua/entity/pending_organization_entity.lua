...
local PendingOrganizationEntity = {}
PendingOrganizationEntity.__index = PendingOrganizationEntity


function PendingOrganizationEntity.new(client, entopts)
  entopts = entopts or {}
  ...
  local self = setmetatable({}, PendingOrganizationEntity)
  self._name = "pending_organization"
  self._client = client
...
function PendingOrganizationEntity:get_name()
  return self._name
end


function PendingOrganizationEntity:make()
  local opts = {}
  for k, v in pairs(self._entopts) do
    opts[k] = v
  end
  return PendingOrganizationEntity.new(self._client, opts)
end
...
function PendingOrganizationEntity:mark_deleted()
  self._deleted = true
end


function PendingOrganizationEntity:deleted()
  return true == self._deleted
end


function PendingOrganizationEntity:data_set(args)
  if args ~= nil then
...
function PendingOrganizationEntity:data_get()
  self._utility.feature_hook(self._entctx, "GetData")
  return vs.clone(self._data)
end


function PendingOrganizationEntity:match_set(args)
  if args ~= nil then
...
function PendingOrganizationEntity:match_get()
...
function PendingOrganizationEntity:stream(action, args, callopts)
...
---@param reqmatch PendingOrganizationListMatch
---@param ctrl? table
---@return PendingOrganization[]
---@return string? err
function PendingOrganizationEntity:list(reqmatch, ctrl)
  local utility = self._utility
...
function PendingOrganizationEntity:_run_op(ctx, post_done)
  local utility = self._utility
...
return PendingOrganizationEntity
