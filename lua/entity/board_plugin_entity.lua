...
local BoardPluginEntity = {}
BoardPluginEntity.__index = BoardPluginEntity


function BoardPluginEntity.new(client, entopts)
  entopts = entopts or {}
  ...
  local self = setmetatable({}, BoardPluginEntity)
  self._name = "board_plugin"
  self._client = client
...
function BoardPluginEntity:get_name()
  return self._name
end


function BoardPluginEntity:make()
  local opts = {}
  for k, v in pairs(self._entopts) do
    opts[k] = v
  end
  return BoardPluginEntity.new(self._client, opts)
end
...
function BoardPluginEntity:mark_deleted()
  self._deleted = true
end


function BoardPluginEntity:deleted()
  return true == self._deleted
end


function BoardPluginEntity:data_set(args)
  if args ~= nil then
...
function BoardPluginEntity:data_get()
  self._utility.feature_hook(self._entctx, "GetData")
  return vs.clone(self._data)
end


function BoardPluginEntity:match_set(args)
  if args ~= nil then
...
function BoardPluginEntity:match_get()
...
function BoardPluginEntity:stream(action, args, callopts)
...
---@param reqmatch BoardPluginRemoveMatch
---@param ctrl? table
---@return BoardPlugin
---@return string? err
function BoardPluginEntity:remove(reqmatch, ctrl)
  local utility = self._utility
...
function BoardPluginEntity:_run_op(ctx, post_done)
  local utility = self._utility
