...
local CustomBoardBackgroundEntity = {}
CustomBoardBackgroundEntity.__index = CustomBoardBackgroundEntity


function CustomBoardBackgroundEntity.new(client, entopts)
  entopts = entopts or {}
  ...
  local self = setmetatable({}, CustomBoardBackgroundEntity)
  self._name = "custom_board_background"
  self._client = client
...
function CustomBoardBackgroundEntity:get_name()
  return self._name
end


function CustomBoardBackgroundEntity:make()
  local opts = {}
  for k, v in pairs(self._entopts) do
    opts[k] = v
  end
  return CustomBoardBackgroundEntity.new(self._client, opts)
end
...
function CustomBoardBackgroundEntity:mark_deleted()
  self._deleted = true
end


function CustomBoardBackgroundEntity:deleted()
  return true == self._deleted
end


function CustomBoardBackgroundEntity:data_set(args)
  if args ~= nil then
...
function CustomBoardBackgroundEntity:data_get()
  self._utility.feature_hook(self._entctx, "GetData")
  return vs.clone(self._data)
end


function CustomBoardBackgroundEntity:match_set(args)
  if args ~= nil then
...
function CustomBoardBackgroundEntity:match_get()
...
function CustomBoardBackgroundEntity:stream(action, args, callopts)
...
---@param reqmatch CustomBoardBackgroundRemoveMatch
---@param ctrl? table
---@return CustomBoardBackground
---@return string? err
function CustomBoardBackgroundEntity:remove(reqmatch, ctrl)
  local utility = self._utility
...
function CustomBoardBackgroundEntity:_run_op(ctx, post_done)
  local utility = self._utility
...
return CustomBoardBackgroundEntity
