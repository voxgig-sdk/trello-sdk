...
local ApplicationComplianceEntity = {}
ApplicationComplianceEntity.__index = ApplicationComplianceEntity


function ApplicationComplianceEntity.new(client, entopts)
  entopts = entopts or {}
  ...
  local self = setmetatable({}, ApplicationComplianceEntity)
  self._name = "application_compliance"
  self._client = client
...
function ApplicationComplianceEntity:get_name()
  return self._name
end


function ApplicationComplianceEntity:make()
  local opts = {}
  for k, v in pairs(self._entopts) do
    opts[k] = v
  end
  return ApplicationComplianceEntity.new(self._client, opts)
end
...
function ApplicationComplianceEntity:mark_deleted()
  self._deleted = true
end


function ApplicationComplianceEntity:deleted()
  return true == self._deleted
end


function ApplicationComplianceEntity:data_set(args)
  if args ~= nil then
...
function ApplicationComplianceEntity:data_get()
  self._utility.feature_hook(self._entctx, "GetData")
  return vs.clone(self._data)
end


function ApplicationComplianceEntity:match_set(args)
  if args ~= nil then
...
function ApplicationComplianceEntity:match_get()
...
function ApplicationComplianceEntity:stream(action, args, callopts)
...
---@param reqmatch ApplicationComplianceLoadMatch
---@param ctrl? table
---@return ApplicationCompliance
---@return string? err
function ApplicationComplianceEntity:load(reqmatch, ctrl)
  local utility = self._utility
...
function ApplicationComplianceEntity:_run_op(ctx, post_done)
  local utility = self._utility
...
return ApplicationComplianceEntity
