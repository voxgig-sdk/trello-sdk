...
local ShowSidebarActivityEntity = {}
ShowSidebarActivityEntity.__index = ShowSidebarActivityEntity


function ShowSidebarActivityEntity.new(client, entopts)
  entopts = entopts or {}
  ...
  local self = setmetatable({}, ShowSidebarActivityEntity)
  self._name = "show_sidebar_activity"
  self._client = client
...
function ShowSidebarActivityEntity:get_name()
  return self._name
end


function ShowSidebarActivityEntity:make()
  local opts = {}
  for k, v in pairs(self._entopts) do
    opts[k] = v
  end
  return ShowSidebarActivityEntity.new(self._client, opts)
end
...
function ShowSidebarActivityEntity:mark_deleted()
  self._deleted = true
end


function ShowSidebarActivityEntity:deleted()
  return true == self._deleted
end


function ShowSidebarActivityEntity:data_set(args)
  if args ~= nil then
...
function ShowSidebarActivityEntity:data_get()
  self._utility.feature_hook(self._entctx, "GetData")
  return vs.clone(self._data)
end


function ShowSidebarActivityEntity:match_set(args)
  if args ~= nil then
...
function ShowSidebarActivityEntity:match_get()
...
function ShowSidebarActivityEntity:stream(action, args, callopts)
...
---@param reqdata ShowSidebarActivityUpdateData
---@param ctrl? table
---@return ShowSidebarActivity
---@return string? err
function ShowSidebarActivityEntity:update(reqdata, ctrl)
  local utility = self._utility
...
function ShowSidebarActivityEntity:_run_op(ctx, post_done)
  local utility = self._utility
...
return ShowSidebarActivityEntity
