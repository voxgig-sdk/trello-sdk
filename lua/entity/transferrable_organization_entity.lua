...
local TransferrableOrganizationEntity = {}
TransferrableOrganizationEntity.__index = TransferrableOrganizationEntity


function TransferrableOrganizationEntity.new(client, entopts)
  entopts = entopts or {}
  ...
  local self = setmetatable({}, TransferrableOrganizationEntity)
  self._name = "transferrable_organization"
  self._client = client
...
function TransferrableOrganizationEntity:get_name()
  return self._name
end


function TransferrableOrganizationEntity:make()
  local opts = {}
  for k, v in pairs(self._entopts) do
    opts[k] = v
  end
  return TransferrableOrganizationEntity.new(self._client, opts)
end
...
function TransferrableOrganizationEntity:mark_deleted()
  self._deleted = true
end


function TransferrableOrganizationEntity:deleted()
  return true == self._deleted
end


function TransferrableOrganizationEntity:data_set(args)
  if args ~= nil then
...
function TransferrableOrganizationEntity:data_get()
  self._utility.feature_hook(self._entctx, "GetData")
  return vs.clone(self._data)
end


function TransferrableOrganizationEntity:match_set(args)
  if args ~= nil then
...
function TransferrableOrganizationEntity:match_get()
...
function TransferrableOrganizationEntity:stream(action, args, callopts)
...
---@param reqmatch TransferrableOrganizationLoadMatch
---@param ctrl? table
---@return TransferrableOrganization
---@return string? err
function TransferrableOrganizationEntity:load(reqmatch, ctrl)
  local utility = self._utility
...
function TransferrableOrganizationEntity:_run_op(ctx, post_done)
  local utility = self._utility
...
return TransferrableOrganizationEntity
