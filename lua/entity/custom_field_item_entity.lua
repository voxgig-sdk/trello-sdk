...
local CustomFieldItemEntity = {}
CustomFieldItemEntity.__index = CustomFieldItemEntity


function CustomFieldItemEntity.new(client, entopts)
  entopts = entopts or {}
  ...
  local self = setmetatable({}, CustomFieldItemEntity)
  self._name = "custom_field_item"
  self._client = client
...
function CustomFieldItemEntity:get_name()
  return self._name
end


function CustomFieldItemEntity:make()
  local opts = {}
  for k, v in pairs(self._entopts) do
    opts[k] = v
  end
  return CustomFieldItemEntity.new(self._client, opts)
end
...
function CustomFieldItemEntity:mark_deleted()
  self._deleted = true
end


function CustomFieldItemEntity:deleted()
  return true == self._deleted
end


function CustomFieldItemEntity:data_set(args)
  if args ~= nil then
...
function CustomFieldItemEntity:data_get()
  self._utility.feature_hook(self._entctx, "GetData")
  return vs.clone(self._data)
end


function CustomFieldItemEntity:match_set(args)
  if args ~= nil then
...
function CustomFieldItemEntity:match_get()
...
function CustomFieldItemEntity:stream(action, args, callopts)
...
---@param reqmatch CustomFieldItemListMatch
---@param ctrl? table
---@return CustomFieldItem[]
---@return string? err
function CustomFieldItemEntity:list(reqmatch, ctrl)
  local utility = self._utility
...
function CustomFieldItemEntity:_run_op(ctx, post_done)
  local utility = self._utility
