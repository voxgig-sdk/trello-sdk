...
---@param reqmatch NotificationLoadMatch
---@param ctrl? table
---@return Notification
---@return string? err
function NotificationEntity:load(reqmatch, ctrl)
  local utility = self._utility
...
---@param reqdata NotificationUpdateData
---@param ctrl? table
---@return Notification
---@return string? err
function NotificationEntity:update(reqdata, ctrl)
  local utility = self._utility
  local ctx = utility.make_context({
    opname = "update",
    ctrl = ctrl,
