...
local ShowSidebarMemberEntity = {}
ShowSidebarMemberEntity.__index = ShowSidebarMemberEntity


function ShowSidebarMemberEntity.new(client, entopts)
  entopts = entopts or {}
  ...
  local self = setmetatable({}, ShowSidebarMemberEntity)
  self._name = "show_sidebar_member"
  self._client = client
...
function ShowSidebarMemberEntity:get_name()
  return self._name
end


function ShowSidebarMemberEntity:make()
  local opts = {}
  for k, v in pairs(self._entopts) do
    opts[k] = v
  end
  return ShowSidebarMemberEntity.new(self._client, opts)
end
...
function ShowSidebarMemberEntity:mark_deleted()
  self._deleted = true
end


function ShowSidebarMemberEntity:deleted()
  return true == self._deleted
end


function ShowSidebarMemberEntity:data_set(args)
  if args ~= nil then
...
function ShowSidebarMemberEntity:data_get()
  self._utility.feature_hook(self._entctx, "GetData")
  return vs.clone(self._data)
end


function ShowSidebarMemberEntity:match_set(args)
  if args ~= nil then
...
function ShowSidebarMemberEntity:match_get()
...
function ShowSidebarMemberEntity:stream(action, args, callopts)
...
---@param reqdata ShowSidebarMemberUpdateData
---@param ctrl? table
---@return ShowSidebarMember
---@return string? err
function ShowSidebarMemberEntity:update(reqdata, ctrl)
  local utility = self._utility
...
function ShowSidebarMemberEntity:_run_op(ctx, post_done)
  local utility = self._utility
...
return ShowSidebarMemberEntity
