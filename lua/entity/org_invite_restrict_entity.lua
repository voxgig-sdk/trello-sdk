...
local OrgInviteRestrictEntity = {}
OrgInviteRestrictEntity.__index = OrgInviteRestrictEntity


function OrgInviteRestrictEntity.new(client, entopts)
  entopts = entopts or {}
  ...
  local self = setmetatable({}, OrgInviteRestrictEntity)
  self._name = "org_invite_restrict"
  self._client = client
...
function OrgInviteRestrictEntity:get_name()
  return self._name
end


function OrgInviteRestrictEntity:make()
  local opts = {}
  for k, v in pairs(self._entopts) do
    opts[k] = v
  end
  return OrgInviteRestrictEntity.new(self._client, opts)
end
...
function OrgInviteRestrictEntity:mark_deleted()
  self._deleted = true
end


function OrgInviteRestrictEntity:deleted()
  return true == self._deleted
end


function OrgInviteRestrictEntity:data_set(args)
  if args ~= nil then
...
function OrgInviteRestrictEntity:data_get()
  self._utility.feature_hook(self._entctx, "GetData")
  return vs.clone(self._data)
end


function OrgInviteRestrictEntity:match_set(args)
  if args ~= nil then
...
function OrgInviteRestrictEntity:match_get()
...
function OrgInviteRestrictEntity:stream(action, args, callopts)
...
---@param reqmatch OrgInviteRestrictRemoveMatch
---@param ctrl? table
---@return OrgInviteRestrict
---@return string? err
function OrgInviteRestrictEntity:remove(reqmatch, ctrl)
  local utility = self._utility
...
function OrgInviteRestrictEntity:_run_op(ctx, post_done)
  local utility = self._utility
...
return OrgInviteRestrictEntity
