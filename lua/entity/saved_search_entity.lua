...
local SavedSearchEntity = {}
SavedSearchEntity.__index = SavedSearchEntity


function SavedSearchEntity.new(client, entopts)
  entopts = entopts or {}
  ...
  local self = setmetatable({}, SavedSearchEntity)
  self._name = "saved_search"
  self._client = client
...
function SavedSearchEntity:get_name()
  return self._name
end


function SavedSearchEntity:make()
  local opts = {}
  for k, v in pairs(self._entopts) do
    opts[k] = v
  end
  return SavedSearchEntity.new(self._client, opts)
end
...
function SavedSearchEntity:mark_deleted()
  self._deleted = true
end


function SavedSearchEntity:deleted()
  return true == self._deleted
end


function SavedSearchEntity:data_set(args)
  if args ~= nil then
...
function SavedSearchEntity:data_get()
  self._utility.feature_hook(self._entctx, "GetData")
  return vs.clone(self._data)
end


function SavedSearchEntity:match_set(args)
  if args ~= nil then
...
function SavedSearchEntity:match_get()
...
function SavedSearchEntity:stream(action, args, callopts)
...
---@param reqmatch SavedSearchLoadMatch
---@param ctrl? table
---@return SavedSearch
---@return string? err
function SavedSearchEntity:load(reqmatch, ctrl)
  local utility = self._utility
...
---@param reqmatch SavedSearchListMatch
---@param ctrl? table
---@return SavedSearch[]
---@return string? err
function SavedSearchEntity:list(reqmatch, ctrl)
  local utility = self._utility
  local ctx = utility.make_context({
    opname = "list",
    ctrl = ctrl,
...
---@param reqdata SavedSearchCreateData
---@param ctrl? table
---@return SavedSearch
---@return string? err
function SavedSearchEntity:create(reqdata, ctrl)
  local utility = self._utility
  local ctx = utility.make_context({
    opname = "create",
    ctrl = ctrl,
...
---@param reqdata SavedSearchUpdateData
---@param ctrl? table
---@return SavedSearch
---@return string? err
function SavedSearchEntity:update(reqdata, ctrl)
  local utility = self._utility
  local ctx = utility.make_context({
    opname = "update",
    ctrl = ctrl,
...
---@param reqmatch SavedSearchRemoveMatch
---@param ctrl? table
---@return SavedSearch
---@return string? err
function SavedSearchEntity:remove(reqmatch, ctrl)
  local utility = self._utility
  local ctx = utility.make_context({
    opname = "remove",
    ctrl = ctrl,
...
function SavedSearchEntity:_run_op(ctx, post_done)
  local utility = self._utility
