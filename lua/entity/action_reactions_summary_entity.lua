...
local ActionReactionsSummaryEntity = {}
ActionReactionsSummaryEntity.__index = ActionReactionsSummaryEntity


function ActionReactionsSummaryEntity.new(client, entopts)
  entopts = entopts or {}
  ...
  local self = setmetatable({}, ActionReactionsSummaryEntity)
  self._name = "action_reactions_summary"
  self._client = client
...
function ActionReactionsSummaryEntity:get_name()
  return self._name
end


function ActionReactionsSummaryEntity:make()
  local opts = {}
  for k, v in pairs(self._entopts) do
    opts[k] = v
  end
  return ActionReactionsSummaryEntity.new(self._client, opts)
end
...
function ActionReactionsSummaryEntity:mark_deleted()
  self._deleted = true
end


function ActionReactionsSummaryEntity:deleted()
  return true == self._deleted
end


function ActionReactionsSummaryEntity:data_set(args)
  if args ~= nil then
...
function ActionReactionsSummaryEntity:data_get()
  self._utility.feature_hook(self._entctx, "GetData")
  return vs.clone(self._data)
end


function ActionReactionsSummaryEntity:match_set(args)
  if args ~= nil then
...
function ActionReactionsSummaryEntity:match_get()
...
function ActionReactionsSummaryEntity:stream(action, args, callopts)
...
---@param reqmatch ActionReactionsSummaryLoadMatch
---@param ctrl? table
---@return ActionReactionsSummary
---@return string? err
function ActionReactionsSummaryEntity:load(reqmatch, ctrl)
  local utility = self._utility
...
function ActionReactionsSummaryEntity:_run_op(ctx, post_done)
  local utility = self._utility
...
return ActionReactionsSummaryEntity
