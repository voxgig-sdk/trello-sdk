...
local NewBillableGuestEntity = {}
NewBillableGuestEntity.__index = NewBillableGuestEntity


function NewBillableGuestEntity.new(client, entopts)
  entopts = entopts or {}
  ...
  local self = setmetatable({}, NewBillableGuestEntity)
  self._name = "new_billable_guest"
  self._client = client
...
function NewBillableGuestEntity:get_name()
  return self._name
end


function NewBillableGuestEntity:make()
  local opts = {}
  for k, v in pairs(self._entopts) do
    opts[k] = v
  end
  return NewBillableGuestEntity.new(self._client, opts)
end
...
function NewBillableGuestEntity:mark_deleted()
  self._deleted = true
end


function NewBillableGuestEntity:deleted()
  return true == self._deleted
end


function NewBillableGuestEntity:data_set(args)
  if args ~= nil then
...
function NewBillableGuestEntity:data_get()
  self._utility.feature_hook(self._entctx, "GetData")
  return vs.clone(self._data)
end


function NewBillableGuestEntity:match_set(args)
  if args ~= nil then
...
function NewBillableGuestEntity:match_get()
...
function NewBillableGuestEntity:stream(action, args, callopts)
...
---@param reqmatch NewBillableGuestLoadMatch
---@param ctrl? table
---@return NewBillableGuest
---@return string? err
function NewBillableGuestEntity:load(reqmatch, ctrl)
  local utility = self._utility
...
function NewBillableGuestEntity:_run_op(ctx, post_done)
  local utility = self._utility
