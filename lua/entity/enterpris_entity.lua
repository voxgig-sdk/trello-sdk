...
local EnterprisEntity = {}
EnterprisEntity.__index = EnterprisEntity


function EnterprisEntity.new(client, entopts)
  entopts = entopts or {}
  ...
  local self = setmetatable({}, EnterprisEntity)
  self._name = "enterpris"
  self._client = client
...
function EnterprisEntity:get_name()
  return self._name
end


function EnterprisEntity:make()
  local opts = {}
  for k, v in pairs(self._entopts) do
    opts[k] = v
  end
  return EnterprisEntity.new(self._client, opts)
end
...
function EnterprisEntity:mark_deleted()
  self._deleted = true
end


function EnterprisEntity:deleted()
  return true == self._deleted
end


function EnterprisEntity:data_set(args)
  if args ~= nil then
...
function EnterprisEntity:data_get()
  self._utility.feature_hook(self._entctx, "GetData")
  return vs.clone(self._data)
end


function EnterprisEntity:match_set(args)
  if args ~= nil then
...
function EnterprisEntity:match_get()
...
function EnterprisEntity:stream(action, args, callopts)
...
---@param reqmatch EnterprisLoadMatch
---@param ctrl? table
---@return Enterpris
---@return string? err
function EnterprisEntity:load(reqmatch, ctrl)
  local utility = self._utility
...
---@param reqdata EnterprisCreateData
---@param ctrl? table
---@return Enterpris
---@return string? err
function EnterprisEntity:create(reqdata, ctrl)
  local utility = self._utility
  local ctx = utility.make_context({
    opname = "create",
    ctrl = ctrl,
...
---@param reqdata EnterprisUpdateData
---@param ctrl? table
---@return Enterpris
---@return string? err
function EnterprisEntity:update(reqdata, ctrl)
  local utility = self._utility
  local ctx = utility.make_context({
    opname = "update",
    ctrl = ctrl,
...
function EnterprisEntity:_run_op(ctx, post_done)
  local utility = self._utility
