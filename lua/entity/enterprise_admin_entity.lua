...
local EnterpriseAdminEntity = {}
EnterpriseAdminEntity.__index = EnterpriseAdminEntity


function EnterpriseAdminEntity.new(client, entopts)
  entopts = entopts or {}
  ...
  local self = setmetatable({}, EnterpriseAdminEntity)
  self._name = "enterprise_admin"
  self._client = client
...
function EnterpriseAdminEntity:get_name()
  return self._name
end


function EnterpriseAdminEntity:make()
  local opts = {}
  for k, v in pairs(self._entopts) do
    opts[k] = v
  end
  return EnterpriseAdminEntity.new(self._client, opts)
end
...
function EnterpriseAdminEntity:mark_deleted()
  self._deleted = true
end


function EnterpriseAdminEntity:deleted()
  return true == self._deleted
end


function EnterpriseAdminEntity:data_set(args)
  if args ~= nil then
...
function EnterpriseAdminEntity:data_get()
  self._utility.feature_hook(self._entctx, "GetData")
  return vs.clone(self._data)
end


function EnterpriseAdminEntity:match_set(args)
  if args ~= nil then
...
function EnterpriseAdminEntity:match_get()
...
function EnterpriseAdminEntity:stream(action, args, callopts)
...
---@param reqmatch EnterpriseAdminLoadMatch
---@param ctrl? table
---@return EnterpriseAdmin
---@return string? err
function EnterpriseAdminEntity:load(reqmatch, ctrl)
  local utility = self._utility
...
function EnterpriseAdminEntity:_run_op(ctx, post_done)
  local utility = self._utility
