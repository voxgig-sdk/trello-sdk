...
local BoardStarEntity = {}
BoardStarEntity.__index = BoardStarEntity


function BoardStarEntity.new(client, entopts)
  entopts = entopts or {}
  ...
  local self = setmetatable({}, BoardStarEntity)
  self._name = "board_star"
  self._client = client
...
function BoardStarEntity:get_name()
  return self._name
end


function BoardStarEntity:make()
  local opts = {}
  for k, v in pairs(self._entopts) do
    opts[k] = v
  end
  return BoardStarEntity.new(self._client, opts)
end
...
function BoardStarEntity:mark_deleted()
  self._deleted = true
end


function BoardStarEntity:deleted()
  return true == self._deleted
end


function BoardStarEntity:data_set(args)
  if args ~= nil then
...
function BoardStarEntity:data_get()
  self._utility.feature_hook(self._entctx, "GetData")
  return vs.clone(self._data)
end


function BoardStarEntity:match_set(args)
  if args ~= nil then
...
function BoardStarEntity:match_get()
...
function BoardStarEntity:stream(action, args, callopts)
...
---@param reqmatch BoardStarLoadMatch
---@param ctrl? table
---@return BoardStar
---@return string? err
function BoardStarEntity:load(reqmatch, ctrl)
  local utility = self._utility
...
---@param reqmatch BoardStarListMatch
---@param ctrl? table
---@return BoardStar[]
---@return string? err
function BoardStarEntity:list(reqmatch, ctrl)
  local utility = self._utility
  local ctx = utility.make_context({
    opname = "list",
    ctrl = ctrl,
...
---@param reqdata BoardStarCreateData
---@param ctrl? table
---@return BoardStar
---@return string? err
function BoardStarEntity:create(reqdata, ctrl)
  local utility = self._utility
  local ctx = utility.make_context({
    opname = "create",
    ctrl = ctrl,
...
---@param reqdata BoardStarUpdateData
---@param ctrl? table
---@return BoardStar
---@return string? err
function BoardStarEntity:update(reqdata, ctrl)
  local utility = self._utility
  local ctx = utility.make_context({
    opname = "update",
    ctrl = ctrl,
...
---@param reqmatch BoardStarRemoveMatch
---@param ctrl? table
---@return BoardStar
---@return string? err
function BoardStarEntity:remove(reqmatch, ctrl)
  local utility = self._utility
  local ctx = utility.make_context({
    opname = "remove",
    ctrl = ctrl,
...
function BoardStarEntity:_run_op(ctx, post_done)
  local utility = self._utility
