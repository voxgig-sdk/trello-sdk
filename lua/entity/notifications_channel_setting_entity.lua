-- Trello SDK NotificationsChannelSetting entity

local vs = require("utility.struct.struct")
local helpers = require("core.helpers")

local NotificationsChannelSettingEntity = {}
NotificationsChannelSettingEntity.__index = NotificationsChannelSettingEntity


function NotificationsChannelSettingEntity.new(client, entopts)
  entopts = entopts or {}
  ...
  local self = setmetatable({}, NotificationsChannelSettingEntity)
  self._name = "notifications_channel_setting"
  self._client = client
...
function NotificationsChannelSettingEntity:get_name()
  return self._name
end


function NotificationsChannelSettingEntity:make()
  local opts = {}
  for k, v in pairs(self._entopts) do
    opts[k] = v
  end
  return NotificationsChannelSettingEntity.new(self._client, opts)
end
...
function NotificationsChannelSettingEntity:mark_deleted()
  self._deleted = true
end


function NotificationsChannelSettingEntity:deleted()
  return true == self._deleted
end


function NotificationsChannelSettingEntity:data_set(args)
  if args ~= nil then
...
function NotificationsChannelSettingEntity:data_get()
  self._utility.feature_hook(self._entctx, "GetData")
  return vs.clone(self._data)
end


function NotificationsChannelSettingEntity:match_set(args)
  if args ~= nil then
...
function NotificationsChannelSettingEntity:match_get()
...
function NotificationsChannelSettingEntity:stream(action, args, callopts)
...
function NotificationsChannelSettingEntity:_run_op(ctx, post_done)
  local utility = self._utility
...
return NotificationsChannelSettingEntity
