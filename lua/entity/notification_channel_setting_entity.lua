...
local NotificationChannelSettingEntity = {}
NotificationChannelSettingEntity.__index = NotificationChannelSettingEntity


function NotificationChannelSettingEntity.new(client, entopts)
  entopts = entopts or {}
  ...
  local self = setmetatable({}, NotificationChannelSettingEntity)
  self._name = "notification_channel_setting"
  self._client = client
...
function NotificationChannelSettingEntity:get_name()
  return self._name
end


function NotificationChannelSettingEntity:make()
  local opts = {}
  for k, v in pairs(self._entopts) do
    opts[k] = v
  end
  return NotificationChannelSettingEntity.new(self._client, opts)
end
...
function NotificationChannelSettingEntity:mark_deleted()
  self._deleted = true
end


function NotificationChannelSettingEntity:deleted()
  return true == self._deleted
end


function NotificationChannelSettingEntity:data_set(args)
  if args ~= nil then
...
function NotificationChannelSettingEntity:data_get()
  self._utility.feature_hook(self._entctx, "GetData")
  return vs.clone(self._data)
end


function NotificationChannelSettingEntity:match_set(args)
  if args ~= nil then
...
function NotificationChannelSettingEntity:match_get()
...
function NotificationChannelSettingEntity:stream(action, args, callopts)
...
---@param reqmatch NotificationChannelSettingLoadMatch
---@param ctrl? table
---@return NotificationChannelSetting
---@return string? err
function NotificationChannelSettingEntity:load(reqmatch, ctrl)
  local utility = self._utility
...
---@param reqmatch NotificationChannelSettingListMatch
---@param ctrl? table
---@return NotificationChannelSetting[]
---@return string? err
function NotificationChannelSettingEntity:list(reqmatch, ctrl)
  local utility = self._utility
  local ctx = utility.make_context({
    opname = "list",
    ctrl = ctrl,
...
---@param reqdata NotificationChannelSettingUpdateData
---@param ctrl? table
---@return NotificationChannelSetting
---@return string? err
function NotificationChannelSettingEntity:update(reqdata, ctrl)
  local utility = self._utility
  local ctx = utility.make_context({
    opname = "update",
    ctrl = ctrl,
...
function NotificationChannelSettingEntity:_run_op(ctx, post_done)
  local utility = self._utility
...
return NotificationChannelSettingEntity
