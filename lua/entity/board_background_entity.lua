...
local BoardBackgroundEntity = {}
BoardBackgroundEntity.__index = BoardBackgroundEntity


function BoardBackgroundEntity.new(client, entopts)
  entopts = entopts or {}
  ...
  local self = setmetatable({}, BoardBackgroundEntity)
  self._name = "board_background"
  self._client = client
...
function BoardBackgroundEntity:get_name()
  return self._name
end


function BoardBackgroundEntity:make()
  local opts = {}
  for k, v in pairs(self._entopts) do
    opts[k] = v
  end
  return BoardBackgroundEntity.new(self._client, opts)
end
...
function BoardBackgroundEntity:mark_deleted()
  self._deleted = true
end


function BoardBackgroundEntity:deleted()
  return true == self._deleted
end


function BoardBackgroundEntity:data_set(args)
  if args ~= nil then
...
function BoardBackgroundEntity:data_get()
  self._utility.feature_hook(self._entctx, "GetData")
  return vs.clone(self._data)
end


function BoardBackgroundEntity:match_set(args)
  if args ~= nil then
...
function BoardBackgroundEntity:match_get()
...
function BoardBackgroundEntity:stream(action, args, callopts)
...
---@param reqmatch BoardBackgroundLoadMatch
---@param ctrl? table
---@return BoardBackground
---@return string? err
function BoardBackgroundEntity:load(reqmatch, ctrl)
  local utility = self._utility
...
---@param reqmatch BoardBackgroundListMatch
---@param ctrl? table
---@return BoardBackground[]
---@return string? err
function BoardBackgroundEntity:list(reqmatch, ctrl)
  local utility = self._utility
  local ctx = utility.make_context({
    opname = "list",
    ctrl = ctrl,
...
---@param reqdata BoardBackgroundCreateData
---@param ctrl? table
---@return BoardBackground
---@return string? err
function BoardBackgroundEntity:create(reqdata, ctrl)
  local utility = self._utility
  local ctx = utility.make_context({
    opname = "create",
    ctrl = ctrl,
...
---@param reqdata BoardBackgroundUpdateData
---@param ctrl? table
---@return BoardBackground
---@return string? err
function BoardBackgroundEntity:update(reqdata, ctrl)
  local utility = self._utility
  local ctx = utility.make_context({
    opname = "update",
    ctrl = ctrl,
...
---@param reqmatch BoardBackgroundRemoveMatch
---@param ctrl? table
---@return BoardBackground
---@return string? err
function BoardBackgroundEntity:remove(reqmatch, ctrl)
  local utility = self._utility
  local ctx = utility.make_context({
    opname = "remove",
    ctrl = ctrl,
...
function BoardBackgroundEntity:_run_op(ctx, post_done)
  local utility = self._utility
