-- Trello SDK ShowSidebarBoardAction entity

local vs = require("utility.struct.struct")
local helpers = require("core.helpers")

local ShowSidebarBoardActionEntity = {}
ShowSidebarBoardActionEntity.__index = ShowSidebarBoardActionEntity


function ShowSidebarBoardActionEntity.new(client, entopts)
  entopts = entopts or {}
  ...
  local self = setmetatable({}, ShowSidebarBoardActionEntity)
  self._name = "show_sidebar_board_action"
  self._client = client
...
function ShowSidebarBoardActionEntity:get_name()
  return self._name
end


function ShowSidebarBoardActionEntity:make()
  local opts = {}
  for k, v in pairs(self._entopts) do
    opts[k] = v
  end
  return ShowSidebarBoardActionEntity.new(self._client, opts)
end
...
function ShowSidebarBoardActionEntity:mark_deleted()
  self._deleted = true
end


function ShowSidebarBoardActionEntity:deleted()
  return true == self._deleted
end


function ShowSidebarBoardActionEntity:data_set(args)
  if args ~= nil then
...
function ShowSidebarBoardActionEntity:data_get()
  self._utility.feature_hook(self._entctx, "GetData")
  return vs.clone(self._data)
end


function ShowSidebarBoardActionEntity:match_set(args)
  if args ~= nil then
...
function ShowSidebarBoardActionEntity:match_get()
...
function ShowSidebarBoardActionEntity:stream(action, args, callopts)
...
---@param reqdata ShowSidebarBoardActionUpdateData
---@param ctrl? table
---@return ShowSidebarBoardAction
---@return string? err
function ShowSidebarBoardActionEntity:update(reqdata, ctrl)
  local utility = self._utility
...
function ShowSidebarBoardActionEntity:_run_op(ctx, post_done)
  local utility = self._utility
...
return ShowSidebarBoardActionEntity
