...
local ShowSidebarEntity = {}
ShowSidebarEntity.__index = ShowSidebarEntity


function ShowSidebarEntity.new(client, entopts)
  entopts = entopts or {}
  ...
  local self = setmetatable({}, ShowSidebarEntity)
  self._name = "show_sidebar"
  self._client = client
...
function ShowSidebarEntity:get_name()
  return self._name
end


function ShowSidebarEntity:make()
  local opts = {}
  for k, v in pairs(self._entopts) do
    opts[k] = v
  end
  return ShowSidebarEntity.new(self._client, opts)
end
...
function ShowSidebarEntity:mark_deleted()
  self._deleted = true
end


function ShowSidebarEntity:deleted()
  return true == self._deleted
end


function ShowSidebarEntity:data_set(args)
  if args ~= nil then
...
function ShowSidebarEntity:data_get()
  self._utility.feature_hook(self._entctx, "GetData")
  return vs.clone(self._data)
end


function ShowSidebarEntity:match_set(args)
  if args ~= nil then
...
function ShowSidebarEntity:match_get()
...
function ShowSidebarEntity:stream(action, args, callopts)
...
---@param reqdata ShowSidebarUpdateData
---@param ctrl? table
---@return ShowSidebar
---@return string? err
function ShowSidebarEntity:update(reqdata, ctrl)
  local utility = self._utility
...
function ShowSidebarEntity:_run_op(ctx, post_done)
  local utility = self._utility
