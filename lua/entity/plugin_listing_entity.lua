...
local PluginListingEntity = {}
PluginListingEntity.__index = PluginListingEntity


function PluginListingEntity.new(client, entopts)
  entopts = entopts or {}
  ...
  local self = setmetatable({}, PluginListingEntity)
  self._name = "plugin_listing"
  self._client = client
...
function PluginListingEntity:get_name()
  return self._name
end


function PluginListingEntity:make()
  local opts = {}
  for k, v in pairs(self._entopts) do
    opts[k] = v
  end
  return PluginListingEntity.new(self._client, opts)
end
...
function PluginListingEntity:mark_deleted()
  self._deleted = true
end


function PluginListingEntity:deleted()
  return true == self._deleted
end


function PluginListingEntity:data_set(args)
  if args ~= nil then
...
function PluginListingEntity:data_get()
  self._utility.feature_hook(self._entctx, "GetData")
  return vs.clone(self._data)
end


function PluginListingEntity:match_set(args)
  if args ~= nil then
...
function PluginListingEntity:match_get()
...
function PluginListingEntity:stream(action, args, callopts)
...
---@param reqdata PluginListingCreateData
---@param ctrl? table
---@return PluginListing
---@return string? err
function PluginListingEntity:create(reqdata, ctrl)
  local utility = self._utility
...
---@param reqdata PluginListingUpdateData
---@param ctrl? table
---@return PluginListing
---@return string? err
function PluginListingEntity:update(reqdata, ctrl)
  local utility = self._utility
  local ctx = utility.make_context({
    opname = "update",
    ctrl = ctrl,
...
function PluginListingEntity:_run_op(ctx, post_done)
  local utility = self._utility
