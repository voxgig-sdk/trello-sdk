...
local MembersVotedEntity = {}
MembersVotedEntity.__index = MembersVotedEntity


function MembersVotedEntity.new(client, entopts)
  entopts = entopts or {}
  ...
  local self = setmetatable({}, MembersVotedEntity)
  self._name = "members_voted"
  self._client = client
...
function MembersVotedEntity:get_name()
  return self._name
end


function MembersVotedEntity:make()
  local opts = {}
  for k, v in pairs(self._entopts) do
    opts[k] = v
  end
  return MembersVotedEntity.new(self._client, opts)
end
...
function MembersVotedEntity:mark_deleted()
  self._deleted = true
end


function MembersVotedEntity:deleted()
  return true == self._deleted
end


function MembersVotedEntity:data_set(args)
  if args ~= nil then
...
function MembersVotedEntity:data_get()
  self._utility.feature_hook(self._entctx, "GetData")
  return vs.clone(self._data)
end


function MembersVotedEntity:match_set(args)
  if args ~= nil then
...
function MembersVotedEntity:match_get()
...
function MembersVotedEntity:stream(action, args, callopts)
...
---@param reqmatch MembersVotedLoadMatch
---@param ctrl? table
---@return MembersVoted
---@return string? err
function MembersVotedEntity:load(reqmatch, ctrl)
  local utility = self._utility
...
---@param reqmatch MembersVotedRemoveMatch
---@param ctrl? table
---@return MembersVoted
---@return string? err
function MembersVotedEntity:remove(reqmatch, ctrl)
  local utility = self._utility
  local ctx = utility.make_context({
    opname = "remove",
    ctrl = ctrl,
...
function MembersVotedEntity:_run_op(ctx, post_done)
  local utility = self._utility
