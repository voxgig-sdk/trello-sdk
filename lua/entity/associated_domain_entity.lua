...
local AssociatedDomainEntity = {}
AssociatedDomainEntity.__index = AssociatedDomainEntity


function AssociatedDomainEntity.new(client, entopts)
  entopts = entopts or {}
  ...
  local self = setmetatable({}, AssociatedDomainEntity)
  self._name = "associated_domain"
  self._client = client
...
function AssociatedDomainEntity:get_name()
  return self._name
end


function AssociatedDomainEntity:make()
  local opts = {}
  for k, v in pairs(self._entopts) do
    opts[k] = v
  end
  return AssociatedDomainEntity.new(self._client, opts)
end
...
function AssociatedDomainEntity:mark_deleted()
  self._deleted = true
end


function AssociatedDomainEntity:deleted()
  return true == self._deleted
end


function AssociatedDomainEntity:data_set(args)
  if args ~= nil then
...
function AssociatedDomainEntity:data_get()
  self._utility.feature_hook(self._entctx, "GetData")
  return vs.clone(self._data)
end


function AssociatedDomainEntity:match_set(args)
  if args ~= nil then
...
function AssociatedDomainEntity:match_get()
...
function AssociatedDomainEntity:stream(action, args, callopts)
...
---@param reqmatch AssociatedDomainRemoveMatch
---@param ctrl? table
---@return AssociatedDomain
---@return string? err
function AssociatedDomainEntity:remove(reqmatch, ctrl)
  local utility = self._utility
...
function AssociatedDomainEntity:_run_op(ctx, post_done)
  local utility = self._utility
