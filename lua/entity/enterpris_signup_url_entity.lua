...
local EnterprisSignupUrlEntity = {}
EnterprisSignupUrlEntity.__index = EnterprisSignupUrlEntity


function EnterprisSignupUrlEntity.new(client, entopts)
  entopts = entopts or {}
  ...
  local self = setmetatable({}, EnterprisSignupUrlEntity)
  self._name = "enterpris_signup_url"
  self._client = client
...
function EnterprisSignupUrlEntity:get_name()
  return self._name
end


function EnterprisSignupUrlEntity:make()
  local opts = {}
  for k, v in pairs(self._entopts) do
    opts[k] = v
  end
  return EnterprisSignupUrlEntity.new(self._client, opts)
end
...
function EnterprisSignupUrlEntity:mark_deleted()
  self._deleted = true
end


function EnterprisSignupUrlEntity:deleted()
  return true == self._deleted
end


function EnterprisSignupUrlEntity:data_set(args)
  if args ~= nil then
...
function EnterprisSignupUrlEntity:data_get()
  self._utility.feature_hook(self._entctx, "GetData")
  return vs.clone(self._data)
end


function EnterprisSignupUrlEntity:match_set(args)
  if args ~= nil then
...
function EnterprisSignupUrlEntity:match_get()
...
function EnterprisSignupUrlEntity:stream(action, args, callopts)
...
---@param reqmatch EnterprisSignupUrlLoadMatch
---@param ctrl? table
---@return EnterprisSignupUrl
---@return string? err
function EnterprisSignupUrlEntity:load(reqmatch, ctrl)
  local utility = self._utility
...
function EnterprisSignupUrlEntity:_run_op(ctx, post_done)
  local utility = self._utility
...
return EnterprisSignupUrlEntity
