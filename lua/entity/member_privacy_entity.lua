...
local MemberPrivacyEntity = {}
MemberPrivacyEntity.__index = MemberPrivacyEntity


function MemberPrivacyEntity.new(client, entopts)
  entopts = entopts or {}
  ...
  local self = setmetatable({}, MemberPrivacyEntity)
  self._name = "member_privacy"
  self._client = client
...
function MemberPrivacyEntity:get_name()
  return self._name
end


function MemberPrivacyEntity:make()
  local opts = {}
  for k, v in pairs(self._entopts) do
    opts[k] = v
  end
  return MemberPrivacyEntity.new(self._client, opts)
end
...
function MemberPrivacyEntity:mark_deleted()
  self._deleted = true
end


function MemberPrivacyEntity:deleted()
  return true == self._deleted
end


function MemberPrivacyEntity:data_set(args)
  if args ~= nil then
...
function MemberPrivacyEntity:data_get()
  self._utility.feature_hook(self._entctx, "GetData")
  return vs.clone(self._data)
end


function MemberPrivacyEntity:match_set(args)
  if args ~= nil then
...
function MemberPrivacyEntity:match_get()
...
function MemberPrivacyEntity:stream(action, args, callopts)
...
---@param reqmatch MemberPrivacyLoadMatch
---@param ctrl? table
---@return MemberPrivacy
---@return string? err
function MemberPrivacyEntity:load(reqmatch, ctrl)
  local utility = self._utility
...
function MemberPrivacyEntity:_run_op(ctx, post_done)
  local utility = self._utility
