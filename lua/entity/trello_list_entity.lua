...
local TrelloListEntity = {}
TrelloListEntity.__index = TrelloListEntity


function TrelloListEntity.new(client, entopts)
  entopts = entopts or {}
  ...
  local self = setmetatable({}, TrelloListEntity)
  self._name = "trello_list"
  self._client = client
...
function TrelloListEntity:get_name()
  return self._name
end


function TrelloListEntity:make()
  local opts = {}
  for k, v in pairs(self._entopts) do
    opts[k] = v
  end
  return TrelloListEntity.new(self._client, opts)
end
...
function TrelloListEntity:mark_deleted()
  self._deleted = true
end


function TrelloListEntity:deleted()
  return true == self._deleted
end


function TrelloListEntity:data_set(args)
  if args ~= nil then
...
function TrelloListEntity:data_get()
  self._utility.feature_hook(self._entctx, "GetData")
  return vs.clone(self._data)
end


function TrelloListEntity:match_set(args)
  if args ~= nil then
...
function TrelloListEntity:match_get()
...
function TrelloListEntity:stream(action, args, callopts)
...
---@param reqmatch TrelloListLoadMatch
---@param ctrl? table
---@return TrelloList
---@return string? err
function TrelloListEntity:load(reqmatch, ctrl)
  local utility = self._utility
...
---@param reqmatch TrelloListListMatch
---@param ctrl? table
---@return TrelloList[]
---@return string? err
function TrelloListEntity:list(reqmatch, ctrl)
  local utility = self._utility
  local ctx = utility.make_context({
    opname = "list",
    ctrl = ctrl,
...
---@param reqdata TrelloListCreateData
---@param ctrl? table
---@return TrelloList
---@return string? err
function TrelloListEntity:create(reqdata, ctrl)
  local utility = self._utility
  local ctx = utility.make_context({
    opname = "create",
    ctrl = ctrl,
...
function TrelloListEntity:_run_op(ctx, post_done)
  local utility = self._utility
