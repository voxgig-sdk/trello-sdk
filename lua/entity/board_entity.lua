...
---@param reqmatch BoardLoadMatch
---@param ctrl? table
---@return Board
---@return string? err
function BoardEntity:load(reqmatch, ctrl)
  local utility = self._utility
...
---@param reqdata BoardCreateData
---@param ctrl? table
---@return Board
---@return string? err
function BoardEntity:create(reqdata, ctrl)
  local utility = self._utility
  local ctx = utility.make_context({
    opname = "create",
    ctrl = ctrl,
...
---@param reqdata BoardUpdateData
---@param ctrl? table
---@return Board
---@return string? err
function BoardEntity:update(reqdata, ctrl)
  local utility = self._utility
  local ctx = utility.make_context({
    opname = "update",
    ctrl = ctrl,
...
---@param reqmatch BoardRemoveMatch
---@param ctrl? table
---@return Board
---@return string? err
function BoardEntity:remove(reqmatch, ctrl)
  local utility = self._utility
  local ctx = utility.make_context({
    opname = "remove",
    ctrl = ctrl,
