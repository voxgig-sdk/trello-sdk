...
local IdEmailListEntity = {}
IdEmailListEntity.__index = IdEmailListEntity


function IdEmailListEntity.new(client, entopts)
  entopts = entopts or {}
  ...
  local self = setmetatable({}, IdEmailListEntity)
  self._name = "id_email_list"
  self._client = client
...
function IdEmailListEntity:get_name()
  return self._name
end


function IdEmailListEntity:make()
  local opts = {}
  for k, v in pairs(self._entopts) do
    opts[k] = v
  end
  return IdEmailListEntity.new(self._client, opts)
end
...
function IdEmailListEntity:mark_deleted()
  self._deleted = true
end


function IdEmailListEntity:deleted()
  return true == self._deleted
end


function IdEmailListEntity:data_set(args)
  if args ~= nil then
...
function IdEmailListEntity:data_get()
  self._utility.feature_hook(self._entctx, "GetData")
  return vs.clone(self._data)
end


function IdEmailListEntity:match_set(args)
  if args ~= nil then
...
function IdEmailListEntity:match_get()
...
function IdEmailListEntity:stream(action, args, callopts)
...
---@param reqdata IdEmailListUpdateData
---@param ctrl? table
---@return IdEmailList
---@return string? err
function IdEmailListEntity:update(reqdata, ctrl)
  local utility = self._utility
...
function IdEmailListEntity:_run_op(ctx, post_done)
  local utility = self._utility
