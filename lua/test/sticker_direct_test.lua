...
describe("StickerDirect", function()
  it("should direct-load-sticker", function()
    local setup = sticker_direct_setup({ id = "direct01" })
    local _should_skip, _reason = runner.is_control_skipped("direct", "direct-load-sticker", setup.live and "live" or "unit")
...
function sticker_direct_setup(mockres)
