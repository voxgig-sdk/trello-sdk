...
describe("NotificationListDirect", function()
  it("should direct-load-notification_list", function()
    local setup = notification_list_direct_setup({ id = "direct01" })
    local _should_skip, _reason = runner.is_control_skipped("direct", "direct-load-notification_list", setup.live and "live" or "unit")
...
function notification_list_direct_setup(mockres)
