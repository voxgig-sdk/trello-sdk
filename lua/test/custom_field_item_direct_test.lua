...
describe("CustomFieldItemDirect", function()
  it("should direct-list-custom_field_item", function()
    local setup = custom_field_item_direct_setup({
      { id = "direct01" },
      { id = "direct02" },
    })
    local _should_skip, _reason = runner.is_control_skipped("direct", "direct-list-custom_field_item", setup.live and "live" or "unit")
...
function custom_field_item_direct_setup(mockres)
