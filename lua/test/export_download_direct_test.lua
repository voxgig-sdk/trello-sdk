...
describe("ExportDownloadDirect", function()
  it("should direct-load-export_download", function()
    local setup = export_download_direct_setup({ id = "direct01" })
    local _should_skip, _reason = runner.is_control_skipped("direct", "direct-load-export_download", setup.live and "live" or "unit")
...
function export_download_direct_setup(mockres)
