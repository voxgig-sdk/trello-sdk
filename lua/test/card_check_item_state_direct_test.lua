-- CardCheckItemState direct test
...
describe("CardCheckItemStateDirect", function()
  it("should direct-load-card_check_item_state", function()
    local setup = card_check_item_state_direct_setup({ id = "direct01" })
    local _should_skip, _reason = runner.is_control_skipped("direct", "direct-load-card_check_item_state", setup.live and "live" or "unit")
...
function card_check_item_state_direct_setup(mockres)
