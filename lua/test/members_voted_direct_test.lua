...
describe("MembersVotedDirect", function()
  it("should direct-load-members_voted", function()
    local setup = members_voted_direct_setup({ id = "direct01" })
    local _should_skip, _reason = runner.is_control_skipped("direct", "direct-load-members_voted", setup.live and "live" or "unit")
...
function members_voted_direct_setup(mockres)
