-- NotificationMemberCreator direct test
...
describe("NotificationMemberCreatorDirect", function()
  it("should direct-load-notification_member_creator", function()
    local setup = notification_member_creator_direct_setup({ id = "direct01" })
    local _should_skip, _reason = runner.is_control_skipped("direct", "direct-load-notification_member_creator", setup.live and "live" or "unit")
...
function notification_member_creator_direct_setup(mockres)
