-- TransferrableOrganization direct test
...
describe("TransferrableOrganizationDirect", function()
  it("should direct-load-transferrable_organization", function()
    local setup = transferrable_organization_direct_setup({ id = "direct01" })
    local _should_skip, _reason = runner.is_control_skipped("direct", "direct-load-transferrable_organization", setup.live and "live" or "unit")
...
function transferrable_organization_direct_setup(mockres)
