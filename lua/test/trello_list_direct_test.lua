...
describe("TrelloListDirect", function()
  it("should direct-list-trello_list", function()
    local setup = trello_list_direct_setup({
      { id = "direct01" },
      { id = "direct02" },
    })
    local _should_skip, _reason = runner.is_control_skipped("direct", "direct-list-trello_list", setup.live and "live" or "unit")
  ...
  it("should direct-load-trello_list", function()
    local setup = trello_list_direct_setup({ id = "direct01" })
    local _should_skip, _reason = runner.is_control_skipped("direct", "direct-load-trello_list", setup.live and "live" or "unit")
    if _should_skip then
      pending(_reason or "skipped via sdk-test-control.json")
      return
    end
...
function trello_list_direct_setup(mockres)
