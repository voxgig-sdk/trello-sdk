...
describe("ChecklistDirect", function()
  it("should direct-load-checklist", function()
    local setup = checklist_direct_setup({ id = "direct01" })
    local _should_skip, _reason = runner.is_control_skipped("direct", "direct-load-checklist", setup.live and "live" or "unit")
...
function checklist_direct_setup(mockres)
