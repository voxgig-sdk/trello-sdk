-- ActionReactionsSummary direct test
...
describe("ActionReactionsSummaryDirect", function()
  it("should direct-load-action_reactions_summary", function()
    local setup = action_reactions_summary_direct_setup({ id = "direct01" })
    local _should_skip, _reason = runner.is_control_skipped("direct", "direct-load-action_reactions_summary", setup.live and "live" or "unit")
...
function action_reactions_summary_direct_setup(mockres)
