-- EnterprisSignupUrl direct test
...
describe("EnterprisSignupUrlDirect", function()
  it("should direct-load-enterpris_signup_url", function()
    local setup = enterpris_signup_url_direct_setup({ id = "direct01" })
    local _should_skip, _reason = runner.is_control_skipped("direct", "direct-load-enterpris_signup_url", setup.live and "live" or "unit")
...
function enterpris_signup_url_direct_setup(mockres)
