-- ClaimableOrganization direct test
...
describe("ClaimableOrganizationDirect", function()
  it("should direct-list-claimable_organization", function()
    local setup = claimable_organization_direct_setup({
      { id = "direct01" },
      { id = "direct02" },
    })
    local _should_skip, _reason = runner.is_control_skipped("direct", "direct-list-claimable_organization", setup.live and "live" or "unit")
...
function claimable_organization_direct_setup(mockres)
