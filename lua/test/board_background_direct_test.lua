...
describe("BoardBackgroundDirect", function()
  it("should direct-list-board_background", function()
    local setup = board_background_direct_setup({
      { id = "direct01" },
      { id = "direct02" },
    })
    local _should_skip, _reason = runner.is_control_skipped("direct", "direct-list-board_background", setup.live and "live" or "unit")
  ...
  it("should direct-load-board_background", function()
    local setup = board_background_direct_setup({ id = "direct01" })
    local _should_skip, _reason = runner.is_control_skipped("direct", "direct-load-board_background", setup.live and "live" or "unit")
    if _should_skip then
      pending(_reason or "skipped via sdk-test-control.json")
      return
    end
...
function board_background_direct_setup(mockres)
