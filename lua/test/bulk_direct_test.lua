...
describe("BulkDirect", function()
  it("should direct-load-bulk", function()
    local setup = bulk_direct_setup({ id = "direct01" })
    local _should_skip, _reason = runner.is_control_skipped("direct", "direct-load-bulk", setup.live and "live" or "unit")
...
function bulk_direct_setup(mockres)
