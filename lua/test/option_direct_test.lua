...
describe("OptionDirect", function()
  it("should direct-load-option", function()
    local setup = option_direct_setup({ id = "direct01" })
    local _should_skip, _reason = runner.is_control_skipped("direct", "direct-load-option", setup.live and "live" or "unit")
...
function option_direct_setup(mockres)
