...
describe("NewBillableGuestDirect", function()
  it("should direct-load-new_billable_guest", function()
    local setup = new_billable_guest_direct_setup({ id = "direct01" })
    local _should_skip, _reason = runner.is_control_skipped("direct", "direct-load-new_billable_guest", setup.live and "live" or "unit")
...
function new_billable_guest_direct_setup(mockres)
