...
describe("PluginDirect", function()
  it("should direct-list-plugin", function()
    local setup = plugin_direct_setup({
      { id = "direct01" },
      { id = "direct02" },
    })
    local _should_skip, _reason = runner.is_control_skipped("direct", "direct-list-plugin", setup.live and "live" or "unit")
