-- PendingOrganization direct test
...
describe("PendingOrganizationDirect", function()
  it("should direct-list-pending_organization", function()
    local setup = pending_organization_direct_setup({
      { id = "direct01" },
      { id = "direct02" },
    })
    local _should_skip, _reason = runner.is_control_skipped("direct", "direct-list-pending_organization", setup.live and "live" or "unit")
...
function pending_organization_direct_setup(mockres)
