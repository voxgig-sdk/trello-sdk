...
describe("WebhookEntity", function()
  ...
  it("should run basic flow", function()
    ...
    if setup.synthetic_only then
      pending("live entity test uses synthetic IDs from fixture — set TRELLO_TEST_WEBHOOK_ENTID JSON to run live")
      return
    end
    ...
    local webhook_ref01_markdef_up0_name = "callbackURL"
...
function webhook_basic_setup(extra)
  ...
  local entid_env_raw = os.getenv("TRELLO_TEST_WEBHOOK_ENTID")
  ...
  if idmap_resolved["token_id"] == nil then
