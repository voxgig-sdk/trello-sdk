-- ApplicationCompliance direct test
...
describe("ApplicationComplianceDirect", function()
  it("should direct-load-application_compliance", function()
    local setup = application_compliance_direct_setup({ id = "direct01" })
    local _should_skip, _reason = runner.is_control_skipped("direct", "direct-load-application_compliance", setup.live and "live" or "unit")
...
function application_compliance_direct_setup(mockres)
