...
describe("EmojiDirect", function()
  it("should direct-list-emoji", function()
    local setup = emoji_direct_setup({
      { id = "direct01" },
      { id = "direct02" },
    })
    local _should_skip, _reason = runner.is_control_skipped("direct", "direct-list-emoji", setup.live and "live" or "unit")
