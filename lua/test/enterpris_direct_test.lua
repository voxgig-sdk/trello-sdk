...
describe("EnterprisDirect", function()
  it("should direct-load-enterpris", function()
    local setup = enterpris_direct_setup({ id = "direct01" })
    local _should_skip, _reason = runner.is_control_skipped("direct", "direct-load-enterpris", setup.live and "live" or "unit")
...
function enterpris_direct_setup(mockres)
