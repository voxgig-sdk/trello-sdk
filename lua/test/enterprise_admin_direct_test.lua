...
describe("EnterpriseAdminDirect", function()
  it("should direct-load-enterprise_admin", function()
    local setup = enterprise_admin_direct_setup({ id = "direct01" })
    local _should_skip, _reason = runner.is_control_skipped("direct", "direct-load-enterprise_admin", setup.live and "live" or "unit")
...
function enterprise_admin_direct_setup(mockres)
