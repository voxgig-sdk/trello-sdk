...
describe("CheckItemDirect", function()
  it("should direct-load-check_item", function()
    local setup = check_item_direct_setup({ id = "direct01" })
    local _should_skip, _reason = runner.is_control_skipped("direct", "direct-load-check_item", setup.live and "live" or "unit")
...
function check_item_direct_setup(mockres)
