...
describe("OrganizationEntity", function()
  ...
  it("should run basic flow", function()
    ...
    if setup.synthetic_only then
      pending("live entity test uses synthetic IDs from fixture — set TRELLO_TEST_ORGANIZATION_ENTID JSON to run live")
      return
    end
    ...
    local organization_ref01_markdef_up0_name = "dateLastActivity"
...
function organization_basic_setup(extra)
  ...
  local entid_env_raw = os.getenv("TRELLO_TEST_ORGANIZATION_ENTID")
  ...
  local idmap_resolved = helpers.to_map(
    env["TRELLO_TEST_ORGANIZATION_ENTID"])
