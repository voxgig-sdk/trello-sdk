-- EnterpriseAuditLog direct test
...
describe("EnterpriseAuditLogDirect", function()
  it("should direct-list-enterprise_audit_log", function()
    local setup = enterprise_audit_log_direct_setup({
      { id = "direct01" },
      { id = "direct02" },
    })
    local _should_skip, _reason = runner.is_control_skipped("direct", "direct-list-enterprise_audit_log", setup.live and "live" or "unit")
...
function enterprise_audit_log_direct_setup(mockres)
