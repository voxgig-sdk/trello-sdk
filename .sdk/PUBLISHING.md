...
|---|---|---|
| `js/` | @voxgig-sdk/trello-js | `.github/workflows/publish-js.yml` |
| `ts/` | @voxgig-sdk/trello | `.github/workflows/publish-ts.yml` |
...
required):
    ...
    npm trust github @voxgig-sdk/trello-js \
      --repository voxgig-sdk/trello-sdk \
      --file publish-js.yml \
      --allow-publish

Then `npm trust list @voxgig-sdk/trello-js` shows it, and
`npm trust revoke @voxgig-sdk/trello-js --id=<id>` removes it.
