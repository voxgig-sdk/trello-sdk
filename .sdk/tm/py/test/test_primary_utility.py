...
from projectname_sdk import TrelloSDK
from projectname_sdk.core.spec import TrelloSpec
from projectname_sdk.core.result import TrelloResult
from projectname_sdk.core.response import TrelloResponse
from projectname_sdk.core.operation import TrelloOperation
from projectname_sdk.core.error import TrelloError
from projectname_sdk.core import helpers
from projectname_sdk.feature.base_feature import TrelloBaseFeature
...
class TestPrimaryUtility:
    ...
    def test_exists(self):
        client = TrelloSDK.test(None, None)
    ...
    def test_feature_init_basic(self):
        init_client = TrelloSDK.test(None, None)
        ...
        class TestInitFeature(TrelloBaseFeature):
            def __init__(self):
                super().__init__()
                self.name = "initfeat"
                self.active = True
    ...
    def test_feature_init_inactive(self):
        ...
        class TestInitFeatureInactive(TrelloBaseFeature):
            def __init__(self):
                super().__init__()
                self.name = "nofeat"
                self.active = False
    ...
    def test_make_result_no_result(self):
        ...
        utility = client._utility
        ctx = _make_test_full_ctx(client, utility)
        ctx.spec = TrelloSpec({"step": "start"})
        ctx.result = None
    ...
    def test_make_spec_basic(self):
        ...
        spec_client = TrelloSDK.test(None, setup_opts)
    ...
    def test_prepare_auth_basic(self):
        ...
        auth_client = TrelloSDK.test(None, setup_opts)
