...
class TrelloTestRunner:
    ...
    @staticmethod
    def env_override(m):
        live = TrelloTestRunner.getenv("PROJECTENV_TEST_LIVE")
        override = TrelloTestRunner.getenv("PROJECTENV_TEST_OVERRIDE")
        ...
        explain = TrelloTestRunner.getenv("PROJECTENV_TEST_EXPLAIN")
