...
from projectname_sdk.core.control import TrelloControl
...
class TrelloContext:
    def __init__(self, ctxmap=None, basectx=None):
        ...
        if isinstance(rp, TrelloResponse):
            self.response = rp
        elif basectx is not None:
    ...
    def make_error(self, code, msg):
        return TrelloError(code, msg, self)
