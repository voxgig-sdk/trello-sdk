...
class ChecklistEntity
{
    ...
    {
        $opts = $this->_entopts;
        return new ChecklistEntity($this->_client, $opts);
    }

    /**
     * @param Checklist|array $args Checklist data (assoc-array) to store.
     */
    ...
    /**
     * @return Checklist|array The current Checklist data as an assoc-array.
     */
    ...
    /**
     * @param array $args Match filter (any subset of Checklist fields).
     */
    ...
    /**
     * @return array The current match filter (any subset of Checklist fields).
     */
     ...
     *
     * @param ChecklistLoadMatch|array|null $reqmatch Match criteria (id/query
     *   fields) as an assoc-array; a typed ChecklistLoadMatch names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return Checklist|array The loaded Checklist as an assoc-array at the
     ...
     *
     * @param ChecklistCreateData|array|null $reqdata Body data as an assoc-array;
     *   a typed ChecklistCreateData names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return Checklist|array The created Checklist as an assoc-array at the
     *   SDK boundary; throws TrelloError on failure (item-5 convention).
     */
     ...
     *
     * @param ChecklistUpdateData|array|null $reqdata Body data as an assoc-array;
     *   a typed ChecklistUpdateData names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return Checklist|array The updated Checklist as an assoc-array at the
     *   SDK boundary; throws TrelloError on failure (item-5 convention).
     */
    ...
    /**
     * Remove an Checklist matching the given criteria.
     *
     * @param ChecklistRemoveMatch|array|null $reqmatch Match criteria (id/query
     *   fields) as an assoc-array; ChecklistRemoveMatch names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return Checklist|array The removed Checklist as an assoc-array at the
     *   SDK boundary; throws TrelloError on failure (item-5 convention).
     */
