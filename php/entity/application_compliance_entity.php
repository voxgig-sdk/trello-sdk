...
// Trello SDK ApplicationCompliance entity
...
class ApplicationComplianceEntity
{
    ...
    public function __construct($client, ?array $entopts = null)
    {
        ...
        $this->_name = "application_compliance";
        $this->_client = $client;
    ...
    {
        $opts = $this->_entopts;
        return new ApplicationComplianceEntity($this->_client, $opts);
    }

    /**
     * @param ApplicationCompliance|array $args ApplicationCompliance data (assoc-array) to store.
     */
    ...
    /**
     * @return ApplicationCompliance|array The current ApplicationCompliance data as an assoc-array.
     */
    ...
    /**
     * @param array $args Match filter (any subset of ApplicationCompliance fields).
     */
    ...
    /**
     * @return array The current match filter (any subset of ApplicationCompliance fields).
     */
    ...
    /**
     * Load a single ApplicationCompliance.
     *
     * @param ApplicationComplianceLoadMatch|array|null $reqmatch Match criteria (id/query
     *   fields) as an assoc-array; a typed ApplicationComplianceLoadMatch names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return ApplicationCompliance|array The loaded ApplicationCompliance as an assoc-array at the
