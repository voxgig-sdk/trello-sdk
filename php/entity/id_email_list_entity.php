...
class IdEmailListEntity
{
    ...
    {
        $opts = $this->_entopts;
        return new IdEmailListEntity($this->_client, $opts);
    }

    /**
     * @param IdEmailList|array $args IdEmailList data (assoc-array) to store.
     */
    ...
    /**
     * @return IdEmailList|array The current IdEmailList data as an assoc-array.
     */
    ...
    /**
     * @param array $args Match filter (any subset of IdEmailList fields).
     */
    ...
    /**
     * @return array The current match filter (any subset of IdEmailList fields).
     */
    ...
    /**
     * Update an existing IdEmailList.
     *
     * @param IdEmailListUpdateData|array|null $reqdata Body data as an assoc-array;
     *   a typed IdEmailListUpdateData names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return IdEmailList|array The updated IdEmailList as an assoc-array at the
