...
// Trello SDK EnterpriseAdmin entity
...
class EnterpriseAdminEntity
{
    ...
    {
        $opts = $this->_entopts;
        return new EnterpriseAdminEntity($this->_client, $opts);
    }

    /**
     * @param EnterpriseAdmin|array $args EnterpriseAdmin data (assoc-array) to store.
     */
    ...
    /**
     * @return EnterpriseAdmin|array The current EnterpriseAdmin data as an assoc-array.
     */
    ...
    /**
     * @param array $args Match filter (any subset of EnterpriseAdmin fields).
     */
    ...
    /**
     * @return array The current match filter (any subset of EnterpriseAdmin fields).
     */
    ...
    /**
     * Load a single EnterpriseAdmin.
     *
     * @param EnterpriseAdminLoadMatch|array|null $reqmatch Match criteria (id/query
     *   fields) as an assoc-array; a typed EnterpriseAdminLoadMatch names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return EnterpriseAdmin|array The loaded EnterpriseAdmin as an assoc-array at the
