...
class NotificationMemberCreatorEntity
{
    ...
    public function __construct($client, ?array $entopts = null)
    {
        ...
        $this->_name = "notification_member_creator";
        $this->_client = $client;
    ...
    {
        $opts = $this->_entopts;
        return new NotificationMemberCreatorEntity($this->_client, $opts);
    }

    /**
     * @param NotificationMemberCreator|array $args NotificationMemberCreator data (assoc-array) to store.
     */
    ...
    /**
     * @return NotificationMemberCreator|array The current NotificationMemberCreator data as an assoc-array.
     */
    ...
    /**
     * @param array $args Match filter (any subset of NotificationMemberCreator fields).
     */
    ...
    /**
     * @return array The current match filter (any subset of NotificationMemberCreator fields).
     */
    ...
    /**
     * Load a single NotificationMemberCreator.
     *
     * @param NotificationMemberCreatorLoadMatch|array|null $reqmatch Match criteria (id/query
     *   fields) as an assoc-array; a typed NotificationMemberCreatorLoadMatch names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return NotificationMemberCreator|array The loaded NotificationMemberCreator as an assoc-array at the
