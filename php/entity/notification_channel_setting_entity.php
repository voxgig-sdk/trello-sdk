...
// Trello SDK NotificationChannelSetting entity
...
class NotificationChannelSettingEntity
{
    ...
    public function __construct($client, ?array $entopts = null)
    {
        ...
        $this->_name = "notification_channel_setting";
        $this->_client = $client;
    ...
    {
        $opts = $this->_entopts;
        return new NotificationChannelSettingEntity($this->_client, $opts);
    }

    /**
     * @param NotificationChannelSetting|array $args NotificationChannelSetting data (assoc-array) to store.
     */
    ...
    /**
     * @return NotificationChannelSetting|array The current NotificationChannelSetting data as an assoc-array.
     */
    ...
    /**
     * @param array $args Match filter (any subset of NotificationChannelSetting fields).
     */
    ...
    /**
     * @return array The current match filter (any subset of NotificationChannelSetting fields).
     */
    ...
    /**
     * Load a single NotificationChannelSetting.
     *
     * @param NotificationChannelSettingLoadMatch|array|null $reqmatch Match criteria (id/query
     *   fields) as an assoc-array; a typed NotificationChannelSettingLoadMatch names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return NotificationChannelSetting|array The loaded NotificationChannelSetting as an assoc-array at the
    ...
    /**
     * List NotificationChannelSetting items matching the given filter.
     *
     * @param NotificationChannelSettingListMatch|array|null $reqmatch Match filter (any subset
     *   of NotificationChannelSetting fields) as an assoc-array; NotificationChannelSettingListMatch names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return NotificationChannelSetting[]|array A list of NotificationChannelSetting items as assoc-arrays at
    ...
    /**
     * Update an existing NotificationChannelSetting.
     *
     * @param NotificationChannelSettingUpdateData|array|null $reqdata Body data as an assoc-array;
     *   a typed NotificationChannelSettingUpdateData names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return NotificationChannelSetting|array The updated NotificationChannelSetting as an assoc-array at the
     *   SDK boundary; throws TrelloError on failure (item-5 convention).
     */
