...
class PluginEntity
{
    ...
    /**
     * List Plugin items matching the given filter.
     *
     * @param PluginListMatch|array|null $reqmatch Match filter (any subset
     *   of Plugin fields) as an assoc-array; PluginListMatch names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return Plugin[]|array A list of Plugin items as assoc-arrays at
     ...
     *
     * @param PluginUpdateData|array|null $reqdata Body data as an assoc-array;
     *   a typed PluginUpdateData names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return Plugin|array The updated Plugin as an assoc-array at the
     *   SDK boundary; throws TrelloError on failure (item-5 convention).
     */
