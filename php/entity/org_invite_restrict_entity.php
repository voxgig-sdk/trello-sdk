...
// Trello SDK OrgInviteRestrict entity
...
class OrgInviteRestrictEntity
{
    ...
    public function __construct($client, ?array $entopts = null)
    {
        ...
        $this->_name = "org_invite_restrict";
        $this->_client = $client;
    ...
    {
        $opts = $this->_entopts;
        return new OrgInviteRestrictEntity($this->_client, $opts);
    }

    /**
     * @param OrgInviteRestrict|array $args OrgInviteRestrict data (assoc-array) to store.
     */
    ...
    /**
     * @return OrgInviteRestrict|array The current OrgInviteRestrict data as an assoc-array.
     */
    ...
    /**
     * @param array $args Match filter (any subset of OrgInviteRestrict fields).
     */
    ...
    /**
     * @return array The current match filter (any subset of OrgInviteRestrict fields).
     */
    ...
    /**
     * Remove an OrgInviteRestrict matching the given criteria.
     *
     * @param OrgInviteRestrictRemoveMatch|array|null $reqmatch Match criteria (id/query
     *   fields) as an assoc-array; OrgInviteRestrictRemoveMatch names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return OrgInviteRestrict|array The removed OrgInviteRestrict as an assoc-array at the
