...
// Trello SDK MemberPrivacy entity
...
class MemberPrivacyEntity
{
    ...
    {
        $opts = $this->_entopts;
        return new MemberPrivacyEntity($this->_client, $opts);
    }

    /**
     * @param MemberPrivacy|array $args MemberPrivacy data (assoc-array) to store.
     */
    ...
    /**
     * @return MemberPrivacy|array The current MemberPrivacy data as an assoc-array.
     */
    ...
    /**
     * @param array $args Match filter (any subset of MemberPrivacy fields).
     */
    ...
    /**
     * @return array The current match filter (any subset of MemberPrivacy fields).
     */
    ...
    /**
     * Load a single MemberPrivacy.
     *
     * @param MemberPrivacyLoadMatch|array|null $reqmatch Match criteria (id/query
     *   fields) as an assoc-array; a typed MemberPrivacyLoadMatch names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return MemberPrivacy|array The loaded MemberPrivacy as an assoc-array at the
