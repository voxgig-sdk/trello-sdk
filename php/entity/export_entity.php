...
class ExportEntity
{
    ...
    /**
     * Remove an Export matching the given criteria.
     *
     * @param ExportRemoveMatch|array|null $reqmatch Match criteria (id/query
     *   fields) as an assoc-array; ExportRemoveMatch names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return Export|array The removed Export as an assoc-array at the
     *   SDK boundary; throws TrelloError on failure (item-5 convention).
     */
