...
class StickerEntity
{
    ...
    {
        $opts = $this->_entopts;
        return new StickerEntity($this->_client, $opts);
    }

    /**
     * @param Sticker|array $args Sticker data (assoc-array) to store.
     */
    ...
    /**
     * @return Sticker|array The current Sticker data as an assoc-array.
     */
    ...
    /**
     * @param array $args Match filter (any subset of Sticker fields).
     */
    ...
    /**
     * @return array The current match filter (any subset of Sticker fields).
     */
    ...
    /**
     * Load a single Sticker.
     *
     * @param StickerLoadMatch|array|null $reqmatch Match criteria (id/query
     *   fields) as an assoc-array; a typed StickerLoadMatch names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return Sticker|array The loaded Sticker as an assoc-array at the
     ...
     *
     * @param StickerUpdateData|array|null $reqdata Body data as an assoc-array;
     *   a typed StickerUpdateData names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return Sticker|array The updated Sticker as an assoc-array at the
     *   SDK boundary; throws TrelloError on failure (item-5 convention).
     */
    ...
    /**
     * Remove an Sticker matching the given criteria.
     *
     * @param StickerRemoveMatch|array|null $reqmatch Match criteria (id/query
     *   fields) as an assoc-array; StickerRemoveMatch names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return Sticker|array The removed Sticker as an assoc-array at the
     *   SDK boundary; throws TrelloError on failure (item-5 convention).
     */
