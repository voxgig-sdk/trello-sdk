...
class SavedSearchEntity
{
    ...
    {
        $opts = $this->_entopts;
        return new SavedSearchEntity($this->_client, $opts);
    }

    /**
     * @param SavedSearch|array $args SavedSearch data (assoc-array) to store.
     */
    ...
    /**
     * @return SavedSearch|array The current SavedSearch data as an assoc-array.
     */
    ...
    /**
     * @param array $args Match filter (any subset of SavedSearch fields).
     */
    ...
    /**
     * @return array The current match filter (any subset of SavedSearch fields).
     */
    ...
    /**
     * Load a single SavedSearch.
     *
     * @param SavedSearchLoadMatch|array|null $reqmatch Match criteria (id/query
     *   fields) as an assoc-array; a typed SavedSearchLoadMatch names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return SavedSearch|array The loaded SavedSearch as an assoc-array at the
    ...
    /**
     * List SavedSearch items matching the given filter.
     *
     * @param SavedSearchListMatch|array|null $reqmatch Match filter (any subset
     *   of SavedSearch fields) as an assoc-array; SavedSearchListMatch names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return SavedSearch[]|array A list of SavedSearch items as assoc-arrays at
     ...
     *
     * @param SavedSearchCreateData|array|null $reqdata Body data as an assoc-array;
     *   a typed SavedSearchCreateData names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return SavedSearch|array The created SavedSearch as an assoc-array at the
     *   SDK boundary; throws TrelloError on failure (item-5 convention).
     */
    ...
    /**
     * Update an existing SavedSearch.
     *
     * @param SavedSearchUpdateData|array|null $reqdata Body data as an assoc-array;
     *   a typed SavedSearchUpdateData names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return SavedSearch|array The updated SavedSearch as an assoc-array at the
     *   SDK boundary; throws TrelloError on failure (item-5 convention).
     */
    ...
    /**
     * Remove an SavedSearch matching the given criteria.
     *
     * @param SavedSearchRemoveMatch|array|null $reqmatch Match criteria (id/query
     *   fields) as an assoc-array; SavedSearchRemoveMatch names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return SavedSearch|array The removed SavedSearch as an assoc-array at the
     *   SDK boundary; throws TrelloError on failure (item-5 convention).
     */
