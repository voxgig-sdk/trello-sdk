...
class BoardPluginEntity
{
    ...
    {
        $opts = $this->_entopts;
        return new BoardPluginEntity($this->_client, $opts);
    }

    /**
     * @param BoardPlugin|array $args BoardPlugin data (assoc-array) to store.
     */
    ...
    /**
     * @return BoardPlugin|array The current BoardPlugin data as an assoc-array.
     */
    ...
    /**
     * @param array $args Match filter (any subset of BoardPlugin fields).
     */
    ...
    /**
     * @return array The current match filter (any subset of BoardPlugin fields).
     */
    ...
    /**
     * Remove an BoardPlugin matching the given criteria.
     *
     * @param BoardPluginRemoveMatch|array|null $reqmatch Match criteria (id/query
     *   fields) as an assoc-array; BoardPluginRemoveMatch names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return BoardPlugin|array The removed BoardPlugin as an assoc-array at the
