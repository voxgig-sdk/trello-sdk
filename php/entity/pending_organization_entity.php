...
// Trello SDK PendingOrganization entity
...
class PendingOrganizationEntity
{
    ...
    public function __construct($client, ?array $entopts = null)
    {
        ...
        $this->_name = "pending_organization";
        $this->_client = $client;
    ...
    {
        $opts = $this->_entopts;
        return new PendingOrganizationEntity($this->_client, $opts);
    }

    /**
     * @param PendingOrganization|array $args PendingOrganization data (assoc-array) to store.
     */
    ...
    /**
     * @return PendingOrganization|array The current PendingOrganization data as an assoc-array.
     */
    ...
    /**
     * @param array $args Match filter (any subset of PendingOrganization fields).
     */
    ...
    /**
     * @return array The current match filter (any subset of PendingOrganization fields).
     */
    ...
    /**
     * List PendingOrganization items matching the given filter.
     *
     * @param PendingOrganizationListMatch|array|null $reqmatch Match filter (any subset
     *   of PendingOrganization fields) as an assoc-array; PendingOrganizationListMatch names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return PendingOrganization[]|array A list of PendingOrganization items as assoc-arrays at
