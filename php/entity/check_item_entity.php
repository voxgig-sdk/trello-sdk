...
class CheckItemEntity
{
    ...
    {
        $opts = $this->_entopts;
        return new CheckItemEntity($this->_client, $opts);
    }

    /**
     * @param CheckItem|array $args CheckItem data (assoc-array) to store.
     */
    ...
    /**
     * @return CheckItem|array The current CheckItem data as an assoc-array.
     */
    ...
    /**
     * @param array $args Match filter (any subset of CheckItem fields).
     */
    ...
    /**
     * @return array The current match filter (any subset of CheckItem fields).
     */
    ...
    /**
     * Load a single CheckItem.
     *
     * @param CheckItemLoadMatch|array|null $reqmatch Match criteria (id/query
     *   fields) as an assoc-array; a typed CheckItemLoadMatch names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return CheckItem|array The loaded CheckItem as an assoc-array at the
    ...
    /**
     * Update an existing CheckItem.
     *
     * @param CheckItemUpdateData|array|null $reqdata Body data as an assoc-array;
     *   a typed CheckItemUpdateData names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return CheckItem|array The updated CheckItem as an assoc-array at the
     *   SDK boundary; throws TrelloError on failure (item-5 convention).
     */
    ...
    /**
     * Remove an CheckItem matching the given criteria.
     *
     * @param CheckItemRemoveMatch|array|null $reqmatch Match criteria (id/query
     *   fields) as an assoc-array; CheckItemRemoveMatch names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return CheckItem|array The removed CheckItem as an assoc-array at the
     *   SDK boundary; throws TrelloError on failure (item-5 convention).
     */
