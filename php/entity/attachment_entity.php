...
class AttachmentEntity
{
    ...
    {
        $opts = $this->_entopts;
        return new AttachmentEntity($this->_client, $opts);
    }

    /**
     * @param Attachment|array $args Attachment data (assoc-array) to store.
     */
    ...
    /**
     * @return Attachment|array The current Attachment data as an assoc-array.
     */
    ...
    /**
     * @param array $args Match filter (any subset of Attachment fields).
     */
    ...
    /**
     * @return array The current match filter (any subset of Attachment fields).
     */
     ...
     *
     * @param AttachmentLoadMatch|array|null $reqmatch Match criteria (id/query
     *   fields) as an assoc-array; a typed AttachmentLoadMatch names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return Attachment|array The loaded Attachment as an assoc-array at the
    ...
    /**
     * List Attachment items matching the given filter.
     *
     * @param AttachmentListMatch|array|null $reqmatch Match filter (any subset
     *   of Attachment fields) as an assoc-array; AttachmentListMatch names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return Attachment[]|array A list of Attachment items as assoc-arrays at
    ...
    /**
     * Remove an Attachment matching the given criteria.
     *
     * @param AttachmentRemoveMatch|array|null $reqmatch Match criteria (id/query
     *   fields) as an assoc-array; AttachmentRemoveMatch names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return Attachment|array The removed Attachment as an assoc-array at the
     *   SDK boundary; throws TrelloError on failure (item-5 convention).
     */
