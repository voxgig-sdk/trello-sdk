...
class ListEntity
{
     ...
     * Create a new List.
     *
     * @param ListCreateData|array|null $reqdata Body data as an assoc-array;
     *   a typed ListCreateData names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return List|array The created List as an assoc-array at the
     *   SDK boundary; throws TrelloError on failure (item-5 convention).
     */
     ...
     *
     * @param ListUpdateData|array|null $reqdata Body data as an assoc-array;
     *   a typed ListUpdateData names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return List|array The updated List as an assoc-array at the
     *   SDK boundary; throws TrelloError on failure (item-5 convention).
     */
