...
// Trello SDK Notification entity
...
class NotificationEntity
{
     ...
     *
     * @param NotificationLoadMatch|array|null $reqmatch Match criteria (id/query
     *   fields) as an assoc-array; a typed NotificationLoadMatch names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return Notification|array The loaded Notification as an assoc-array at the
     ...
     *
     * @param NotificationUpdateData|array|null $reqdata Body data as an assoc-array;
     *   a typed NotificationUpdateData names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return Notification|array The updated Notification as an assoc-array at the
     *   SDK boundary; throws TrelloError on failure (item-5 convention).
     */
