...
class BoardEntity
{
     ...
     * Load a single Board.
     *
     * @param BoardLoadMatch|array|null $reqmatch Match criteria (id/query
     *   fields) as an assoc-array; a typed BoardLoadMatch names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return Board|array The loaded Board as an assoc-array at the
     ...
     * Create a new Board.
     *
     * @param BoardCreateData|array|null $reqdata Body data as an assoc-array;
     *   a typed BoardCreateData names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return Board|array The created Board as an assoc-array at the
     *   SDK boundary; throws TrelloError on failure (item-5 convention).
     */
     ...
     *
     * @param BoardUpdateData|array|null $reqdata Body data as an assoc-array;
     *   a typed BoardUpdateData names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return Board|array The updated Board as an assoc-array at the
     *   SDK boundary; throws TrelloError on failure (item-5 convention).
     */
    ...
    /**
     * Remove an Board matching the given criteria.
     *
     * @param BoardRemoveMatch|array|null $reqmatch Match criteria (id/query
     *   fields) as an assoc-array; BoardRemoveMatch names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return Board|array The removed Board as an assoc-array at the
     *   SDK boundary; throws TrelloError on failure (item-5 convention).
     */
