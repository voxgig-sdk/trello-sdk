...
class AdminEntity
{
    ...
    /**
     * Remove an Admin matching the given criteria.
     *
     * @param AdminRemoveMatch|array|null $reqmatch Match criteria (id/query
     *   fields) as an assoc-array; AdminRemoveMatch names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return Admin|array The removed Admin as an assoc-array at the
     *   SDK boundary; throws TrelloError on failure (item-5 convention).
     */
