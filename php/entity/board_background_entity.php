...
// Trello SDK BoardBackground entity
...
class BoardBackgroundEntity
{
    ...
    {
        $opts = $this->_entopts;
        return new BoardBackgroundEntity($this->_client, $opts);
    }

    /**
     * @param BoardBackground|array $args BoardBackground data (assoc-array) to store.
     */
    public function data_set($args): void
    {
        if ($args) {
            $this->_data = TrelloHelpers::to_map(Struct::clone($args)) ?? [];
            ($this->_utility->feature_hook)($this->_entctx, "SetData");
        }
    }

    /**
     * @return BoardBackground|array The current BoardBackground data as an assoc-array.
     */
    ...
    /**
     * @param array $args Match filter (any subset of BoardBackground fields).
     */
    public function match_set($args): void
    {
        if ($args) {
            $this->_match = TrelloHelpers::to_map(Struct::clone($args)) ?? [];
            ($this->_utility->feature_hook)($this->_entctx, "SetMatch");
        }
    }

    /**
     * @return array The current match filter (any subset of BoardBackground fields).
     */
    ...
    /**
     * Load a single BoardBackground.
     *
     * @param BoardBackgroundLoadMatch|array|null $reqmatch Match criteria (id/query
     *   fields) as an assoc-array; a typed BoardBackgroundLoadMatch names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return BoardBackground|array The loaded BoardBackground as an assoc-array at the
     *   SDK boundary; throws TrelloError on failure (item-5 convention).
     */
        ...
        return $this->_run_op($ctx, function () use ($ctx) {
            if ($ctx->result) {
                ...
                if ($ctx->result->resdata) {
                    $this->_data = TrelloHelpers::to_map(Struct::clone($ctx->result->resdata)) ?? [];
                }
            }
        });
    }
    ...
    /**
     * List BoardBackground items matching the given filter.
     *
     * @param BoardBackgroundListMatch|array|null $reqmatch Match filter (any subset
     *   of BoardBackground fields) as an assoc-array; BoardBackgroundListMatch names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return BoardBackground[]|array A list of BoardBackground items as assoc-arrays at
     *   the SDK boundary; throws TrelloError on failure (item-5 convention).
     */
    ...
    /**
     * Create a new BoardBackground.
     *
     * @param BoardBackgroundCreateData|array|null $reqdata Body data as an assoc-array;
     *   a typed BoardBackgroundCreateData names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return BoardBackground|array The created BoardBackground as an assoc-array at the
     *   SDK boundary; throws TrelloError on failure (item-5 convention).
     */
    ...
    /**
     * Update an existing BoardBackground.
     *
     * @param BoardBackgroundUpdateData|array|null $reqdata Body data as an assoc-array;
     *   a typed BoardBackgroundUpdateData names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return BoardBackground|array The updated BoardBackground as an assoc-array at the
     *   SDK boundary; throws TrelloError on failure (item-5 convention).
     */
    ...
    /**
     * Remove an BoardBackground matching the given criteria.
     *
     * @param BoardBackgroundRemoveMatch|array|null $reqmatch Match criteria (id/query
     *   fields) as an assoc-array; BoardBackgroundRemoveMatch names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return BoardBackground|array The removed BoardBackground as an assoc-array at the
     *   SDK boundary; throws TrelloError on failure (item-5 convention).
     */
