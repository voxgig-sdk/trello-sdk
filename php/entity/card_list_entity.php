...
class CardListEntity
{
    ...
    /**
     * Load a single CardList.
     *
     * @param CardListLoadMatch|array|null $reqmatch Match criteria (id/query
     *   fields) as an assoc-array; a typed CardListLoadMatch names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return CardList|array The loaded CardList as an assoc-array at the
