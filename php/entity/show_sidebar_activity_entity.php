...
// Trello SDK ShowSidebarActivity entity
...
class ShowSidebarActivityEntity
{
    ...
    public function __construct($client, ?array $entopts = null)
    {
        ...
        $this->_name = "show_sidebar_activity";
        $this->_client = $client;
    ...
    {
        $opts = $this->_entopts;
        return new ShowSidebarActivityEntity($this->_client, $opts);
    }

    /**
     * @param ShowSidebarActivity|array $args ShowSidebarActivity data (assoc-array) to store.
     */
    ...
    /**
     * @return ShowSidebarActivity|array The current ShowSidebarActivity data as an assoc-array.
     */
    ...
    /**
     * @param array $args Match filter (any subset of ShowSidebarActivity fields).
     */
    ...
    /**
     * @return array The current match filter (any subset of ShowSidebarActivity fields).
     */
    ...
    /**
     * Update an existing ShowSidebarActivity.
     *
     * @param ShowSidebarActivityUpdateData|array|null $reqdata Body data as an assoc-array;
     *   a typed ShowSidebarActivityUpdateData names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return ShowSidebarActivity|array The updated ShowSidebarActivity as an assoc-array at the
