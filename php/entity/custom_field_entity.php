...
class CustomFieldEntity
{
    ...
    {
        $opts = $this->_entopts;
        return new CustomFieldEntity($this->_client, $opts);
    }

    /**
     * @param CustomField|array $args CustomField data (assoc-array) to store.
     */
    ...
    /**
     * @return CustomField|array The current CustomField data as an assoc-array.
     */
    ...
    /**
     * @param array $args Match filter (any subset of CustomField fields).
     */
    ...
    /**
     * @return array The current match filter (any subset of CustomField fields).
     */
    ...
    /**
     * Load a single CustomField.
     *
     * @param CustomFieldLoadMatch|array|null $reqmatch Match criteria (id/query
     *   fields) as an assoc-array; a typed CustomFieldLoadMatch names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return CustomField|array The loaded CustomField as an assoc-array at the
    ...
    /**
     * List CustomField items matching the given filter.
     *
     * @param CustomFieldListMatch|array|null $reqmatch Match filter (any subset
     *   of CustomField fields) as an assoc-array; CustomFieldListMatch names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return CustomField[]|array A list of CustomField items as assoc-arrays at
     ...
     *
     * @param CustomFieldCreateData|array|null $reqdata Body data as an assoc-array;
     *   a typed CustomFieldCreateData names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return CustomField|array The created CustomField as an assoc-array at the
     *   SDK boundary; throws TrelloError on failure (item-5 convention).
     */
     ...
     *
     * @param CustomFieldUpdateData|array|null $reqdata Body data as an assoc-array;
     *   a typed CustomFieldUpdateData names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return CustomField|array The updated CustomField as an assoc-array at the
     *   SDK boundary; throws TrelloError on failure (item-5 convention).
     */
    ...
    /**
     * Remove an CustomField matching the given criteria.
     *
     * @param CustomFieldRemoveMatch|array|null $reqmatch Match criteria (id/query
     *   fields) as an assoc-array; CustomFieldRemoveMatch names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return CustomField|array The removed CustomField as an assoc-array at the
     *   SDK boundary; throws TrelloError on failure (item-5 convention).
     */
