...
class PluginDataEntity
{
    ...
    {
        $opts = $this->_entopts;
        return new PluginDataEntity($this->_client, $opts);
    }

    /**
     * @param PluginData|array $args PluginData data (assoc-array) to store.
     */
    ...
    /**
     * @return PluginData|array The current PluginData data as an assoc-array.
     */
    ...
    /**
     * @param array $args Match filter (any subset of PluginData fields).
     */
    ...
    /**
     * @return array The current match filter (any subset of PluginData fields).
     */
    ...
    /**
     * Load a single PluginData.
     *
     * @param PluginDataLoadMatch|array|null $reqmatch Match criteria (id/query
     *   fields) as an assoc-array; a typed PluginDataLoadMatch names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return PluginData|array The loaded PluginData as an assoc-array at the
    ...
    /**
     * List PluginData items matching the given filter.
     *
     * @param PluginDataListMatch|array|null $reqmatch Match filter (any subset
     *   of PluginData fields) as an assoc-array; PluginDataListMatch names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return PluginData[]|array A list of PluginData items as assoc-arrays at
