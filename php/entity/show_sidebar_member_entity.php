...
// Trello SDK ShowSidebarMember entity
...
class ShowSidebarMemberEntity
{
    ...
    public function __construct($client, ?array $entopts = null)
    {
        ...
        $this->_name = "show_sidebar_member";
        $this->_client = $client;
    ...
    {
        $opts = $this->_entopts;
        return new ShowSidebarMemberEntity($this->_client, $opts);
    }

    /**
     * @param ShowSidebarMember|array $args ShowSidebarMember data (assoc-array) to store.
     */
    ...
    /**
     * @return ShowSidebarMember|array The current ShowSidebarMember data as an assoc-array.
     */
    ...
    /**
     * @param array $args Match filter (any subset of ShowSidebarMember fields).
     */
    ...
    /**
     * @return array The current match filter (any subset of ShowSidebarMember fields).
     */
    ...
    /**
     * Update an existing ShowSidebarMember.
     *
     * @param ShowSidebarMemberUpdateData|array|null $reqdata Body data as an assoc-array;
     *   a typed ShowSidebarMemberUpdateData names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return ShowSidebarMember|array The updated ShowSidebarMember as an assoc-array at the
