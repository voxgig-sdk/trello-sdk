...
class IdLabelEntity
{
    ...
    {
        $opts = $this->_entopts;
        return new IdLabelEntity($this->_client, $opts);
    }

    /**
     * @param IdLabel|array $args IdLabel data (assoc-array) to store.
     */
    ...
    /**
     * @return IdLabel|array The current IdLabel data as an assoc-array.
     */
    ...
    /**
     * @param array $args Match filter (any subset of IdLabel fields).
     */
    ...
    /**
     * @return array The current match filter (any subset of IdLabel fields).
     */
    ...
    /**
     * Remove an IdLabel matching the given criteria.
     *
     * @param IdLabelRemoveMatch|array|null $reqmatch Match criteria (id/query
     *   fields) as an assoc-array; IdLabelRemoveMatch names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return IdLabel|array The removed IdLabel as an assoc-array at the
