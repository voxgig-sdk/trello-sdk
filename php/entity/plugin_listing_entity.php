...
// Trello SDK PluginListing entity
...
class PluginListingEntity
{
    ...
    {
        $opts = $this->_entopts;
        return new PluginListingEntity($this->_client, $opts);
    }

    /**
     * @param PluginListing|array $args PluginListing data (assoc-array) to store.
     */
    ...
    /**
     * @return PluginListing|array The current PluginListing data as an assoc-array.
     */
    ...
    /**
     * @param array $args Match filter (any subset of PluginListing fields).
     */
    ...
    /**
     * @return array The current match filter (any subset of PluginListing fields).
     */
    ...
    /**
     * Create a new PluginListing.
     *
     * @param PluginListingCreateData|array|null $reqdata Body data as an assoc-array;
     *   a typed PluginListingCreateData names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return PluginListing|array The created PluginListing as an assoc-array at the
    ...
    /**
     * Update an existing PluginListing.
     *
     * @param PluginListingUpdateData|array|null $reqdata Body data as an assoc-array;
     *   a typed PluginListingUpdateData names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return PluginListing|array The updated PluginListing as an assoc-array at the
     *   SDK boundary; throws TrelloError on failure (item-5 convention).
     */
