...
class BoardStarEntity
{
    ...
    {
        $opts = $this->_entopts;
        return new BoardStarEntity($this->_client, $opts);
    }

    /**
     * @param BoardStar|array $args BoardStar data (assoc-array) to store.
     */
    ...
    /**
     * @return BoardStar|array The current BoardStar data as an assoc-array.
     */
    ...
    /**
     * @param array $args Match filter (any subset of BoardStar fields).
     */
    ...
    /**
     * @return array The current match filter (any subset of BoardStar fields).
     */
    ...
    /**
     * Load a single BoardStar.
     *
     * @param BoardStarLoadMatch|array|null $reqmatch Match criteria (id/query
     *   fields) as an assoc-array; a typed BoardStarLoadMatch names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return BoardStar|array The loaded BoardStar as an assoc-array at the
    ...
    /**
     * List BoardStar items matching the given filter.
     *
     * @param BoardStarListMatch|array|null $reqmatch Match filter (any subset
     *   of BoardStar fields) as an assoc-array; BoardStarListMatch names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return BoardStar[]|array A list of BoardStar items as assoc-arrays at
    ...
    /**
     * Create a new BoardStar.
     *
     * @param BoardStarCreateData|array|null $reqdata Body data as an assoc-array;
     *   a typed BoardStarCreateData names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return BoardStar|array The created BoardStar as an assoc-array at the
     *   SDK boundary; throws TrelloError on failure (item-5 convention).
     */
    ...
    /**
     * Update an existing BoardStar.
     *
     * @param BoardStarUpdateData|array|null $reqdata Body data as an assoc-array;
     *   a typed BoardStarUpdateData names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return BoardStar|array The updated BoardStar as an assoc-array at the
     *   SDK boundary; throws TrelloError on failure (item-5 convention).
     */
    ...
    /**
     * Remove an BoardStar matching the given criteria.
     *
     * @param BoardStarRemoveMatch|array|null $reqmatch Match criteria (id/query
     *   fields) as an assoc-array; BoardStarRemoveMatch names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return BoardStar|array The removed BoardStar as an assoc-array at the
     *   SDK boundary; throws TrelloError on failure (item-5 convention).
     */
