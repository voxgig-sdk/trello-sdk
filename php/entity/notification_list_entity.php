...
// Trello SDK NotificationList entity
...
class NotificationListEntity
{
    ...
    {
        $opts = $this->_entopts;
        return new NotificationListEntity($this->_client, $opts);
    }

    /**
     * @param NotificationList|array $args NotificationList data (assoc-array) to store.
     */
    ...
    /**
     * @return NotificationList|array The current NotificationList data as an assoc-array.
     */
    ...
    /**
     * @param array $args Match filter (any subset of NotificationList fields).
     */
    ...
    /**
     * @return array The current match filter (any subset of NotificationList fields).
     */
    ...
    /**
     * Load a single NotificationList.
     *
     * @param NotificationListLoadMatch|array|null $reqmatch Match criteria (id/query
     *   fields) as an assoc-array; a typed NotificationListLoadMatch names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return NotificationList|array The loaded NotificationList as an assoc-array at the
