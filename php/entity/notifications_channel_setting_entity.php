...
class NotificationsChannelSettingEntity
{
    ...
    public function __construct($client, ?array $entopts = null)
    {
        ...
        $this->_name = "notifications_channel_setting";
        $this->_client = $client;
    ...
    {
        $opts = $this->_entopts;
        return new NotificationsChannelSettingEntity($this->_client, $opts);
    }

    /**
     * @param NotificationsChannelSetting|array $args NotificationsChannelSetting data (assoc-array) to store.
     */
    ...
    /**
     * @return NotificationsChannelSetting|array The current NotificationsChannelSetting data as an assoc-array.
     */
    ...
    /**
     * @param array $args Match filter (any subset of NotificationsChannelSetting fields).
     */
    ...
    /**
     * @return array The current match filter (any subset of NotificationsChannelSetting fields).
     */
