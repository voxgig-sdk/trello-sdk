...
class CustomEmojiEntity
{
    ...
    {
        $opts = $this->_entopts;
        return new CustomEmojiEntity($this->_client, $opts);
    }

    /**
     * @param CustomEmoji|array $args CustomEmoji data (assoc-array) to store.
     */
    ...
    /**
     * @return CustomEmoji|array The current CustomEmoji data as an assoc-array.
     */
    ...
    /**
     * @param array $args Match filter (any subset of CustomEmoji fields).
     */
    ...
    /**
     * @return array The current match filter (any subset of CustomEmoji fields).
     */
    ...
    /**
     * Load a single CustomEmoji.
     *
     * @param CustomEmojiLoadMatch|array|null $reqmatch Match criteria (id/query
     *   fields) as an assoc-array; a typed CustomEmojiLoadMatch names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return CustomEmoji|array The loaded CustomEmoji as an assoc-array at the
    ...
    /**
     * List CustomEmoji items matching the given filter.
     *
     * @param CustomEmojiListMatch|array|null $reqmatch Match filter (any subset
     *   of CustomEmoji fields) as an assoc-array; CustomEmojiListMatch names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return CustomEmoji[]|array A list of CustomEmoji items as assoc-arrays at
     ...
     *
     * @param CustomEmojiCreateData|array|null $reqdata Body data as an assoc-array;
     *   a typed CustomEmojiCreateData names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return CustomEmoji|array The created CustomEmoji as an assoc-array at the
     *   SDK boundary; throws TrelloError on failure (item-5 convention).
     */
