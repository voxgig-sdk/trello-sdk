...
// Trello SDK AssociatedDomain entity
...
class AssociatedDomainEntity
{
    ...
    {
        $opts = $this->_entopts;
        return new AssociatedDomainEntity($this->_client, $opts);
    }

    /**
     * @param AssociatedDomain|array $args AssociatedDomain data (assoc-array) to store.
     */
    ...
    /**
     * @return AssociatedDomain|array The current AssociatedDomain data as an assoc-array.
     */
    ...
    /**
     * @param array $args Match filter (any subset of AssociatedDomain fields).
     */
    ...
    /**
     * @return array The current match filter (any subset of AssociatedDomain fields).
     */
    ...
    /**
     * Remove an AssociatedDomain matching the given criteria.
     *
     * @param AssociatedDomainRemoveMatch|array|null $reqmatch Match criteria (id/query
     *   fields) as an assoc-array; AssociatedDomainRemoveMatch names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return AssociatedDomain|array The removed AssociatedDomain as an assoc-array at the
