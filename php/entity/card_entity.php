...
class CardEntity
{
     ...
     *
     * @param CardUpdateData|array|null $reqdata Body data as an assoc-array;
     *   a typed CardUpdateData names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return Card|array The updated Card as an assoc-array at the
     *   SDK boundary; throws TrelloError on failure (item-5 convention).
     */
    ...
    /**
     * Remove an Card matching the given criteria.
     *
     * @param CardRemoveMatch|array|null $reqmatch Match criteria (id/query
     *   fields) as an assoc-array; CardRemoveMatch names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return Card|array The removed Card as an assoc-array at the
     *   SDK boundary; throws TrelloError on failure (item-5 convention).
     */
