...
// Trello SDK TransferrableOrganization entity
...
class TransferrableOrganizationEntity
{
    ...
    public function __construct($client, ?array $entopts = null)
    {
        ...
        $this->_name = "transferrable_organization";
        $this->_client = $client;
    ...
    {
        $opts = $this->_entopts;
        return new TransferrableOrganizationEntity($this->_client, $opts);
    }

    /**
     * @param TransferrableOrganization|array $args TransferrableOrganization data (assoc-array) to store.
     */
    ...
    /**
     * @return TransferrableOrganization|array The current TransferrableOrganization data as an assoc-array.
     */
    ...
    /**
     * @param array $args Match filter (any subset of TransferrableOrganization fields).
     */
    ...
    /**
     * @return array The current match filter (any subset of TransferrableOrganization fields).
     */
    ...
    /**
     * Load a single TransferrableOrganization.
     *
     * @param TransferrableOrganizationLoadMatch|array|null $reqmatch Match criteria (id/query
     *   fields) as an assoc-array; a typed TransferrableOrganizationLoadMatch names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return TransferrableOrganization|array The loaded TransferrableOrganization as an assoc-array at the
