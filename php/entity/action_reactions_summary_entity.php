...
// Trello SDK ActionReactionsSummary entity
...
class ActionReactionsSummaryEntity
{
    ...
    public function __construct($client, ?array $entopts = null)
    {
        ...
        $this->_name = "action_reactions_summary";
        $this->_client = $client;
    ...
    {
        $opts = $this->_entopts;
        return new ActionReactionsSummaryEntity($this->_client, $opts);
    }

    /**
     * @param ActionReactionsSummary|array $args ActionReactionsSummary data (assoc-array) to store.
     */
    ...
    /**
     * @return ActionReactionsSummary|array The current ActionReactionsSummary data as an assoc-array.
     */
    ...
    /**
     * @param array $args Match filter (any subset of ActionReactionsSummary fields).
     */
    ...
    /**
     * @return array The current match filter (any subset of ActionReactionsSummary fields).
     */
    ...
    /**
     * Load a single ActionReactionsSummary.
     *
     * @param ActionReactionsSummaryLoadMatch|array|null $reqmatch Match criteria (id/query
     *   fields) as an assoc-array; a typed ActionReactionsSummaryLoadMatch names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return ActionReactionsSummary|array The loaded ActionReactionsSummary as an assoc-array at the
