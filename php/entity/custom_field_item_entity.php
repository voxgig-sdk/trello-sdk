...
// Trello SDK CustomFieldItem entity
...
class CustomFieldItemEntity
{
    ...
    {
        $opts = $this->_entopts;
        return new CustomFieldItemEntity($this->_client, $opts);
    }

    /**
     * @param CustomFieldItem|array $args CustomFieldItem data (assoc-array) to store.
     */
    ...
    /**
     * @return CustomFieldItem|array The current CustomFieldItem data as an assoc-array.
     */
    ...
    /**
     * @param array $args Match filter (any subset of CustomFieldItem fields).
     */
    ...
    /**
     * @return array The current match filter (any subset of CustomFieldItem fields).
     */
    ...
    /**
     * List CustomFieldItem items matching the given filter.
     *
     * @param CustomFieldItemListMatch|array|null $reqmatch Match filter (any subset
     *   of CustomFieldItem fields) as an assoc-array; CustomFieldItemListMatch names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return CustomFieldItem[]|array A list of CustomFieldItem items as assoc-arrays at
