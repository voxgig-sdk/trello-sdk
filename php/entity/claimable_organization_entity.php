...
class ClaimableOrganizationEntity
{
    ...
    public function __construct($client, ?array $entopts = null)
    {
        ...
        $this->_name = "claimable_organization";
        $this->_client = $client;
    ...
    {
        $opts = $this->_entopts;
        return new ClaimableOrganizationEntity($this->_client, $opts);
    }

    /**
     * @param ClaimableOrganization|array $args ClaimableOrganization data (assoc-array) to store.
     */
    ...
    /**
     * @return ClaimableOrganization|array The current ClaimableOrganization data as an assoc-array.
     */
    ...
    /**
     * @param array $args Match filter (any subset of ClaimableOrganization fields).
     */
    ...
    /**
     * @return array The current match filter (any subset of ClaimableOrganization fields).
     */
    ...
    /**
     * List ClaimableOrganization items matching the given filter.
     *
     * @param ClaimableOrganizationListMatch|array|null $reqmatch Match filter (any subset
     *   of ClaimableOrganization fields) as an assoc-array; ClaimableOrganizationListMatch names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return ClaimableOrganization[]|array A list of ClaimableOrganization items as assoc-arrays at
