...
class ReadEntity
{
    ...
    {
        $opts = $this->_entopts;
        return new ReadEntity($this->_client, $opts);
    }

    /**
     * @param Read|array $args Read data (assoc-array) to store.
     */
    ...
    /**
     * @return Read|array The current Read data as an assoc-array.
     */
    ...
    /**
     * @param array $args Match filter (any subset of Read fields).
     */
    ...
    /**
     * @return array The current match filter (any subset of Read fields).
     */
     ...
     * Create a new Read.
     *
     * @param ReadCreateData|array|null $reqdata Body data as an assoc-array;
     *   a typed ReadCreateData names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return Read|array The created Read as an assoc-array at the
