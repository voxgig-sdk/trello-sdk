...
class LabelEntity
{
    ...
    /**
     * Remove an Label matching the given criteria.
     *
     * @param LabelRemoveMatch|array|null $reqmatch Match criteria (id/query
     *   fields) as an assoc-array; LabelRemoveMatch names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return Label|array The removed Label as an assoc-array at the
     *   SDK boundary; throws TrelloError on failure (item-5 convention).
     */
