...
class IdMemberEntity
{
    ...
    {
        $opts = $this->_entopts;
        return new IdMemberEntity($this->_client, $opts);
    }

    /**
     * @param IdMember|array $args IdMember data (assoc-array) to store.
     */
    ...
    /**
     * @return IdMember|array The current IdMember data as an assoc-array.
     */
    ...
    /**
     * @param array $args Match filter (any subset of IdMember fields).
     */
    ...
    /**
     * @return array The current match filter (any subset of IdMember fields).
     */
    ...
    /**
     * Remove an IdMember matching the given criteria.
     *
     * @param IdMemberRemoveMatch|array|null $reqmatch Match criteria (id/query
     *   fields) as an assoc-array; IdMemberRemoveMatch names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return IdMember|array The removed IdMember as an assoc-array at the
