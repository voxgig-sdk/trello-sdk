...
// Trello SDK ExportDownload entity
...
class ExportDownloadEntity
{
    ...
    {
        $opts = $this->_entopts;
        return new ExportDownloadEntity($this->_client, $opts);
    }

    /**
     * @param ExportDownload|array $args ExportDownload data (assoc-array) to store.
     */
    ...
    /**
     * @return ExportDownload|array The current ExportDownload data as an assoc-array.
     */
    ...
    /**
     * @param array $args Match filter (any subset of ExportDownload fields).
     */
    ...
    /**
     * @return array The current match filter (any subset of ExportDownload fields).
     */
    ...
    /**
     * Load a single ExportDownload.
     *
     * @param ExportDownloadLoadMatch|array|null $reqmatch Match criteria (id/query
     *   fields) as an assoc-array; a typed ExportDownloadLoadMatch names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return ExportDownload|array The loaded ExportDownload as an assoc-array at the
