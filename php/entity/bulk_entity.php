...
class BulkEntity
{
     ...
     * Load a single Bulk.
     *
     * @param BulkLoadMatch|array|null $reqmatch Match criteria (id/query
     *   fields) as an assoc-array; a typed BulkLoadMatch names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return Bulk|array The loaded Bulk as an assoc-array at the
    ...
    /**
     * Update an existing Bulk.
     *
     * @param BulkUpdateData|array|null $reqdata Body data as an assoc-array;
     *   a typed BulkUpdateData names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return Bulk|array The updated Bulk as an assoc-array at the
     *   SDK boundary; throws TrelloError on failure (item-5 convention).
     */
