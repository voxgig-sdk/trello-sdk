...
class ShowSidebarBoardActionEntity
{
    ...
    public function __construct($client, ?array $entopts = null)
    {
        ...
        $this->_name = "show_sidebar_board_action";
        $this->_client = $client;
    ...
    {
        $opts = $this->_entopts;
        return new ShowSidebarBoardActionEntity($this->_client, $opts);
    }

    /**
     * @param ShowSidebarBoardAction|array $args ShowSidebarBoardAction data (assoc-array) to store.
     */
    ...
    /**
     * @return ShowSidebarBoardAction|array The current ShowSidebarBoardAction data as an assoc-array.
     */
    ...
    /**
     * @param array $args Match filter (any subset of ShowSidebarBoardAction fields).
     */
    ...
    /**
     * @return array The current match filter (any subset of ShowSidebarBoardAction fields).
     */
    ...
    /**
     * Update an existing ShowSidebarBoardAction.
     *
     * @param ShowSidebarBoardActionUpdateData|array|null $reqdata Body data as an assoc-array;
     *   a typed ShowSidebarBoardActionUpdateData names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return ShowSidebarBoardAction|array The updated ShowSidebarBoardAction as an assoc-array at the
