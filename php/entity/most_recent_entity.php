...
class MostRecentEntity
{
    ...
    {
        $opts = $this->_entopts;
        return new MostRecentEntity($this->_client, $opts);
    }

    /**
     * @param MostRecent|array $args MostRecent data (assoc-array) to store.
     */
    ...
    /**
     * @return MostRecent|array The current MostRecent data as an assoc-array.
     */
    ...
    /**
     * @param array $args Match filter (any subset of MostRecent fields).
     */
    ...
    /**
     * @return array The current match filter (any subset of MostRecent fields).
     */
