...
// Trello SDK EmailPosition entity
...
class EmailPositionEntity
{
    ...
    {
        $opts = $this->_entopts;
        return new EmailPositionEntity($this->_client, $opts);
    }

    /**
     * @param EmailPosition|array $args EmailPosition data (assoc-array) to store.
     */
    ...
    /**
     * @return EmailPosition|array The current EmailPosition data as an assoc-array.
     */
    ...
    /**
     * @param array $args Match filter (any subset of EmailPosition fields).
     */
    ...
    /**
     * @return array The current match filter (any subset of EmailPosition fields).
     */
    ...
    /**
     * Update an existing EmailPosition.
     *
     * @param EmailPositionUpdateData|array|null $reqdata Body data as an assoc-array;
     *   a typed EmailPositionUpdateData names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return EmailPosition|array The updated EmailPosition as an assoc-array at the
