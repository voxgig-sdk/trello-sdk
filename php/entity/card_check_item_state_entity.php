...
// Trello SDK CardCheckItemState entity
...
class CardCheckItemStateEntity
{
    ...
    public function __construct($client, ?array $entopts = null)
    {
        ...
        $this->_name = "card_check_item_state";
        $this->_client = $client;
    ...
    {
        $opts = $this->_entopts;
        return new CardCheckItemStateEntity($this->_client, $opts);
    }

    /**
     * @param CardCheckItemState|array $args CardCheckItemState data (assoc-array) to store.
     */
    ...
    /**
     * @return CardCheckItemState|array The current CardCheckItemState data as an assoc-array.
     */
    ...
    /**
     * @param array $args Match filter (any subset of CardCheckItemState fields).
     */
    ...
    /**
     * @return array The current match filter (any subset of CardCheckItemState fields).
     */
    ...
    /**
     * Load a single CardCheckItemState.
     *
     * @param CardCheckItemStateLoadMatch|array|null $reqmatch Match criteria (id/query
     *   fields) as an assoc-array; a typed CardCheckItemStateLoadMatch names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return CardCheckItemState|array The loaded CardCheckItemState as an assoc-array at the
