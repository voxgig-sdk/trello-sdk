...
class ShowSidebarEntity
{
    ...
    {
        $opts = $this->_entopts;
        return new ShowSidebarEntity($this->_client, $opts);
    }

    /**
     * @param ShowSidebar|array $args ShowSidebar data (assoc-array) to store.
     */
    ...
    /**
     * @return ShowSidebar|array The current ShowSidebar data as an assoc-array.
     */
    ...
    /**
     * @param array $args Match filter (any subset of ShowSidebar fields).
     */
    ...
    /**
     * @return array The current match filter (any subset of ShowSidebar fields).
     */
    ...
    /**
     * Update an existing ShowSidebar.
     *
     * @param ShowSidebarUpdateData|array|null $reqdata Body data as an assoc-array;
     *   a typed ShowSidebarUpdateData names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return ShowSidebar|array The updated ShowSidebar as an assoc-array at the
