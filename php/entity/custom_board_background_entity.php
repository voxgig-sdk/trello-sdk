...
// Trello SDK CustomBoardBackground entity
...
class CustomBoardBackgroundEntity
{
    ...
    public function __construct($client, ?array $entopts = null)
    {
        ...
        $this->_name = "custom_board_background";
        $this->_client = $client;
    ...
    {
        $opts = $this->_entopts;
        return new CustomBoardBackgroundEntity($this->_client, $opts);
    }

    /**
     * @param CustomBoardBackground|array $args CustomBoardBackground data (assoc-array) to store.
     */
    ...
    /**
     * @return CustomBoardBackground|array The current CustomBoardBackground data as an assoc-array.
     */
    ...
    /**
     * @param array $args Match filter (any subset of CustomBoardBackground fields).
     */
    ...
    /**
     * @return array The current match filter (any subset of CustomBoardBackground fields).
     */
    ...
    /**
     * Remove an CustomBoardBackground matching the given criteria.
     *
     * @param CustomBoardBackgroundRemoveMatch|array|null $reqmatch Match criteria (id/query
     *   fields) as an assoc-array; CustomBoardBackgroundRemoveMatch names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return CustomBoardBackground|array The removed CustomBoardBackground as an assoc-array at the
