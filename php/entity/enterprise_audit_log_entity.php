...
// Trello SDK EnterpriseAuditLog entity
...
class EnterpriseAuditLogEntity
{
    ...
    public function __construct($client, ?array $entopts = null)
    {
        ...
        $this->_name = "enterprise_audit_log";
        $this->_client = $client;
    ...
    {
        $opts = $this->_entopts;
        return new EnterpriseAuditLogEntity($this->_client, $opts);
    }

    /**
     * @param EnterpriseAuditLog|array $args EnterpriseAuditLog data (assoc-array) to store.
     */
    ...
    /**
     * @return EnterpriseAuditLog|array The current EnterpriseAuditLog data as an assoc-array.
     */
    ...
    /**
     * @param array $args Match filter (any subset of EnterpriseAuditLog fields).
     */
    ...
    /**
     * @return array The current match filter (any subset of EnterpriseAuditLog fields).
     */
    ...
    /**
     * List EnterpriseAuditLog items matching the given filter.
     *
     * @param EnterpriseAuditLogListMatch|array|null $reqmatch Match filter (any subset
     *   of EnterpriseAuditLog fields) as an assoc-array; EnterpriseAuditLogListMatch names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return EnterpriseAuditLog[]|array A list of EnterpriseAuditLog items as assoc-arrays at
