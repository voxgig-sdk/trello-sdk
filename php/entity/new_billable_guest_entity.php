...
// Trello SDK NewBillableGuest entity
...
class NewBillableGuestEntity
{
    ...
    {
        $opts = $this->_entopts;
        return new NewBillableGuestEntity($this->_client, $opts);
    }

    /**
     * @param NewBillableGuest|array $args NewBillableGuest data (assoc-array) to store.
     */
    ...
    /**
     * @return NewBillableGuest|array The current NewBillableGuest data as an assoc-array.
     */
    ...
    /**
     * @param array $args Match filter (any subset of NewBillableGuest fields).
     */
    ...
    /**
     * @return array The current match filter (any subset of NewBillableGuest fields).
     */
    ...
    /**
     * Load a single NewBillableGuest.
     *
     * @param NewBillableGuestLoadMatch|array|null $reqmatch Match criteria (id/query
     *   fields) as an assoc-array; a typed NewBillableGuestLoadMatch names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return NewBillableGuest|array The loaded NewBillableGuest as an assoc-array at the
