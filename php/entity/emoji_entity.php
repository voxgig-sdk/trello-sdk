...
class EmojiEntity
{
    ...
    /**
     * List Emoji items matching the given filter.
     *
     * @param EmojiListMatch|array|null $reqmatch Match filter (any subset
     *   of Emoji fields) as an assoc-array; EmojiListMatch names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return Emoji[]|array A list of Emoji items as assoc-arrays at
