...
class EnterprisEntity
{
    ...
    {
        $opts = $this->_entopts;
        return new EnterprisEntity($this->_client, $opts);
    }

    /**
     * @param Enterpris|array $args Enterpris data (assoc-array) to store.
     */
    ...
    /**
     * @return Enterpris|array The current Enterpris data as an assoc-array.
     */
    ...
    /**
     * @param array $args Match filter (any subset of Enterpris fields).
     */
    ...
    /**
     * @return array The current match filter (any subset of Enterpris fields).
     */
    ...
    /**
     * Load a single Enterpris.
     *
     * @param EnterprisLoadMatch|array|null $reqmatch Match criteria (id/query
     *   fields) as an assoc-array; a typed EnterprisLoadMatch names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return Enterpris|array The loaded Enterpris as an assoc-array at the
    ...
    /**
     * Create a new Enterpris.
     *
     * @param EnterprisCreateData|array|null $reqdata Body data as an assoc-array;
     *   a typed EnterprisCreateData names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return Enterpris|array The created Enterpris as an assoc-array at the
     *   SDK boundary; throws TrelloError on failure (item-5 convention).
     */
    ...
    /**
     * Update an existing Enterpris.
     *
     * @param EnterprisUpdateData|array|null $reqdata Body data as an assoc-array;
     *   a typed EnterprisUpdateData names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return Enterpris|array The updated Enterpris as an assoc-array at the
     *   SDK boundary; throws TrelloError on failure (item-5 convention).
     */
