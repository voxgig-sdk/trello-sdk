...
// Trello SDK CustomSticker entity
...
class CustomStickerEntity
{
    ...
    {
        $opts = $this->_entopts;
        return new CustomStickerEntity($this->_client, $opts);
    }

    /**
     * @param CustomSticker|array $args CustomSticker data (assoc-array) to store.
     */
    ...
    /**
     * @return CustomSticker|array The current CustomSticker data as an assoc-array.
     */
    ...
    /**
     * @param array $args Match filter (any subset of CustomSticker fields).
     */
    ...
    /**
     * @return array The current match filter (any subset of CustomSticker fields).
     */
    ...
    /**
     * Load a single CustomSticker.
     *
     * @param CustomStickerLoadMatch|array|null $reqmatch Match criteria (id/query
     *   fields) as an assoc-array; a typed CustomStickerLoadMatch names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return CustomSticker|array The loaded CustomSticker as an assoc-array at the
    ...
    /**
     * List CustomSticker items matching the given filter.
     *
     * @param CustomStickerListMatch|array|null $reqmatch Match filter (any subset
     *   of CustomSticker fields) as an assoc-array; CustomStickerListMatch names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return CustomSticker[]|array A list of CustomSticker items as assoc-arrays at
    ...
    /**
     * Create a new CustomSticker.
     *
     * @param CustomStickerCreateData|array|null $reqdata Body data as an assoc-array;
     *   a typed CustomStickerCreateData names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return CustomSticker|array The created CustomSticker as an assoc-array at the
     *   SDK boundary; throws TrelloError on failure (item-5 convention).
     */
    ...
    /**
     * Remove an CustomSticker matching the given criteria.
     *
     * @param CustomStickerRemoveMatch|array|null $reqmatch Match criteria (id/query
     *   fields) as an assoc-array; CustomStickerRemoveMatch names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return CustomSticker|array The removed CustomSticker as an assoc-array at the
     *   SDK boundary; throws TrelloError on failure (item-5 convention).
     */
