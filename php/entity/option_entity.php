...
class OptionEntity
{
     ...
     *
     * @param OptionLoadMatch|array|null $reqmatch Match criteria (id/query
     *   fields) as an assoc-array; a typed OptionLoadMatch names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return Option|array The loaded Option as an assoc-array at the
    ...
    /**
     * Remove an Option matching the given criteria.
     *
     * @param OptionRemoveMatch|array|null $reqmatch Match criteria (id/query
     *   fields) as an assoc-array; OptionRemoveMatch names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return Option|array The removed Option as an assoc-array at the
     *   SDK boundary; throws TrelloError on failure (item-5 convention).
     */
