...
// Trello SDK EnterprisSignupUrl entity
...
class EnterprisSignupUrlEntity
{
    ...
    public function __construct($client, ?array $entopts = null)
    {
        ...
        $this->_name = "enterpris_signup_url";
        $this->_client = $client;
    ...
    {
        $opts = $this->_entopts;
        return new EnterprisSignupUrlEntity($this->_client, $opts);
    }

    /**
     * @param EnterprisSignupUrl|array $args EnterprisSignupUrl data (assoc-array) to store.
     */
    ...
    /**
     * @return EnterprisSignupUrl|array The current EnterprisSignupUrl data as an assoc-array.
     */
    ...
    /**
     * @param array $args Match filter (any subset of EnterprisSignupUrl fields).
     */
    ...
    /**
     * @return array The current match filter (any subset of EnterprisSignupUrl fields).
     */
    ...
    /**
     * Load a single EnterprisSignupUrl.
     *
     * @param EnterprisSignupUrlLoadMatch|array|null $reqmatch Match criteria (id/query
     *   fields) as an assoc-array; a typed EnterprisSignupUrlLoadMatch names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return EnterprisSignupUrl|array The loaded EnterprisSignupUrl as an assoc-array at the
