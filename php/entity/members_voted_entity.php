...
// Trello SDK MembersVoted entity
...
class MembersVotedEntity
{
    ...
    {
        $opts = $this->_entopts;
        return new MembersVotedEntity($this->_client, $opts);
    }

    /**
     * @param MembersVoted|array $args MembersVoted data (assoc-array) to store.
     */
    ...
    /**
     * @return MembersVoted|array The current MembersVoted data as an assoc-array.
     */
    ...
    /**
     * @param array $args Match filter (any subset of MembersVoted fields).
     */
    ...
    /**
     * @return array The current match filter (any subset of MembersVoted fields).
     */
    ...
    /**
     * Load a single MembersVoted.
     *
     * @param MembersVotedLoadMatch|array|null $reqmatch Match criteria (id/query
     *   fields) as an assoc-array; a typed MembersVotedLoadMatch names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return MembersVoted|array The loaded MembersVoted as an assoc-array at the
    ...
    /**
     * Remove an MembersVoted matching the given criteria.
     *
     * @param MembersVotedRemoveMatch|array|null $reqmatch Match criteria (id/query
     *   fields) as an assoc-array; MembersVotedRemoveMatch names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return MembersVoted|array The removed MembersVoted as an assoc-array at the
     *   SDK boundary; throws TrelloError on failure (item-5 convention).
     */
