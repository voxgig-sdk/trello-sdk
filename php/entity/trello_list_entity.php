...
class TrelloListEntity
{
    ...
    {
        $opts = $this->_entopts;
        return new TrelloListEntity($this->_client, $opts);
    }

    /**
     * @param TrelloList|array $args TrelloList data (assoc-array) to store.
     */
    ...
    /**
     * @return TrelloList|array The current TrelloList data as an assoc-array.
     */
    ...
    /**
     * @param array $args Match filter (any subset of TrelloList fields).
     */
    ...
    /**
     * @return array The current match filter (any subset of TrelloList fields).
     */
    ...
    /**
     * Load a single TrelloList.
     *
     * @param TrelloListLoadMatch|array|null $reqmatch Match criteria (id/query
     *   fields) as an assoc-array; a typed TrelloListLoadMatch names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return TrelloList|array The loaded TrelloList as an assoc-array at the
    ...
    /**
     * List TrelloList items matching the given filter.
     *
     * @param TrelloListListMatch|array|null $reqmatch Match filter (any subset
     *   of TrelloList fields) as an assoc-array; TrelloListListMatch names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return TrelloList[]|array A list of TrelloList items as assoc-arrays at
    ...
    /**
     * Create a new TrelloList.
     *
     * @param TrelloListCreateData|array|null $reqdata Body data as an assoc-array;
     *   a typed TrelloListCreateData names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return TrelloList|array The created TrelloList as an assoc-array at the
     *   SDK boundary; throws TrelloError on failure (item-5 convention).
     */
