...
class EnterpriseAuditLogDirectTest extends TestCase
{
    public function test_direct_list_enterprise_audit_log(): void
    {
        $setup = enterprise_audit_log_direct_setup([
            ["id" => "direct01"],
            ["id" => "direct02"],
        ]);
        [$_shouldSkip, $_reason] = Runner::is_control_skipped("direct", "direct-list-enterprise_audit_log", $setup["live"] ? "live" : "unit");
        if ($_shouldSkip) {
