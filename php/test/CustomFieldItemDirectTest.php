...
class CustomFieldItemDirectTest extends TestCase
{
    public function test_direct_list_custom_field_item(): void
    {
        $setup = custom_field_item_direct_setup([
            ["id" => "direct01"],
            ["id" => "direct02"],
        ]);
        [$_shouldSkip, $_reason] = Runner::is_control_skipped("direct", "direct-list-custom_field_item", $setup["live"] ? "live" : "unit");
        if ($_shouldSkip) {
