...
class AdminEntityTest extends TestCase
{
    ...
    public function test_basic_flow(): void
    {
        ...
        if (!empty($setup["synthetic_only"])) {
            $this->markTestSkipped("live entity test uses synthetic IDs from fixture — set TRELLO_TEST_ADMIN_ENTID JSON to run live");
            return;
        }
        $client = $setup["client"];
...
function admin_basic_setup($extra)
{
    ...
    $entid_env_raw = getenv("TRELLO_TEST_ADMIN_ENTID");
