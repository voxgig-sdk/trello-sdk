...
class BulkDirectTest extends TestCase
{
    public function test_direct_load_bulk(): void
    {
        $setup = bulk_direct_setup(["id" => "direct01"]);
        [$_shouldSkip, $_reason] = Runner::is_control_skipped("direct", "direct-load-bulk", $setup["live"] ? "live" : "unit");
        if ($_shouldSkip) {
