...
class TrelloTestRunner
{
    ...
    {
        $live = self::getenv('TRELLO_TEST_LIVE');
        $override = self::getenv('TRELLO_TEST_OVERRIDE');
        ...
        $explain = self::getenv('TRELLO_TEST_EXPLAIN');
...
class_alias('TrelloTestRunner', 'Runner');
class_alias('TrelloHelpers', 'Helpers');
