...
class TokenEntityTest extends TestCase
{
    ...
    public function test_basic_flow(): void
    {
        ...
        if (!empty($setup["synthetic_only"])) {
            $this->markTestSkipped("live entity test uses synthetic IDs from fixture — set TRELLO_TEST_TOKEN_ENTID JSON to run live");
            return;
        }
        $client = $setup["client"];
...
function token_basic_setup($extra)
{
    ...
    // Generate idmap.
    $idmap = [];
    foreach (["token01", "token02", "token03", "member01", "member02", "member03"] as $k) {
    ...
    $entid_env_raw = getenv("TRELLO_TEST_TOKEN_ENTID");
