...
class PendingOrganizationDirectTest extends TestCase
{
    public function test_direct_list_pending_organization(): void
    {
        $setup = pending_organization_direct_setup([
            ["id" => "direct01"],
            ["id" => "direct02"],
        ]);
        [$_shouldSkip, $_reason] = Runner::is_control_skipped("direct", "direct-list-pending_organization", $setup["live"] ? "live" : "unit");
        if ($_shouldSkip) {
