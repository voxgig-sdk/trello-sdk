...
// Trello SDK — documentation example COMPLETENESS GATE.
//
...
//      EXECUTED offline in seeded test mode (TrelloSDK::test)
...
{
    private const SDK_CLASS = 'TrelloSDK';
    ...
    private const SDK_BASE = 'trello_sdk';
