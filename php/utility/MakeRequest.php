...
// Trello SDK utility: make_request

require_once __DIR__ . '/../core/Response.php';
require_once __DIR__ . '/../core/Result.php';

class TrelloMakeRequest
{
    public static function call(TrelloContext $ctx): array
    {
        ...
        if ($fetch_err) {
            ...
            $response = new TrelloResponse(['err' => $ctx->make_error('request_no_response', 'response: undefined')]);
        } elseif (is_array($fetched)) {
            $response = new TrelloResponse($fetched);
        } else {
