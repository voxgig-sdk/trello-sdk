...
class TrelloFetcher
{
    ...
    public const DEFAULT_USER_AGENT = 'Mozilla/5.0 (compatible; TrelloSDK/1.0)';
    ...
    public static function call(TrelloContext $ctx, string $fullurl, array $fetchdef): array
    {
