...
class TrelloPagingFeature extends TrelloBaseFeature
{
    ...
    private function _graphql_pre_request(TrelloContext $ctx, array $paging): void
    {
        $body = $ctx->spec->body;
        if (!is_array($body)) {
            return;
    ...
    private function _is_list(TrelloContext $ctx): bool
    {
