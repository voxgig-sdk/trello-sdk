...
class TrelloRatelimitFeature extends TrelloBaseFeature
{
    ...
    private function _acquire(TrelloContext $ctx): void
    {
    ...
    private function _track(TrelloContext $_ctx, float $wait_ms): void
    {
        $client = $this->client;
