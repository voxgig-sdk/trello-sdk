...
// Trello SDK test feature

require_once __DIR__ . '/BaseFeature.php';
require_once __DIR__ . '/../utility/Param.php';

class TrelloTestFeature extends TrelloBaseFeature
{
    ...
    public function init(TrelloContext $ctx, array $options): void
    {
        ...
        $test_fetcher = function (TrelloContext $fctx, string $_fullurl, array $_fetchdef) use ($entity): array {
    ...
    public function makeNetsim(array $net, callable $inner): callable
    {
        ...
        return function (TrelloContext $fctx, string $url, array $fetchdef) use ($net, $inner, $pick_latency, $sleep): array {
            $this->_netcalls++;
            $call = $this->_netcalls;
     ...
     */
    public function buildArgs(TrelloContext $ctx, $op, $args): array
    {
