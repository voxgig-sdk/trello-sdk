...
class TrelloTimeoutFeature extends TrelloBaseFeature
{
    ...
    private function _with_timeout(TrelloContext $ctx, string $url, array $fetchdef, callable $inner): array
    {
    ...
    private function _track(TrelloContext $_ctx, float $ms): void
    {
        $client = $this->client;
