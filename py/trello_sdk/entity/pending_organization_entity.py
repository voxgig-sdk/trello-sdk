...
class PendingOrganizationEntity:
    ...
    def make(self):
        ...
        for k, v in self._entopts.items():
            opts[k] = v
        return PendingOrganizationEntity(self._client, opts)
    ...
    def data_get(self) -> PendingOrganization:
    ...
    def match_get(self) -> PendingOrganization:
    ...
    def list(self, reqmatch=None, ctrl=None) -> list[PendingOrganization]:
        utility = self._utility
        # reqmatch is optional: an omitted match lists all records. Treat None
        # as an empty match so client.PendingOrganization().list() works with no args.
        if reqmatch is None:
            reqmatch = {}
