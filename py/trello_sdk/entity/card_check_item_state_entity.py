...
class CardCheckItemStateEntity:
    ...
    def make(self):
        ...
        for k, v in self._entopts.items():
            opts[k] = v
        return CardCheckItemStateEntity(self._client, opts)
    ...
    def data_get(self) -> CardCheckItemState:
    ...
    def match_get(self) -> CardCheckItemState:
    ...
    def load(self, reqmatch=None, ctrl=None) -> CardCheckItemState:
        utility = self._utility
        # reqmatch is optional: an entity with no id-like key loads with no
        # match. Treat None as an empty match so client.CardCheckItemState().load()
        # works with no args.
        if reqmatch is None:
            reqmatch = {}
