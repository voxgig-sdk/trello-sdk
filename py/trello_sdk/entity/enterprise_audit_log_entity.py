...
class EnterpriseAuditLogEntity:
    ...
    def make(self):
        ...
        for k, v in self._entopts.items():
            opts[k] = v
        return EnterpriseAuditLogEntity(self._client, opts)
    ...
    def data_get(self) -> EnterpriseAuditLog:
    ...
    def match_get(self) -> EnterpriseAuditLog:
    ...
    def list(self, reqmatch=None, ctrl=None) -> list[EnterpriseAuditLog]:
        utility = self._utility
        # reqmatch is optional: an omitted match lists all records. Treat None
        # as an empty match so client.EnterpriseAuditLog().list() works with no args.
        if reqmatch is None:
            reqmatch = {}
