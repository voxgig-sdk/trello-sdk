...
class ActionReactionsSummaryEntity:
    ...
    def make(self):
        ...
        for k, v in self._entopts.items():
            opts[k] = v
        return ActionReactionsSummaryEntity(self._client, opts)
    ...
    def data_get(self) -> ActionReactionsSummary:
    ...
    def match_get(self) -> ActionReactionsSummary:
    ...
    def load(self, reqmatch=None, ctrl=None) -> ActionReactionsSummary:
        utility = self._utility
        # reqmatch is optional: an entity with no id-like key loads with no
        # match. Treat None as an empty match so client.ActionReactionsSummary().load()
        # works with no args.
        if reqmatch is None:
            reqmatch = {}
