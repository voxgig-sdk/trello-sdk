...
class EnterprisSignupUrlEntity:
    ...
    def make(self):
        ...
        for k, v in self._entopts.items():
            opts[k] = v
        return EnterprisSignupUrlEntity(self._client, opts)
    ...
    def data_get(self) -> EnterprisSignupUrl:
    ...
    def match_get(self) -> EnterprisSignupUrl:
    ...
    def load(self, reqmatch=None, ctrl=None) -> EnterprisSignupUrl:
        utility = self._utility
        # reqmatch is optional: an entity with no id-like key loads with no
        # match. Treat None as an empty match so client.EnterprisSignupUrl().load()
        # works with no args.
        if reqmatch is None:
            reqmatch = {}
