...
class ShowSidebarEntity:
    ...
    def make(self):
        ...
        for k, v in self._entopts.items():
            opts[k] = v
        return ShowSidebarEntity(self._client, opts)
    ...
    def match_get(self) -> ShowSidebar:
    ...
    def update(self, reqdata: ShowSidebarUpdateData, ctrl=None) -> ShowSidebar:
        utility = self._utility
