...
class CustomFieldItemEntity:
    ...
    def make(self):
        ...
        for k, v in self._entopts.items():
            opts[k] = v
        return CustomFieldItemEntity(self._client, opts)
    ...
    def data_get(self) -> CustomFieldItem:
    ...
    def match_get(self) -> CustomFieldItem:
    ...
    def list(self, reqmatch=None, ctrl=None) -> list[CustomFieldItem]:
        utility = self._utility
        # reqmatch is optional: an omitted match lists all records. Treat None
        # as an empty match so client.CustomFieldItem().list() works with no args.
        if reqmatch is None:
            reqmatch = {}
