...
class ApplicationComplianceEntity:
    ...
    def make(self):
        ...
        for k, v in self._entopts.items():
            opts[k] = v
        return ApplicationComplianceEntity(self._client, opts)
    ...
    def data_get(self) -> ApplicationCompliance:
    ...
    def match_get(self) -> ApplicationCompliance:
    ...
    def load(self, reqmatch=None, ctrl=None) -> ApplicationCompliance:
        utility = self._utility
        # reqmatch is optional: an entity with no id-like key loads with no
        # match. Treat None as an empty match so client.ApplicationCompliance().load()
        # works with no args.
        if reqmatch is None:
            reqmatch = {}
