...
class PluginListingEntity:
    ...
    def make(self):
        ...
        for k, v in self._entopts.items():
            opts[k] = v
        return PluginListingEntity(self._client, opts)
    ...
    def data_get(self) -> PluginListing:
    ...
    def match_get(self) -> PluginListing:
    ...
    def create(self, reqdata: PluginListingCreateData, ctrl=None) -> PluginListing:
        utility = self._utility
    ...
    def update(self, reqdata: PluginListingUpdateData, ctrl=None) -> PluginListing:
        utility = self._utility
        ctx = utility.make_context({
            "opname": "update",
            "ctrl": ctrl,
