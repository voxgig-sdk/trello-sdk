...
class NotificationMemberCreatorEntity:
    ...
    def make(self):
        ...
        for k, v in self._entopts.items():
            opts[k] = v
        return NotificationMemberCreatorEntity(self._client, opts)
    ...
    def data_get(self) -> NotificationMemberCreator:
    ...
    def match_get(self) -> NotificationMemberCreator:
    ...
    def load(self, reqmatch=None, ctrl=None) -> NotificationMemberCreator:
        utility = self._utility
        # reqmatch is optional: an entity with no id-like key loads with no
        # match. Treat None as an empty match so client.NotificationMemberCreator().load()
        # works with no args.
        if reqmatch is None:
            reqmatch = {}
