...
class NewBillableGuestEntity:
    ...
    def make(self):
        ...
        for k, v in self._entopts.items():
            opts[k] = v
        return NewBillableGuestEntity(self._client, opts)
    ...
    def data_get(self) -> NewBillableGuest:
    ...
    def match_get(self) -> NewBillableGuest:
    ...
    def load(self, reqmatch=None, ctrl=None) -> NewBillableGuest:
        utility = self._utility
        # reqmatch is optional: an entity with no id-like key loads with no
        # match. Treat None as an empty match so client.NewBillableGuest().load()
        # works with no args.
        if reqmatch is None:
            reqmatch = {}
