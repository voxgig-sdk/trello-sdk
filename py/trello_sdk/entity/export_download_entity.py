...
class ExportDownloadEntity:
    ...
    def make(self):
        ...
        for k, v in self._entopts.items():
            opts[k] = v
        return ExportDownloadEntity(self._client, opts)
    ...
    def data_get(self) -> ExportDownload:
    ...
    def match_get(self) -> ExportDownload:
    ...
    def load(self, reqmatch=None, ctrl=None) -> ExportDownload:
        utility = self._utility
        # reqmatch is optional: an entity with no id-like key loads with no
        # match. Treat None as an empty match so client.ExportDownload().load()
        # works with no args.
        if reqmatch is None:
            reqmatch = {}
