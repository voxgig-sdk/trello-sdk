...
class ShowSidebarMemberEntity:
    ...
    def make(self):
        ...
        for k, v in self._entopts.items():
            opts[k] = v
        return ShowSidebarMemberEntity(self._client, opts)
    ...
    def data_get(self) -> ShowSidebarMember:
    ...
    def match_get(self) -> ShowSidebarMember:
    ...
    def update(self, reqdata: ShowSidebarMemberUpdateData, ctrl=None) -> ShowSidebarMember:
        utility = self._utility
