...
class IdEmailListEntity:
    ...
    def make(self):
        ...
        for k, v in self._entopts.items():
            opts[k] = v
        return IdEmailListEntity(self._client, opts)
    ...
    def match_get(self) -> IdEmailList:
    ...
    def update(self, reqdata: IdEmailListUpdateData, ctrl=None) -> IdEmailList:
        utility = self._utility
