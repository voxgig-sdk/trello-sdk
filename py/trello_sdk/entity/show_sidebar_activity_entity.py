...
class ShowSidebarActivityEntity:
    ...
    def make(self):
        ...
        for k, v in self._entopts.items():
            opts[k] = v
        return ShowSidebarActivityEntity(self._client, opts)
    ...
    def data_get(self) -> ShowSidebarActivity:
    ...
    def match_get(self) -> ShowSidebarActivity:
    ...
    def update(self, reqdata: ShowSidebarActivityUpdateData, ctrl=None) -> ShowSidebarActivity:
        utility = self._utility
