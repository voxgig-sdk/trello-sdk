...
class EmailPositionEntity:
    ...
    def make(self):
        ...
        for k, v in self._entopts.items():
            opts[k] = v
        return EmailPositionEntity(self._client, opts)
    ...
    def data_get(self) -> EmailPosition:
    ...
    def match_get(self) -> EmailPosition:
    ...
    def update(self, reqdata: EmailPositionUpdateData, ctrl=None) -> EmailPosition:
        utility = self._utility
