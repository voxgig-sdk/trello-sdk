...
class NotificationListEntity:
    ...
    def make(self):
        ...
        for k, v in self._entopts.items():
            opts[k] = v
        return NotificationListEntity(self._client, opts)
    ...
    def data_get(self) -> NotificationList:
    ...
    def match_get(self) -> NotificationList:
    ...
    def load(self, reqmatch=None, ctrl=None) -> NotificationList:
        utility = self._utility
        # reqmatch is optional: an entity with no id-like key loads with no
        # match. Treat None as an empty match so client.NotificationList().load()
        # works with no args.
        if reqmatch is None:
            reqmatch = {}
