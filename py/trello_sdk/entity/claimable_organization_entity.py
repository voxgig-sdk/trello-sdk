...
class ClaimableOrganizationEntity:
    ...
    def make(self):
        ...
        for k, v in self._entopts.items():
            opts[k] = v
        return ClaimableOrganizationEntity(self._client, opts)
    ...
    def data_get(self) -> ClaimableOrganization:
    ...
    def match_get(self) -> ClaimableOrganization:
    ...
    def list(self, reqmatch=None, ctrl=None) -> list[ClaimableOrganization]:
        utility = self._utility
        # reqmatch is optional: an omitted match lists all records. Treat None
        # as an empty match so client.ClaimableOrganization().list() works with no args.
        if reqmatch is None:
            reqmatch = {}
