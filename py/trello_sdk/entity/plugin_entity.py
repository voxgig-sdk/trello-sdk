...
class PluginEntity:
    ...
    def list(self, reqmatch=None, ctrl=None) -> list[Plugin]:
        utility = self._utility
        # reqmatch is optional: an omitted match lists all records. Treat None
        # as an empty match so client.Plugin().list() works with no args.
        if reqmatch is None:
            reqmatch = {}
        ctx = utility.make_context({
            "opname": "list",
    ...
    def update(self, reqdata: PluginUpdateData, ctrl=None) -> Plugin:
        utility = self._utility
        ctx = utility.make_context({
            "opname": "update",
            "ctrl": ctrl,
