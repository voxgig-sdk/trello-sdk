...
class TransferrableOrganizationEntity:
    ...
    def make(self):
        ...
        for k, v in self._entopts.items():
            opts[k] = v
        return TransferrableOrganizationEntity(self._client, opts)
    ...
    def data_get(self) -> TransferrableOrganization:
    ...
    def match_get(self) -> TransferrableOrganization:
    ...
    def load(self, reqmatch=None, ctrl=None) -> TransferrableOrganization:
        utility = self._utility
        # reqmatch is optional: an entity with no id-like key loads with no
        # match. Treat None as an empty match so client.TransferrableOrganization().load()
        # works with no args.
        if reqmatch is None:
            reqmatch = {}
