...
class ShowSidebarBoardActionEntity:
    ...
    def make(self):
        ...
        for k, v in self._entopts.items():
            opts[k] = v
        return ShowSidebarBoardActionEntity(self._client, opts)
    ...
    def data_get(self) -> ShowSidebarBoardAction:
    ...
    def match_get(self) -> ShowSidebarBoardAction:
    ...
    def update(self, reqdata: ShowSidebarBoardActionUpdateData, ctrl=None) -> ShowSidebarBoardAction:
        utility = self._utility
