...
class EnterpriseAdminEntity:
    ...
    def make(self):
        ...
        for k, v in self._entopts.items():
            opts[k] = v
        return EnterpriseAdminEntity(self._client, opts)
    ...
    def data_get(self) -> EnterpriseAdmin:
    ...
    def match_get(self) -> EnterpriseAdmin:
    ...
    def load(self, reqmatch=None, ctrl=None) -> EnterpriseAdmin:
        utility = self._utility
        # reqmatch is optional: an entity with no id-like key loads with no
        # match. Treat None as an empty match so client.EnterpriseAdmin().load()
        # works with no args.
        if reqmatch is None:
            reqmatch = {}
