...
class MemberPrivacyEntity:
    ...
    def make(self):
        ...
        for k, v in self._entopts.items():
            opts[k] = v
        return MemberPrivacyEntity(self._client, opts)
    ...
    def data_get(self) -> MemberPrivacy:
    ...
    def match_get(self) -> MemberPrivacy:
    ...
    def load(self, reqmatch=None, ctrl=None) -> MemberPrivacy:
        utility = self._utility
        # reqmatch is optional: an entity with no id-like key loads with no
        # match. Treat None as an empty match so client.MemberPrivacy().load()
        # works with no args.
        if reqmatch is None:
            reqmatch = {}
