...
class TestCardListDirect:
    ...
    def test_should_direct_load_card_list(self):
        setup = _card_list_direct_setup({"id": "direct01"})
        _skip, _reason = runner.is_control_skipped("direct", "direct-load-card_list", "live" if setup["live"] else "unit")
        if _skip:
