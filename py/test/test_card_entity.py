    ...
    def test_should_run_basic_flow(self):
        ...
        if setup.get("synthetic_only"):
            pytest.skip("live entity test uses synthetic IDs from fixture — "
                        "set TRELLO_TEST_CARD_ENTID JSON to run live")
        client = setup["client"]
        ...
        card_ref01_markdef_up0_value = "Mark01-card_ref01_" + str(setup["now"])
        card_ref01_data_up0_up[card_ref01_markdef_up0_name] = card_ref01_markdef_up0_value

        card_ref01_resdata_up0 = helpers.to_map(runner.entity_data(card_ref01_ent.update(card_ref01_data_up0_up, None)))
        assert card_ref01_resdata_up0 is not None
        assert card_ref01_resdata_up0["id"] == card_ref01_data_up0_up["id"]
        assert card_ref01_resdata_up0[card_ref01_markdef_up0_name] == card_ref01_markdef_up0_value
        ...
        card_ref01_ent.remove(card_ref01_match_rm0, None)
        ...
        card_ref01_list_rt0_result = card_ref01_ent.list(card_ref01_match_rt0, None)
        assert isinstance(card_ref01_list_rt0_result, list)
...
def _card_basic_setup(extra):
    ...
    idmap_resolved = helpers.to_map(
        env.get("TRELLO_TEST_CARD_ENTID"))
