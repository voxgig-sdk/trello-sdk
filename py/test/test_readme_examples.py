# Trello SDK — documentation python-examples COMPLETENESS gate.
#
...
#      SDK (mentions TrelloSDK) OR drives a client/sdk variable the narrative
#      built earlier ("client." / "sdk."). A constructing block is rewritten so
#      both TrelloSDK(...) and TrelloSDK.test(...) become
#      TrelloSDK.test({"entity": {...}}) seeding one mock record (id "test01")
...
_SDK_MODULE = "trello_sdk"
_SDK_CLASS = "TrelloSDK"
...
_ENTITIES = {
    "Action": "action",
    "ActionReactionsSummary": "action_reactions_summary",
    "Admin": "admin",
    "Application": "application",
    "ApplicationCompliance": "application_compliance",
    "AssociatedDomain": "associated_domain",
    "Attachment": "attachment",
    "Batch": "batch",
    "Board": "board",
    "BoardBackground": "board_background",
    "BoardPlugin": "board_plugin",
    "BoardStar": "board_star",
    "Bulk": "bulk",
    "Card": "card",
    "CardCheckItemState": "card_check_item_state",
    "CardList": "card_list",
    "CheckItem": "check_item",
    "Checklist": "checklist",
    "ClaimableOrganization": "claimable_organization",
    "CustomBoardBackground": "custom_board_background",
    ...
    "Emoji": "emoji",
    "Enterpris": "enterpris",
    "EnterprisSignupUrl": "enterpris_signup_url",
    "EnterpriseAdmin": "enterprise_admin",
    "EnterpriseAuditLog": "enterprise_audit_log",
    "Export": "export",
    "ExportDownload": "export_download",
    "Generate": "generate",
    "IdEmailList": "id_email_list",
    "IdLabel": "id_label",
    "IdMember": "id_member",
    "Label": "label",
    "List": "list",
    "Member": "member",
    "MemberPrivacy": "member_privacy",
    "MembersVoted": "members_voted",
    "Membership": "membership",
    "MostRecent": "most_recent",
    "NewBillableGuest": "new_billable_guest",
    "Notification": "notification",
    "NotificationChannelSetting": "notification_channel_setting",
    "NotificationList": "notification_list",
    "NotificationMemberCreator": "notification_member_creator",
    "NotificationsChannelSetting": "notifications_channel_setting",
    "Option": "option",
    "OrgInviteRestrict": "org_invite_restrict",
    "Organization": "organization",
    "PendingOrganization": "pending_organization",
    "Plugin": "plugin",
    "PluginData": "plugin_data",
    "PluginListing": "plugin_listing",
    "Reaction": "reaction",
    "Read": "read",
    "SavedSearch": "saved_search",
    "Search": "search",
    "ShowSidebar": "show_sidebar",
    "ShowSidebarActivity": "show_sidebar_activity",
    "ShowSidebarBoardAction": "show_sidebar_board_action",
    "ShowSidebarMember": "show_sidebar_member",
    "Sticker": "sticker",
    "Tag": "tag",
    "Token": "token",
    "TransferrableOrganization": "transferrable_organization",
