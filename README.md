...
Full documentation for this SDK: [https://voxgig-sdk.github.io/trello-sdk/](https://voxgig-sdk.github.io/trello-sdk/)
...
| --- | --- | --- |
| TypeScript | `@voxgig-sdk/trello` | publish pending — [install from git tag](https://github.com/voxgig-sdk/trello-sdk/tags) |
| Python | `voxgig-sdk-trello` | publish pending — [install from git tag](https://github.com/voxgig-sdk/trello-sdk/tags) |
| PHP | `voxgig-sdk/trello` | publish pending — [install from git tag](https://github.com/voxgig-sdk/trello-sdk/tags) |
| Golang | `github.com/voxgig-sdk/trello-sdk/go` | `go get github.com/voxgig-sdk/trello-sdk/go@latest` |
| Lua | `voxgig-sdk-trello` | publish pending — [install from git tag](https://github.com/voxgig-sdk/trello-sdk/tags) |
| JavaScript | `@voxgig-sdk/trello-js` | publish pending — [install from git tag](https://github.com/voxgig-sdk/trello-sdk/tags) |
