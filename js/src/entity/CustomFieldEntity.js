...
class CustomFieldEntity extends TrelloEntityBase {
  ...
  /**
   * @param {CustomFieldLoadMatch} [reqmatch]
   * @param {Object} [ctrl]
  ...
  /**
   * @param {CustomFieldListMatch} [reqmatch]
   * @param {Object} [ctrl]
   * @returns {Promise<CustomField[]>}
   */
  ...
  /**
   * @param {CustomFieldCreateData} [reqdata]
   * @param {Object} [ctrl]
   * @returns {Promise<CustomField>}
   */
  ...
  /**
   * @param {CustomFieldUpdateData} [reqdata]
   * @param {Object} [ctrl]
   * @returns {Promise<CustomField>}
   */
  ...
  /**
   * @param {CustomFieldRemoveMatch} [reqmatch]
   * @param {Object} [ctrl]
   * @returns {Promise<CustomField>}
   */
