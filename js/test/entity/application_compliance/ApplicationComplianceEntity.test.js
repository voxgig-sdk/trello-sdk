...
describe('ApplicationComplianceEntity', async () => {
  ...
  test('basic', async (t) => {
    ...
    const application_compliance_ref01_match_dt0 = {}
    const application_compliance_ref01_data_dt0 = (await application_compliance_ref01_ent.load(application_compliance_ref01_match_dt0)).data()
    assert(null != application_compliance_ref01_data_dt0)
...
function basicSetup(extra) {
  ...
  const entityDataFile =
    Path.resolve(__dirname,
      '../../../../.sdk/test/entity/application_compliance/ApplicationComplianceTestData.json')
  ...
  if (live) {
    const rawIds = process.env['TRELLO_TEST_APPLICATION_COMPLIANCE_ENTID']
