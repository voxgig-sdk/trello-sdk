...
type PluginListingEntity struct {
	name    string
...
func NewPluginListingEntity(client *core.TrelloSDK, entopts map[string]any) *PluginListingEntity {
	if entopts == nil {
		entopts = map[string]any{}
	}
...
func (e *PluginListingEntity) GetName() string { return e.name }
...
func (e *PluginListingEntity) MarkDeleted() {
	e.deleted = true
}


// Deleted reports whether a successful Remove has resolved on this instance.
func (e *PluginListingEntity) Deleted() bool {
	return e.deleted
}


func (e *PluginListingEntity) Make() core.Entity {
	opts := map[string]any{}
	for k, v := range e.entopts {
		opts[k] = v
	}
	return NewPluginListingEntity(e.client, opts)
}

func (e *PluginListingEntity) Data(args ...any) any {
...
func (e *PluginListingEntity) Match(args ...any) any {
	if len(args) > 0 && args[0] != nil {
...
// argument it returns the current data as an PluginListing; with an argument it
// sets the data and returns the stored value. It delegates to the untyped Data
// (identical runtime) and converts at the typed boundary.
func (e *PluginListingEntity) DataTyped(data ...PluginListing) PluginListing {
	if len(data) > 0 {
		return typedFrom[PluginListing](e.Data(asMap(data[0])))
	}
	return typedFrom[PluginListing](e.Data())
}

// MatchTyped mirrors DataTyped for the entity's match filter. The match is a
// partial of the entity, so it round-trips through PluginListing (all fields
// optional at the wire level).
func (e *PluginListingEntity) MatchTyped(match ...PluginListing) PluginListing {
	if len(match) > 0 {
		return typedFrom[PluginListing](e.Match(asMap(match[0])))
	}
	return typedFrom[PluginListing](e.Match())
}
...
func (e *PluginListingEntity) Stream(action string, args map[string]any, callopts map[string]any) <-chan any {
	out := make(chan any)
...
func (e *PluginListingEntity) Load(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("load", e.name)
}


func (e *PluginListingEntity) List(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("list", e.name)
}



func (e *PluginListingEntity) Create(reqdata map[string]any, ctrl map[string]any) (any, error) {
	utility := e.utility
...
// PluginListingCreateData and returns an PluginListing. It delegates to the untyped
// Create (identical runtime) and converts at the typed boundary.
func (e *PluginListingEntity) CreateTyped(reqdata PluginListingCreateData, ctrl map[string]any) (PluginListing, error) {
	res, err := e.Create(asMap(reqdata), ctrl)
	if err != nil {
		return PluginListing{}, err
	}
	return typedFrom[PluginListing](res), nil
}




func (e *PluginListingEntity) Update(reqdata map[string]any, ctrl map[string]any) (any, error) {
	utility := e.utility
	ctx := utility.MakeContext(map[string]any{
		"opname":  "update",
		"ctrl":    ctrl,
...
// PluginListingUpdateData and returns an PluginListing. It delegates to the untyped
// Update (identical runtime) and converts at the typed boundary.
func (e *PluginListingEntity) UpdateTyped(reqdata PluginListingUpdateData, ctrl map[string]any) (PluginListing, error) {
...
func (e *PluginListingEntity) Remove(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("remove", e.name)
}


func (e *PluginListingEntity) runOp(ctx *core.Context, postDone func()) (any, error) {
	utility := e.utility
