...
func NewAdminEntity(client *core.TrelloSDK, entopts map[string]any) *AdminEntity {
	if entopts == nil {
		entopts = map[string]any{}
	}
...
func (e *AdminEntity) Load(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("load", e.name)
}


func (e *AdminEntity) List(_ map[string]any, _ map[string]any) (any, error) {
...
func (e *AdminEntity) Remove(reqmatch map[string]any, ctrl map[string]any) (any, error) {
	utility := e.utility
	ctx := utility.MakeContext(map[string]any{
		"opname":   "remove",
		"ctrl":     ctrl,
...
// AdminRemoveMatch and returns an Admin. It delegates to the untyped
// Remove (identical runtime) and converts at the typed boundary.
func (e *AdminEntity) RemoveTyped(reqmatch AdminRemoveMatch, ctrl map[string]any) (Admin, error) {
