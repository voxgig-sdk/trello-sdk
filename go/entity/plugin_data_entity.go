...
func NewPluginDataEntity(client *core.TrelloSDK, entopts map[string]any) *PluginDataEntity {
	if entopts == nil {
		entopts = map[string]any{}
	}
...
func (e *PluginDataEntity) GetName() string { return e.name }
...
func (e *PluginDataEntity) MarkDeleted() {
	e.deleted = true
}


// Deleted reports whether a successful Remove has resolved on this instance.
func (e *PluginDataEntity) Deleted() bool {
	return e.deleted
}


func (e *PluginDataEntity) Make() core.Entity {
	opts := map[string]any{}
	for k, v := range e.entopts {
		opts[k] = v
	}
	return NewPluginDataEntity(e.client, opts)
}

func (e *PluginDataEntity) Data(args ...any) any {
...
func (e *PluginDataEntity) Match(args ...any) any {
	if len(args) > 0 && args[0] != nil {
...
// argument it returns the current data as an PluginData; with an argument it
// sets the data and returns the stored value. It delegates to the untyped Data
// (identical runtime) and converts at the typed boundary.
func (e *PluginDataEntity) DataTyped(data ...PluginData) PluginData {
	if len(data) > 0 {
		return typedFrom[PluginData](e.Data(asMap(data[0])))
	}
	return typedFrom[PluginData](e.Data())
}

// MatchTyped mirrors DataTyped for the entity's match filter. The match is a
// partial of the entity, so it round-trips through PluginData (all fields
// optional at the wire level).
func (e *PluginDataEntity) MatchTyped(match ...PluginData) PluginData {
	if len(match) > 0 {
		return typedFrom[PluginData](e.Match(asMap(match[0])))
	}
	return typedFrom[PluginData](e.Match())
}
...
func (e *PluginDataEntity) Stream(action string, args map[string]any, callopts map[string]any) <-chan any {
	out := make(chan any)
...
func (e *PluginDataEntity) Load(reqmatch map[string]any, ctrl map[string]any) (any, error) {
	utility := e.utility
...
// PluginDataLoadMatch and returns an PluginData. It delegates to the untyped
// Load (identical runtime) and converts at the typed boundary.
func (e *PluginDataEntity) LoadTyped(reqmatch PluginDataLoadMatch, ctrl map[string]any) (PluginData, error) {
	res, err := e.Load(asMap(reqmatch), ctrl)
	if err != nil {
		return PluginData{}, err
	}
	return typedFrom[PluginData](res), nil
}




func (e *PluginDataEntity) List(reqmatch map[string]any, ctrl map[string]any) (any, error) {
	utility := e.utility
	ctx := utility.MakeContext(map[string]any{
		"opname":   "list",
		"ctrl":     ctrl,
...
// PluginDataListMatch and returns []PluginData. It delegates to the untyped
// List (identical runtime) and converts at the typed boundary.
func (e *PluginDataEntity) ListTyped(reqmatch PluginDataListMatch, ctrl map[string]any) ([]PluginData, error) {
	res, err := e.List(asMap(reqmatch), ctrl)
	if err != nil {
		return nil, err
	}
	return typedSliceFrom[PluginData](res), nil
}



func (e *PluginDataEntity) Create(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("create", e.name)
}


func (e *PluginDataEntity) Update(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("update", e.name)
}


func (e *PluginDataEntity) Remove(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("remove", e.name)
}


func (e *PluginDataEntity) runOp(ctx *core.Context, postDone func()) (any, error) {
	utility := e.utility
