...
func NewOptionEntity(client *core.TrelloSDK, entopts map[string]any) *OptionEntity {
	if entopts == nil {
		entopts = map[string]any{}
	}
...
func (e *OptionEntity) Load(reqmatch map[string]any, ctrl map[string]any) (any, error) {
	utility := e.utility
...
// OptionLoadMatch and returns an Option. It delegates to the untyped
// Load (identical runtime) and converts at the typed boundary.
func (e *OptionEntity) LoadTyped(reqmatch OptionLoadMatch, ctrl map[string]any) (Option, error) {
	res, err := e.Load(asMap(reqmatch), ctrl)
	if err != nil {
		return Option{}, err
	}
	return typedFrom[Option](res), nil
}
...
func (e *OptionEntity) Remove(reqmatch map[string]any, ctrl map[string]any) (any, error) {
	utility := e.utility
	ctx := utility.MakeContext(map[string]any{
		"opname":   "remove",
		"ctrl":     ctrl,
...
// OptionRemoveMatch and returns an Option. It delegates to the untyped
// Remove (identical runtime) and converts at the typed boundary.
func (e *OptionEntity) RemoveTyped(reqmatch OptionRemoveMatch, ctrl map[string]any) (Option, error) {
