...
type EnterprisSignupUrlEntity struct {
	name    string
...
func NewEnterprisSignupUrlEntity(client *core.TrelloSDK, entopts map[string]any) *EnterprisSignupUrlEntity {
	if entopts == nil {
		entopts = map[string]any{}
	}
...
func (e *EnterprisSignupUrlEntity) GetName() string { return e.name }
...
func (e *EnterprisSignupUrlEntity) MarkDeleted() {
	e.deleted = true
}


// Deleted reports whether a successful Remove has resolved on this instance.
func (e *EnterprisSignupUrlEntity) Deleted() bool {
	return e.deleted
}


func (e *EnterprisSignupUrlEntity) Make() core.Entity {
	opts := map[string]any{}
	for k, v := range e.entopts {
		opts[k] = v
	}
	return NewEnterprisSignupUrlEntity(e.client, opts)
}

func (e *EnterprisSignupUrlEntity) Data(args ...any) any {
...
func (e *EnterprisSignupUrlEntity) Match(args ...any) any {
	if len(args) > 0 && args[0] != nil {
...
// argument it returns the current data as an EnterprisSignupUrl; with an argument it
// sets the data and returns the stored value. It delegates to the untyped Data
// (identical runtime) and converts at the typed boundary.
func (e *EnterprisSignupUrlEntity) DataTyped(data ...EnterprisSignupUrl) EnterprisSignupUrl {
	if len(data) > 0 {
		return typedFrom[EnterprisSignupUrl](e.Data(asMap(data[0])))
	}
	return typedFrom[EnterprisSignupUrl](e.Data())
}

// MatchTyped mirrors DataTyped for the entity's match filter. The match is a
// partial of the entity, so it round-trips through EnterprisSignupUrl (all fields
// optional at the wire level).
func (e *EnterprisSignupUrlEntity) MatchTyped(match ...EnterprisSignupUrl) EnterprisSignupUrl {
	if len(match) > 0 {
		return typedFrom[EnterprisSignupUrl](e.Match(asMap(match[0])))
	}
	return typedFrom[EnterprisSignupUrl](e.Match())
}
...
func (e *EnterprisSignupUrlEntity) Stream(action string, args map[string]any, callopts map[string]any) <-chan any {
	out := make(chan any)
...
func (e *EnterprisSignupUrlEntity) Load(reqmatch map[string]any, ctrl map[string]any) (any, error) {
	utility := e.utility
...
// EnterprisSignupUrlLoadMatch and returns an EnterprisSignupUrl. It delegates to the untyped
// Load (identical runtime) and converts at the typed boundary.
func (e *EnterprisSignupUrlEntity) LoadTyped(reqmatch EnterprisSignupUrlLoadMatch, ctrl map[string]any) (EnterprisSignupUrl, error) {
	res, err := e.Load(asMap(reqmatch), ctrl)
	if err != nil {
		return EnterprisSignupUrl{}, err
	}
	return typedFrom[EnterprisSignupUrl](res), nil
}



func (e *EnterprisSignupUrlEntity) List(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("list", e.name)
}


func (e *EnterprisSignupUrlEntity) Create(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("create", e.name)
}


func (e *EnterprisSignupUrlEntity) Update(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("update", e.name)
}


func (e *EnterprisSignupUrlEntity) Remove(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("remove", e.name)
}


func (e *EnterprisSignupUrlEntity) runOp(ctx *core.Context, postDone func()) (any, error) {
	utility := e.utility
