...
type NotificationListEntity struct {
	name    string
...
func NewNotificationListEntity(client *core.TrelloSDK, entopts map[string]any) *NotificationListEntity {
	if entopts == nil {
		entopts = map[string]any{}
	}
...
func (e *NotificationListEntity) GetName() string { return e.name }
...
func (e *NotificationListEntity) MarkDeleted() {
	e.deleted = true
}


// Deleted reports whether a successful Remove has resolved on this instance.
func (e *NotificationListEntity) Deleted() bool {
	return e.deleted
}


func (e *NotificationListEntity) Make() core.Entity {
	opts := map[string]any{}
	for k, v := range e.entopts {
		opts[k] = v
	}
	return NewNotificationListEntity(e.client, opts)
}

func (e *NotificationListEntity) Data(args ...any) any {
...
func (e *NotificationListEntity) Match(args ...any) any {
	if len(args) > 0 && args[0] != nil {
...
// argument it returns the current data as an NotificationList; with an argument it
// sets the data and returns the stored value. It delegates to the untyped Data
// (identical runtime) and converts at the typed boundary.
func (e *NotificationListEntity) DataTyped(data ...NotificationList) NotificationList {
	if len(data) > 0 {
		return typedFrom[NotificationList](e.Data(asMap(data[0])))
	}
	return typedFrom[NotificationList](e.Data())
}

// MatchTyped mirrors DataTyped for the entity's match filter. The match is a
// partial of the entity, so it round-trips through NotificationList (all fields
// optional at the wire level).
func (e *NotificationListEntity) MatchTyped(match ...NotificationList) NotificationList {
	if len(match) > 0 {
		return typedFrom[NotificationList](e.Match(asMap(match[0])))
	}
	return typedFrom[NotificationList](e.Match())
}
...
func (e *NotificationListEntity) Stream(action string, args map[string]any, callopts map[string]any) <-chan any {
	out := make(chan any)
...
func (e *NotificationListEntity) Load(reqmatch map[string]any, ctrl map[string]any) (any, error) {
	utility := e.utility
...
// NotificationListLoadMatch and returns an NotificationList. It delegates to the untyped
// Load (identical runtime) and converts at the typed boundary.
func (e *NotificationListEntity) LoadTyped(reqmatch NotificationListLoadMatch, ctrl map[string]any) (NotificationList, error) {
	res, err := e.Load(asMap(reqmatch), ctrl)
	if err != nil {
		return NotificationList{}, err
	}
	return typedFrom[NotificationList](res), nil
}



func (e *NotificationListEntity) List(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("list", e.name)
}


func (e *NotificationListEntity) Create(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("create", e.name)
}


func (e *NotificationListEntity) Update(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("update", e.name)
}


func (e *NotificationListEntity) Remove(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("remove", e.name)
}


func (e *NotificationListEntity) runOp(ctx *core.Context, postDone func()) (any, error) {
	utility := e.utility
