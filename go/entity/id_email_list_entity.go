...
func NewIdEmailListEntity(client *core.TrelloSDK, entopts map[string]any) *IdEmailListEntity {
	if entopts == nil {
		entopts = map[string]any{}
	}
...
func (e *IdEmailListEntity) GetName() string { return e.name }
...
func (e *IdEmailListEntity) MarkDeleted() {
	e.deleted = true
}


// Deleted reports whether a successful Remove has resolved on this instance.
func (e *IdEmailListEntity) Deleted() bool {
	return e.deleted
}


func (e *IdEmailListEntity) Make() core.Entity {
	opts := map[string]any{}
	for k, v := range e.entopts {
		opts[k] = v
	}
	return NewIdEmailListEntity(e.client, opts)
}

func (e *IdEmailListEntity) Data(args ...any) any {
...
func (e *IdEmailListEntity) Match(args ...any) any {
	if len(args) > 0 && args[0] != nil {
...
// argument it returns the current data as an IdEmailList; with an argument it
// sets the data and returns the stored value. It delegates to the untyped Data
// (identical runtime) and converts at the typed boundary.
func (e *IdEmailListEntity) DataTyped(data ...IdEmailList) IdEmailList {
	if len(data) > 0 {
		return typedFrom[IdEmailList](e.Data(asMap(data[0])))
	}
	return typedFrom[IdEmailList](e.Data())
}

// MatchTyped mirrors DataTyped for the entity's match filter. The match is a
// partial of the entity, so it round-trips through IdEmailList (all fields
// optional at the wire level).
func (e *IdEmailListEntity) MatchTyped(match ...IdEmailList) IdEmailList {
	if len(match) > 0 {
		return typedFrom[IdEmailList](e.Match(asMap(match[0])))
	}
	return typedFrom[IdEmailList](e.Match())
}
...
func (e *IdEmailListEntity) Stream(action string, args map[string]any, callopts map[string]any) <-chan any {
	out := make(chan any)
...
func (e *IdEmailListEntity) Load(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("load", e.name)
}


func (e *IdEmailListEntity) List(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("list", e.name)
}


func (e *IdEmailListEntity) Create(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("create", e.name)
}



func (e *IdEmailListEntity) Update(reqdata map[string]any, ctrl map[string]any) (any, error) {
	utility := e.utility
...
// IdEmailListUpdateData and returns an IdEmailList. It delegates to the untyped
// Update (identical runtime) and converts at the typed boundary.
func (e *IdEmailListEntity) UpdateTyped(reqdata IdEmailListUpdateData, ctrl map[string]any) (IdEmailList, error) {
	res, err := e.Update(asMap(reqdata), ctrl)
	if err != nil {
		return IdEmailList{}, err
	}
	return typedFrom[IdEmailList](res), nil
}



func (e *IdEmailListEntity) Remove(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("remove", e.name)
}


func (e *IdEmailListEntity) runOp(ctx *core.Context, postDone func()) (any, error) {
	utility := e.utility
