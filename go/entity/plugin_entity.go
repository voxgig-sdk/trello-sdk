...
func NewPluginEntity(client *core.TrelloSDK, entopts map[string]any) *PluginEntity {
	if entopts == nil {
		entopts = map[string]any{}
	}
...
func (e *PluginEntity) List(reqmatch map[string]any, ctrl map[string]any) (any, error) {
	utility := e.utility
	ctx := utility.MakeContext(map[string]any{
		"opname":   "list",
		"ctrl":     ctrl,
...
// PluginListMatch and returns []Plugin. It delegates to the untyped
// List (identical runtime) and converts at the typed boundary.
func (e *PluginEntity) ListTyped(reqmatch PluginListMatch, ctrl map[string]any) ([]Plugin, error) {
	res, err := e.List(asMap(reqmatch), ctrl)
	if err != nil {
		return nil, err
	}
	return typedSliceFrom[Plugin](res), nil
}
...
func (e *PluginEntity) Update(reqdata map[string]any, ctrl map[string]any) (any, error) {
	utility := e.utility
	ctx := utility.MakeContext(map[string]any{
		"opname":  "update",
		"ctrl":    ctrl,
...
// PluginUpdateData and returns an Plugin. It delegates to the untyped
// Update (identical runtime) and converts at the typed boundary.
func (e *PluginEntity) UpdateTyped(reqdata PluginUpdateData, ctrl map[string]any) (Plugin, error) {
