...
func NewCheckItemEntity(client *core.TrelloSDK, entopts map[string]any) *CheckItemEntity {
	if entopts == nil {
		entopts = map[string]any{}
	}
...
func (e *CheckItemEntity) GetName() string { return e.name }
...
func (e *CheckItemEntity) MarkDeleted() {
	e.deleted = true
}


// Deleted reports whether a successful Remove has resolved on this instance.
func (e *CheckItemEntity) Deleted() bool {
	return e.deleted
}


func (e *CheckItemEntity) Make() core.Entity {
	opts := map[string]any{}
	for k, v := range e.entopts {
		opts[k] = v
	}
	return NewCheckItemEntity(e.client, opts)
}

func (e *CheckItemEntity) Data(args ...any) any {
...
func (e *CheckItemEntity) Match(args ...any) any {
	if len(args) > 0 && args[0] != nil {
...
// argument it returns the current data as an CheckItem; with an argument it
// sets the data and returns the stored value. It delegates to the untyped Data
// (identical runtime) and converts at the typed boundary.
func (e *CheckItemEntity) DataTyped(data ...CheckItem) CheckItem {
	if len(data) > 0 {
		return typedFrom[CheckItem](e.Data(asMap(data[0])))
	}
	return typedFrom[CheckItem](e.Data())
}

// MatchTyped mirrors DataTyped for the entity's match filter. The match is a
// partial of the entity, so it round-trips through CheckItem (all fields
// optional at the wire level).
func (e *CheckItemEntity) MatchTyped(match ...CheckItem) CheckItem {
	if len(match) > 0 {
		return typedFrom[CheckItem](e.Match(asMap(match[0])))
	}
	return typedFrom[CheckItem](e.Match())
}
...
func (e *CheckItemEntity) Stream(action string, args map[string]any, callopts map[string]any) <-chan any {
	out := make(chan any)
...
func (e *CheckItemEntity) Load(reqmatch map[string]any, ctrl map[string]any) (any, error) {
	utility := e.utility
...
// CheckItemLoadMatch and returns an CheckItem. It delegates to the untyped
// Load (identical runtime) and converts at the typed boundary.
func (e *CheckItemEntity) LoadTyped(reqmatch CheckItemLoadMatch, ctrl map[string]any) (CheckItem, error) {
	res, err := e.Load(asMap(reqmatch), ctrl)
	if err != nil {
		return CheckItem{}, err
	}
	return typedFrom[CheckItem](res), nil
}



func (e *CheckItemEntity) List(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("list", e.name)
}


func (e *CheckItemEntity) Create(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("create", e.name)
}



func (e *CheckItemEntity) Update(reqdata map[string]any, ctrl map[string]any) (any, error) {
	utility := e.utility
	ctx := utility.MakeContext(map[string]any{
		"opname":  "update",
		"ctrl":    ctrl,
...
// CheckItemUpdateData and returns an CheckItem. It delegates to the untyped
// Update (identical runtime) and converts at the typed boundary.
func (e *CheckItemEntity) UpdateTyped(reqdata CheckItemUpdateData, ctrl map[string]any) (CheckItem, error) {
...
func (e *CheckItemEntity) Remove(reqmatch map[string]any, ctrl map[string]any) (any, error) {
	utility := e.utility
	ctx := utility.MakeContext(map[string]any{
		"opname":   "remove",
		"ctrl":     ctrl,
...
// CheckItemRemoveMatch and returns an CheckItem. It delegates to the untyped
// Remove (identical runtime) and converts at the typed boundary.
func (e *CheckItemEntity) RemoveTyped(reqmatch CheckItemRemoveMatch, ctrl map[string]any) (CheckItem, error) {
...
func (e *CheckItemEntity) runOp(ctx *core.Context, postDone func()) (any, error) {
	utility := e.utility
