...
type AssociatedDomainEntity struct {
	name    string
...
func NewAssociatedDomainEntity(client *core.TrelloSDK, entopts map[string]any) *AssociatedDomainEntity {
	if entopts == nil {
		entopts = map[string]any{}
	}
...
func (e *AssociatedDomainEntity) GetName() string { return e.name }
...
func (e *AssociatedDomainEntity) MarkDeleted() {
	e.deleted = true
}


// Deleted reports whether a successful Remove has resolved on this instance.
func (e *AssociatedDomainEntity) Deleted() bool {
	return e.deleted
}


func (e *AssociatedDomainEntity) Make() core.Entity {
	opts := map[string]any{}
	for k, v := range e.entopts {
		opts[k] = v
	}
	return NewAssociatedDomainEntity(e.client, opts)
}

func (e *AssociatedDomainEntity) Data(args ...any) any {
...
func (e *AssociatedDomainEntity) Match(args ...any) any {
	if len(args) > 0 && args[0] != nil {
...
// argument it returns the current data as an AssociatedDomain; with an argument it
// sets the data and returns the stored value. It delegates to the untyped Data
// (identical runtime) and converts at the typed boundary.
func (e *AssociatedDomainEntity) DataTyped(data ...AssociatedDomain) AssociatedDomain {
	if len(data) > 0 {
		return typedFrom[AssociatedDomain](e.Data(asMap(data[0])))
	}
	return typedFrom[AssociatedDomain](e.Data())
}

// MatchTyped mirrors DataTyped for the entity's match filter. The match is a
// partial of the entity, so it round-trips through AssociatedDomain (all fields
// optional at the wire level).
func (e *AssociatedDomainEntity) MatchTyped(match ...AssociatedDomain) AssociatedDomain {
	if len(match) > 0 {
		return typedFrom[AssociatedDomain](e.Match(asMap(match[0])))
	}
	return typedFrom[AssociatedDomain](e.Match())
}
...
func (e *AssociatedDomainEntity) Stream(action string, args map[string]any, callopts map[string]any) <-chan any {
	out := make(chan any)
...
func (e *AssociatedDomainEntity) Load(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("load", e.name)
}


func (e *AssociatedDomainEntity) List(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("list", e.name)
}


func (e *AssociatedDomainEntity) Create(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("create", e.name)
}


func (e *AssociatedDomainEntity) Update(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("update", e.name)
}



func (e *AssociatedDomainEntity) Remove(reqmatch map[string]any, ctrl map[string]any) (any, error) {
	utility := e.utility
...
// AssociatedDomainRemoveMatch and returns an AssociatedDomain. It delegates to the untyped
// Remove (identical runtime) and converts at the typed boundary.
func (e *AssociatedDomainEntity) RemoveTyped(reqmatch AssociatedDomainRemoveMatch, ctrl map[string]any) (AssociatedDomain, error) {
	res, err := e.Remove(asMap(reqmatch), ctrl)
	if err != nil {
		return AssociatedDomain{}, err
	}
	return typedFrom[AssociatedDomain](res), nil
}



func (e *AssociatedDomainEntity) runOp(ctx *core.Context, postDone func()) (any, error) {
	utility := e.utility
