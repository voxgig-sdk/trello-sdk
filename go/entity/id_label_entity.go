...
func NewIdLabelEntity(client *core.TrelloSDK, entopts map[string]any) *IdLabelEntity {
	if entopts == nil {
		entopts = map[string]any{}
	}
...
func (e *IdLabelEntity) GetName() string { return e.name }
...
func (e *IdLabelEntity) MarkDeleted() {
	e.deleted = true
}


// Deleted reports whether a successful Remove has resolved on this instance.
func (e *IdLabelEntity) Deleted() bool {
	return e.deleted
}


func (e *IdLabelEntity) Make() core.Entity {
	opts := map[string]any{}
	for k, v := range e.entopts {
		opts[k] = v
	}
	return NewIdLabelEntity(e.client, opts)
}

func (e *IdLabelEntity) Data(args ...any) any {
...
func (e *IdLabelEntity) Match(args ...any) any {
	if len(args) > 0 && args[0] != nil {
...
// argument it returns the current data as an IdLabel; with an argument it
// sets the data and returns the stored value. It delegates to the untyped Data
// (identical runtime) and converts at the typed boundary.
func (e *IdLabelEntity) DataTyped(data ...IdLabel) IdLabel {
	if len(data) > 0 {
		return typedFrom[IdLabel](e.Data(asMap(data[0])))
	}
	return typedFrom[IdLabel](e.Data())
}

// MatchTyped mirrors DataTyped for the entity's match filter. The match is a
// partial of the entity, so it round-trips through IdLabel (all fields
// optional at the wire level).
func (e *IdLabelEntity) MatchTyped(match ...IdLabel) IdLabel {
	if len(match) > 0 {
		return typedFrom[IdLabel](e.Match(asMap(match[0])))
	}
	return typedFrom[IdLabel](e.Match())
}
...
func (e *IdLabelEntity) Stream(action string, args map[string]any, callopts map[string]any) <-chan any {
	out := make(chan any)
...
func (e *IdLabelEntity) Load(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("load", e.name)
}


func (e *IdLabelEntity) List(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("list", e.name)
}


func (e *IdLabelEntity) Create(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("create", e.name)
}


func (e *IdLabelEntity) Update(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("update", e.name)
}



func (e *IdLabelEntity) Remove(reqmatch map[string]any, ctrl map[string]any) (any, error) {
	utility := e.utility
...
// IdLabelRemoveMatch and returns an IdLabel. It delegates to the untyped
// Remove (identical runtime) and converts at the typed boundary.
func (e *IdLabelEntity) RemoveTyped(reqmatch IdLabelRemoveMatch, ctrl map[string]any) (IdLabel, error) {
	res, err := e.Remove(asMap(reqmatch), ctrl)
	if err != nil {
		return IdLabel{}, err
	}
	return typedFrom[IdLabel](res), nil
}



func (e *IdLabelEntity) runOp(ctx *core.Context, postDone func()) (any, error) {
	utility := e.utility
