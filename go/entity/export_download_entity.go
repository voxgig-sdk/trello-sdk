...
type ExportDownloadEntity struct {
	name    string
...
func NewExportDownloadEntity(client *core.TrelloSDK, entopts map[string]any) *ExportDownloadEntity {
	if entopts == nil {
		entopts = map[string]any{}
	}
...
func (e *ExportDownloadEntity) GetName() string { return e.name }
...
func (e *ExportDownloadEntity) MarkDeleted() {
	e.deleted = true
}


// Deleted reports whether a successful Remove has resolved on this instance.
func (e *ExportDownloadEntity) Deleted() bool {
	return e.deleted
}


func (e *ExportDownloadEntity) Make() core.Entity {
	opts := map[string]any{}
	for k, v := range e.entopts {
		opts[k] = v
	}
	return NewExportDownloadEntity(e.client, opts)
}

func (e *ExportDownloadEntity) Data(args ...any) any {
...
func (e *ExportDownloadEntity) Match(args ...any) any {
	if len(args) > 0 && args[0] != nil {
...
// argument it returns the current data as an ExportDownload; with an argument it
// sets the data and returns the stored value. It delegates to the untyped Data
// (identical runtime) and converts at the typed boundary.
func (e *ExportDownloadEntity) DataTyped(data ...ExportDownload) ExportDownload {
	if len(data) > 0 {
		return typedFrom[ExportDownload](e.Data(asMap(data[0])))
	}
	return typedFrom[ExportDownload](e.Data())
}

// MatchTyped mirrors DataTyped for the entity's match filter. The match is a
// partial of the entity, so it round-trips through ExportDownload (all fields
// optional at the wire level).
func (e *ExportDownloadEntity) MatchTyped(match ...ExportDownload) ExportDownload {
	if len(match) > 0 {
		return typedFrom[ExportDownload](e.Match(asMap(match[0])))
	}
	return typedFrom[ExportDownload](e.Match())
}
...
func (e *ExportDownloadEntity) Stream(action string, args map[string]any, callopts map[string]any) <-chan any {
	out := make(chan any)
...
func (e *ExportDownloadEntity) Load(reqmatch map[string]any, ctrl map[string]any) (any, error) {
	utility := e.utility
...
// ExportDownloadLoadMatch and returns an ExportDownload. It delegates to the untyped
// Load (identical runtime) and converts at the typed boundary.
func (e *ExportDownloadEntity) LoadTyped(reqmatch ExportDownloadLoadMatch, ctrl map[string]any) (ExportDownload, error) {
	res, err := e.Load(asMap(reqmatch), ctrl)
	if err != nil {
		return ExportDownload{}, err
	}
	return typedFrom[ExportDownload](res), nil
}



func (e *ExportDownloadEntity) List(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("list", e.name)
}


func (e *ExportDownloadEntity) Create(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("create", e.name)
}


func (e *ExportDownloadEntity) Update(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("update", e.name)
}


func (e *ExportDownloadEntity) Remove(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("remove", e.name)
}


func (e *ExportDownloadEntity) runOp(ctx *core.Context, postDone func()) (any, error) {
	utility := e.utility
