...
func NewMostRecentEntity(client *core.TrelloSDK, entopts map[string]any) *MostRecentEntity {
	if entopts == nil {
		entopts = map[string]any{}
	}
...
func (e *MostRecentEntity) GetName() string { return e.name }
...
func (e *MostRecentEntity) MarkDeleted() {
	e.deleted = true
}


// Deleted reports whether a successful Remove has resolved on this instance.
func (e *MostRecentEntity) Deleted() bool {
	return e.deleted
}


func (e *MostRecentEntity) Make() core.Entity {
	opts := map[string]any{}
	for k, v := range e.entopts {
		opts[k] = v
	}
	return NewMostRecentEntity(e.client, opts)
}

func (e *MostRecentEntity) Data(args ...any) any {
...
func (e *MostRecentEntity) Match(args ...any) any {
	if len(args) > 0 && args[0] != nil {
...
// argument it returns the current data as an MostRecent; with an argument it
// sets the data and returns the stored value. It delegates to the untyped Data
// (identical runtime) and converts at the typed boundary.
func (e *MostRecentEntity) DataTyped(data ...MostRecent) MostRecent {
	if len(data) > 0 {
		return typedFrom[MostRecent](e.Data(asMap(data[0])))
	}
	return typedFrom[MostRecent](e.Data())
}

// MatchTyped mirrors DataTyped for the entity's match filter. The match is a
// partial of the entity, so it round-trips through MostRecent (all fields
// optional at the wire level).
func (e *MostRecentEntity) MatchTyped(match ...MostRecent) MostRecent {
	if len(match) > 0 {
		return typedFrom[MostRecent](e.Match(asMap(match[0])))
	}
	return typedFrom[MostRecent](e.Match())
}
...
func (e *MostRecentEntity) Stream(action string, args map[string]any, callopts map[string]any) <-chan any {
	out := make(chan any)
...
func (e *MostRecentEntity) Load(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("load", e.name)
}


func (e *MostRecentEntity) List(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("list", e.name)
}


func (e *MostRecentEntity) Create(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("create", e.name)
}


func (e *MostRecentEntity) Update(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("update", e.name)
}


func (e *MostRecentEntity) Remove(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("remove", e.name)
}


func (e *MostRecentEntity) runOp(ctx *core.Context, postDone func()) (any, error) {
	utility := e.utility
