...
func NewBulkEntity(client *core.TrelloSDK, entopts map[string]any) *BulkEntity {
	if entopts == nil {
		entopts = map[string]any{}
	}
...
func (e *BulkEntity) Load(reqmatch map[string]any, ctrl map[string]any) (any, error) {
	utility := e.utility
...
// BulkLoadMatch and returns an Bulk. It delegates to the untyped
// Load (identical runtime) and converts at the typed boundary.
func (e *BulkEntity) LoadTyped(reqmatch BulkLoadMatch, ctrl map[string]any) (Bulk, error) {
...
func (e *BulkEntity) Create(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("create", e.name)
}



func (e *BulkEntity) Update(reqdata map[string]any, ctrl map[string]any) (any, error) {
	utility := e.utility
	ctx := utility.MakeContext(map[string]any{
		"opname":  "update",
		"ctrl":    ctrl,
...
// BulkUpdateData and returns an Bulk. It delegates to the untyped
// Update (identical runtime) and converts at the typed boundary.
func (e *BulkEntity) UpdateTyped(reqdata BulkUpdateData, ctrl map[string]any) (Bulk, error) {
