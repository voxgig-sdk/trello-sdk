...
type CardCheckItemStateEntity struct {
	name    string
...
func NewCardCheckItemStateEntity(client *core.TrelloSDK, entopts map[string]any) *CardCheckItemStateEntity {
	if entopts == nil {
		entopts = map[string]any{}
	}
...
func (e *CardCheckItemStateEntity) GetName() string { return e.name }
...
func (e *CardCheckItemStateEntity) MarkDeleted() {
	e.deleted = true
}


// Deleted reports whether a successful Remove has resolved on this instance.
func (e *CardCheckItemStateEntity) Deleted() bool {
	return e.deleted
}


func (e *CardCheckItemStateEntity) Make() core.Entity {
	opts := map[string]any{}
	for k, v := range e.entopts {
		opts[k] = v
	}
	return NewCardCheckItemStateEntity(e.client, opts)
}

func (e *CardCheckItemStateEntity) Data(args ...any) any {
...
func (e *CardCheckItemStateEntity) Match(args ...any) any {
	if len(args) > 0 && args[0] != nil {
...
// argument it returns the current data as an CardCheckItemState; with an argument it
// sets the data and returns the stored value. It delegates to the untyped Data
// (identical runtime) and converts at the typed boundary.
func (e *CardCheckItemStateEntity) DataTyped(data ...CardCheckItemState) CardCheckItemState {
	if len(data) > 0 {
		return typedFrom[CardCheckItemState](e.Data(asMap(data[0])))
	}
	return typedFrom[CardCheckItemState](e.Data())
}

// MatchTyped mirrors DataTyped for the entity's match filter. The match is a
// partial of the entity, so it round-trips through CardCheckItemState (all fields
// optional at the wire level).
func (e *CardCheckItemStateEntity) MatchTyped(match ...CardCheckItemState) CardCheckItemState {
	if len(match) > 0 {
		return typedFrom[CardCheckItemState](e.Match(asMap(match[0])))
	}
	return typedFrom[CardCheckItemState](e.Match())
}
...
func (e *CardCheckItemStateEntity) Stream(action string, args map[string]any, callopts map[string]any) <-chan any {
	out := make(chan any)
...
func (e *CardCheckItemStateEntity) Load(reqmatch map[string]any, ctrl map[string]any) (any, error) {
	utility := e.utility
...
// CardCheckItemStateLoadMatch and returns an CardCheckItemState. It delegates to the untyped
// Load (identical runtime) and converts at the typed boundary.
func (e *CardCheckItemStateEntity) LoadTyped(reqmatch CardCheckItemStateLoadMatch, ctrl map[string]any) (CardCheckItemState, error) {
	res, err := e.Load(asMap(reqmatch), ctrl)
	if err != nil {
		return CardCheckItemState{}, err
	}
	return typedFrom[CardCheckItemState](res), nil
}



func (e *CardCheckItemStateEntity) List(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("list", e.name)
}


func (e *CardCheckItemStateEntity) Create(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("create", e.name)
}


func (e *CardCheckItemStateEntity) Update(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("update", e.name)
}


func (e *CardCheckItemStateEntity) Remove(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("remove", e.name)
}


func (e *CardCheckItemStateEntity) runOp(ctx *core.Context, postDone func()) (any, error) {
	utility := e.utility
