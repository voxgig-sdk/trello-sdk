...
type PendingOrganizationEntity struct {
	name    string
...
func NewPendingOrganizationEntity(client *core.TrelloSDK, entopts map[string]any) *PendingOrganizationEntity {
	if entopts == nil {
		entopts = map[string]any{}
	}
...
func (e *PendingOrganizationEntity) GetName() string { return e.name }
...
func (e *PendingOrganizationEntity) MarkDeleted() {
	e.deleted = true
}


// Deleted reports whether a successful Remove has resolved on this instance.
func (e *PendingOrganizationEntity) Deleted() bool {
	return e.deleted
}


func (e *PendingOrganizationEntity) Make() core.Entity {
	opts := map[string]any{}
	for k, v := range e.entopts {
		opts[k] = v
	}
	return NewPendingOrganizationEntity(e.client, opts)
}

func (e *PendingOrganizationEntity) Data(args ...any) any {
...
func (e *PendingOrganizationEntity) Match(args ...any) any {
	if len(args) > 0 && args[0] != nil {
...
// argument it returns the current data as an PendingOrganization; with an argument it
// sets the data and returns the stored value. It delegates to the untyped Data
// (identical runtime) and converts at the typed boundary.
func (e *PendingOrganizationEntity) DataTyped(data ...PendingOrganization) PendingOrganization {
	if len(data) > 0 {
		return typedFrom[PendingOrganization](e.Data(asMap(data[0])))
	}
	return typedFrom[PendingOrganization](e.Data())
}

// MatchTyped mirrors DataTyped for the entity's match filter. The match is a
// partial of the entity, so it round-trips through PendingOrganization (all fields
// optional at the wire level).
func (e *PendingOrganizationEntity) MatchTyped(match ...PendingOrganization) PendingOrganization {
	if len(match) > 0 {
		return typedFrom[PendingOrganization](e.Match(asMap(match[0])))
	}
	return typedFrom[PendingOrganization](e.Match())
}
...
func (e *PendingOrganizationEntity) Stream(action string, args map[string]any, callopts map[string]any) <-chan any {
	out := make(chan any)
...
func (e *PendingOrganizationEntity) Load(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("load", e.name)
}



func (e *PendingOrganizationEntity) List(reqmatch map[string]any, ctrl map[string]any) (any, error) {
	utility := e.utility
...
// PendingOrganizationListMatch and returns []PendingOrganization. It delegates to the untyped
// List (identical runtime) and converts at the typed boundary.
func (e *PendingOrganizationEntity) ListTyped(reqmatch PendingOrganizationListMatch, ctrl map[string]any) ([]PendingOrganization, error) {
	res, err := e.List(asMap(reqmatch), ctrl)
	if err != nil {
		return nil, err
	}
	return typedSliceFrom[PendingOrganization](res), nil
}



func (e *PendingOrganizationEntity) Create(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("create", e.name)
}


func (e *PendingOrganizationEntity) Update(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("update", e.name)
}


func (e *PendingOrganizationEntity) Remove(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("remove", e.name)
}


func (e *PendingOrganizationEntity) runOp(ctx *core.Context, postDone func()) (any, error) {
	utility := e.utility
