...
func NewStickerEntity(client *core.TrelloSDK, entopts map[string]any) *StickerEntity {
	if entopts == nil {
		entopts = map[string]any{}
	}
...
func (e *StickerEntity) GetName() string { return e.name }
...
func (e *StickerEntity) MarkDeleted() {
	e.deleted = true
}


// Deleted reports whether a successful Remove has resolved on this instance.
func (e *StickerEntity) Deleted() bool {
	return e.deleted
}


func (e *StickerEntity) Make() core.Entity {
	opts := map[string]any{}
	for k, v := range e.entopts {
		opts[k] = v
	}
	return NewStickerEntity(e.client, opts)
}

func (e *StickerEntity) Data(args ...any) any {
...
func (e *StickerEntity) Match(args ...any) any {
	if len(args) > 0 && args[0] != nil {
...
// argument it returns the current data as an Sticker; with an argument it
// sets the data and returns the stored value. It delegates to the untyped Data
// (identical runtime) and converts at the typed boundary.
func (e *StickerEntity) DataTyped(data ...Sticker) Sticker {
	if len(data) > 0 {
		return typedFrom[Sticker](e.Data(asMap(data[0])))
	}
	return typedFrom[Sticker](e.Data())
}

// MatchTyped mirrors DataTyped for the entity's match filter. The match is a
// partial of the entity, so it round-trips through Sticker (all fields
// optional at the wire level).
func (e *StickerEntity) MatchTyped(match ...Sticker) Sticker {
	if len(match) > 0 {
		return typedFrom[Sticker](e.Match(asMap(match[0])))
	}
	return typedFrom[Sticker](e.Match())
}
...
func (e *StickerEntity) Stream(action string, args map[string]any, callopts map[string]any) <-chan any {
	out := make(chan any)
...
func (e *StickerEntity) Load(reqmatch map[string]any, ctrl map[string]any) (any, error) {
	utility := e.utility
...
// StickerLoadMatch and returns an Sticker. It delegates to the untyped
// Load (identical runtime) and converts at the typed boundary.
func (e *StickerEntity) LoadTyped(reqmatch StickerLoadMatch, ctrl map[string]any) (Sticker, error) {
	res, err := e.Load(asMap(reqmatch), ctrl)
	if err != nil {
		return Sticker{}, err
	}
	return typedFrom[Sticker](res), nil
}



func (e *StickerEntity) List(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("list", e.name)
}


func (e *StickerEntity) Create(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("create", e.name)
}



func (e *StickerEntity) Update(reqdata map[string]any, ctrl map[string]any) (any, error) {
	utility := e.utility
	ctx := utility.MakeContext(map[string]any{
		"opname":  "update",
		"ctrl":    ctrl,
...
// StickerUpdateData and returns an Sticker. It delegates to the untyped
// Update (identical runtime) and converts at the typed boundary.
func (e *StickerEntity) UpdateTyped(reqdata StickerUpdateData, ctrl map[string]any) (Sticker, error) {
...
func (e *StickerEntity) Remove(reqmatch map[string]any, ctrl map[string]any) (any, error) {
	utility := e.utility
	ctx := utility.MakeContext(map[string]any{
		"opname":   "remove",
		"ctrl":     ctrl,
...
// StickerRemoveMatch and returns an Sticker. It delegates to the untyped
// Remove (identical runtime) and converts at the typed boundary.
func (e *StickerEntity) RemoveTyped(reqmatch StickerRemoveMatch, ctrl map[string]any) (Sticker, error) {
...
func (e *StickerEntity) runOp(ctx *core.Context, postDone func()) (any, error) {
	utility := e.utility
