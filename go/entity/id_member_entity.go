...
func NewIdMemberEntity(client *core.TrelloSDK, entopts map[string]any) *IdMemberEntity {
	if entopts == nil {
		entopts = map[string]any{}
	}
...
func (e *IdMemberEntity) GetName() string { return e.name }
...
func (e *IdMemberEntity) MarkDeleted() {
	e.deleted = true
}


// Deleted reports whether a successful Remove has resolved on this instance.
func (e *IdMemberEntity) Deleted() bool {
	return e.deleted
}


func (e *IdMemberEntity) Make() core.Entity {
	opts := map[string]any{}
	for k, v := range e.entopts {
		opts[k] = v
	}
	return NewIdMemberEntity(e.client, opts)
}

func (e *IdMemberEntity) Data(args ...any) any {
...
func (e *IdMemberEntity) Match(args ...any) any {
	if len(args) > 0 && args[0] != nil {
...
// argument it returns the current data as an IdMember; with an argument it
// sets the data and returns the stored value. It delegates to the untyped Data
// (identical runtime) and converts at the typed boundary.
func (e *IdMemberEntity) DataTyped(data ...IdMember) IdMember {
	if len(data) > 0 {
		return typedFrom[IdMember](e.Data(asMap(data[0])))
	}
	return typedFrom[IdMember](e.Data())
}

// MatchTyped mirrors DataTyped for the entity's match filter. The match is a
// partial of the entity, so it round-trips through IdMember (all fields
// optional at the wire level).
func (e *IdMemberEntity) MatchTyped(match ...IdMember) IdMember {
	if len(match) > 0 {
		return typedFrom[IdMember](e.Match(asMap(match[0])))
	}
	return typedFrom[IdMember](e.Match())
}
...
func (e *IdMemberEntity) Stream(action string, args map[string]any, callopts map[string]any) <-chan any {
	out := make(chan any)
...
func (e *IdMemberEntity) Load(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("load", e.name)
}


func (e *IdMemberEntity) List(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("list", e.name)
}


func (e *IdMemberEntity) Create(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("create", e.name)
}


func (e *IdMemberEntity) Update(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("update", e.name)
}



func (e *IdMemberEntity) Remove(reqmatch map[string]any, ctrl map[string]any) (any, error) {
	utility := e.utility
...
// IdMemberRemoveMatch and returns an IdMember. It delegates to the untyped
// Remove (identical runtime) and converts at the typed boundary.
func (e *IdMemberEntity) RemoveTyped(reqmatch IdMemberRemoveMatch, ctrl map[string]any) (IdMember, error) {
	res, err := e.Remove(asMap(reqmatch), ctrl)
	if err != nil {
		return IdMember{}, err
	}
	return typedFrom[IdMember](res), nil
}



func (e *IdMemberEntity) runOp(ctx *core.Context, postDone func()) (any, error) {
	utility := e.utility
