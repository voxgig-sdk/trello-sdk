...
func NewEmojiEntity(client *core.TrelloSDK, entopts map[string]any) *EmojiEntity {
	if entopts == nil {
		entopts = map[string]any{}
	}
...
func (e *EmojiEntity) Load(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("load", e.name)
}



func (e *EmojiEntity) List(reqmatch map[string]any, ctrl map[string]any) (any, error) {
	utility := e.utility
...
// EmojiListMatch and returns []Emoji. It delegates to the untyped
// List (identical runtime) and converts at the typed boundary.
func (e *EmojiEntity) ListTyped(reqmatch EmojiListMatch, ctrl map[string]any) ([]Emoji, error) {
	res, err := e.List(asMap(reqmatch), ctrl)
	if err != nil {
		return nil, err
	}
	return typedSliceFrom[Emoji](res), nil
}
