...
type ShowSidebarMemberEntity struct {
	name    string
...
func NewShowSidebarMemberEntity(client *core.TrelloSDK, entopts map[string]any) *ShowSidebarMemberEntity {
	if entopts == nil {
		entopts = map[string]any{}
	}
...
func (e *ShowSidebarMemberEntity) GetName() string { return e.name }
...
func (e *ShowSidebarMemberEntity) MarkDeleted() {
	e.deleted = true
}


// Deleted reports whether a successful Remove has resolved on this instance.
func (e *ShowSidebarMemberEntity) Deleted() bool {
	return e.deleted
}


func (e *ShowSidebarMemberEntity) Make() core.Entity {
	opts := map[string]any{}
	for k, v := range e.entopts {
		opts[k] = v
	}
	return NewShowSidebarMemberEntity(e.client, opts)
}

func (e *ShowSidebarMemberEntity) Data(args ...any) any {
...
func (e *ShowSidebarMemberEntity) Match(args ...any) any {
	if len(args) > 0 && args[0] != nil {
...
// argument it returns the current data as an ShowSidebarMember; with an argument it
// sets the data and returns the stored value. It delegates to the untyped Data
// (identical runtime) and converts at the typed boundary.
func (e *ShowSidebarMemberEntity) DataTyped(data ...ShowSidebarMember) ShowSidebarMember {
	if len(data) > 0 {
		return typedFrom[ShowSidebarMember](e.Data(asMap(data[0])))
	}
	return typedFrom[ShowSidebarMember](e.Data())
}

// MatchTyped mirrors DataTyped for the entity's match filter. The match is a
// partial of the entity, so it round-trips through ShowSidebarMember (all fields
// optional at the wire level).
func (e *ShowSidebarMemberEntity) MatchTyped(match ...ShowSidebarMember) ShowSidebarMember {
	if len(match) > 0 {
		return typedFrom[ShowSidebarMember](e.Match(asMap(match[0])))
	}
	return typedFrom[ShowSidebarMember](e.Match())
}
...
func (e *ShowSidebarMemberEntity) Stream(action string, args map[string]any, callopts map[string]any) <-chan any {
	out := make(chan any)
...
func (e *ShowSidebarMemberEntity) Load(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("load", e.name)
}


func (e *ShowSidebarMemberEntity) List(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("list", e.name)
}


func (e *ShowSidebarMemberEntity) Create(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("create", e.name)
}



func (e *ShowSidebarMemberEntity) Update(reqdata map[string]any, ctrl map[string]any) (any, error) {
	utility := e.utility
...
// ShowSidebarMemberUpdateData and returns an ShowSidebarMember. It delegates to the untyped
// Update (identical runtime) and converts at the typed boundary.
func (e *ShowSidebarMemberEntity) UpdateTyped(reqdata ShowSidebarMemberUpdateData, ctrl map[string]any) (ShowSidebarMember, error) {
	res, err := e.Update(asMap(reqdata), ctrl)
	if err != nil {
		return ShowSidebarMember{}, err
	}
	return typedFrom[ShowSidebarMember](res), nil
}



func (e *ShowSidebarMemberEntity) Remove(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("remove", e.name)
}


func (e *ShowSidebarMemberEntity) runOp(ctx *core.Context, postDone func()) (any, error) {
	utility := e.utility
