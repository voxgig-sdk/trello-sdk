...
type EnterpriseAuditLogEntity struct {
	name    string
...
func NewEnterpriseAuditLogEntity(client *core.TrelloSDK, entopts map[string]any) *EnterpriseAuditLogEntity {
	if entopts == nil {
		entopts = map[string]any{}
	}
...
func (e *EnterpriseAuditLogEntity) GetName() string { return e.name }
...
func (e *EnterpriseAuditLogEntity) MarkDeleted() {
	e.deleted = true
}


// Deleted reports whether a successful Remove has resolved on this instance.
func (e *EnterpriseAuditLogEntity) Deleted() bool {
	return e.deleted
}


func (e *EnterpriseAuditLogEntity) Make() core.Entity {
	opts := map[string]any{}
	for k, v := range e.entopts {
		opts[k] = v
	}
	return NewEnterpriseAuditLogEntity(e.client, opts)
}

func (e *EnterpriseAuditLogEntity) Data(args ...any) any {
...
func (e *EnterpriseAuditLogEntity) Match(args ...any) any {
	if len(args) > 0 && args[0] != nil {
...
// argument it returns the current data as an EnterpriseAuditLog; with an argument it
// sets the data and returns the stored value. It delegates to the untyped Data
// (identical runtime) and converts at the typed boundary.
func (e *EnterpriseAuditLogEntity) DataTyped(data ...EnterpriseAuditLog) EnterpriseAuditLog {
	if len(data) > 0 {
		return typedFrom[EnterpriseAuditLog](e.Data(asMap(data[0])))
	}
	return typedFrom[EnterpriseAuditLog](e.Data())
}

// MatchTyped mirrors DataTyped for the entity's match filter. The match is a
// partial of the entity, so it round-trips through EnterpriseAuditLog (all fields
// optional at the wire level).
func (e *EnterpriseAuditLogEntity) MatchTyped(match ...EnterpriseAuditLog) EnterpriseAuditLog {
	if len(match) > 0 {
		return typedFrom[EnterpriseAuditLog](e.Match(asMap(match[0])))
	}
	return typedFrom[EnterpriseAuditLog](e.Match())
}
...
func (e *EnterpriseAuditLogEntity) Stream(action string, args map[string]any, callopts map[string]any) <-chan any {
	out := make(chan any)
...
func (e *EnterpriseAuditLogEntity) Load(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("load", e.name)
}



func (e *EnterpriseAuditLogEntity) List(reqmatch map[string]any, ctrl map[string]any) (any, error) {
	utility := e.utility
...
// EnterpriseAuditLogListMatch and returns []EnterpriseAuditLog. It delegates to the untyped
// List (identical runtime) and converts at the typed boundary.
func (e *EnterpriseAuditLogEntity) ListTyped(reqmatch EnterpriseAuditLogListMatch, ctrl map[string]any) ([]EnterpriseAuditLog, error) {
	res, err := e.List(asMap(reqmatch), ctrl)
	if err != nil {
		return nil, err
	}
	return typedSliceFrom[EnterpriseAuditLog](res), nil
}



func (e *EnterpriseAuditLogEntity) Create(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("create", e.name)
}


func (e *EnterpriseAuditLogEntity) Update(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("update", e.name)
}


func (e *EnterpriseAuditLogEntity) Remove(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("remove", e.name)
}


func (e *EnterpriseAuditLogEntity) runOp(ctx *core.Context, postDone func()) (any, error) {
	utility := e.utility
