...
type MembersVotedEntity struct {
	name    string
...
func NewMembersVotedEntity(client *core.TrelloSDK, entopts map[string]any) *MembersVotedEntity {
	if entopts == nil {
		entopts = map[string]any{}
	}
...
func (e *MembersVotedEntity) GetName() string { return e.name }
...
func (e *MembersVotedEntity) MarkDeleted() {
	e.deleted = true
}


// Deleted reports whether a successful Remove has resolved on this instance.
func (e *MembersVotedEntity) Deleted() bool {
	return e.deleted
}


func (e *MembersVotedEntity) Make() core.Entity {
	opts := map[string]any{}
	for k, v := range e.entopts {
		opts[k] = v
	}
	return NewMembersVotedEntity(e.client, opts)
}

func (e *MembersVotedEntity) Data(args ...any) any {
...
func (e *MembersVotedEntity) Match(args ...any) any {
	if len(args) > 0 && args[0] != nil {
...
// argument it returns the current data as an MembersVoted; with an argument it
// sets the data and returns the stored value. It delegates to the untyped Data
// (identical runtime) and converts at the typed boundary.
func (e *MembersVotedEntity) DataTyped(data ...MembersVoted) MembersVoted {
	if len(data) > 0 {
		return typedFrom[MembersVoted](e.Data(asMap(data[0])))
	}
	return typedFrom[MembersVoted](e.Data())
}

// MatchTyped mirrors DataTyped for the entity's match filter. The match is a
// partial of the entity, so it round-trips through MembersVoted (all fields
// optional at the wire level).
func (e *MembersVotedEntity) MatchTyped(match ...MembersVoted) MembersVoted {
	if len(match) > 0 {
		return typedFrom[MembersVoted](e.Match(asMap(match[0])))
	}
	return typedFrom[MembersVoted](e.Match())
}
...
func (e *MembersVotedEntity) Stream(action string, args map[string]any, callopts map[string]any) <-chan any {
	out := make(chan any)
...
func (e *MembersVotedEntity) Load(reqmatch map[string]any, ctrl map[string]any) (any, error) {
	utility := e.utility
...
// MembersVotedLoadMatch and returns an MembersVoted. It delegates to the untyped
// Load (identical runtime) and converts at the typed boundary.
func (e *MembersVotedEntity) LoadTyped(reqmatch MembersVotedLoadMatch, ctrl map[string]any) (MembersVoted, error) {
	res, err := e.Load(asMap(reqmatch), ctrl)
	if err != nil {
		return MembersVoted{}, err
	}
	return typedFrom[MembersVoted](res), nil
}



func (e *MembersVotedEntity) List(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("list", e.name)
}


func (e *MembersVotedEntity) Create(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("create", e.name)
}


func (e *MembersVotedEntity) Update(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("update", e.name)
}



func (e *MembersVotedEntity) Remove(reqmatch map[string]any, ctrl map[string]any) (any, error) {
	utility := e.utility
	ctx := utility.MakeContext(map[string]any{
		"opname":   "remove",
		"ctrl":     ctrl,
...
// MembersVotedRemoveMatch and returns an MembersVoted. It delegates to the untyped
// Remove (identical runtime) and converts at the typed boundary.
func (e *MembersVotedEntity) RemoveTyped(reqmatch MembersVotedRemoveMatch, ctrl map[string]any) (MembersVoted, error) {
...
func (e *MembersVotedEntity) runOp(ctx *core.Context, postDone func()) (any, error) {
	utility := e.utility
