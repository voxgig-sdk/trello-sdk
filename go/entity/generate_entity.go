...
func NewGenerateEntity(client *core.TrelloSDK, entopts map[string]any) *GenerateEntity {
	if entopts == nil {
		entopts = map[string]any{}
	}
...
func (e *GenerateEntity) Load(_ map[string]any, _ map[string]any) (any, error) {
...
func (e *GenerateEntity) Create(reqdata map[string]any, ctrl map[string]any) (any, error) {
	utility := e.utility
...
// GenerateCreateData and returns an Generate. It delegates to the untyped
// Create (identical runtime) and converts at the typed boundary.
func (e *GenerateEntity) CreateTyped(reqdata GenerateCreateData, ctrl map[string]any) (Generate, error) {
