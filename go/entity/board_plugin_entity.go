...
func NewBoardPluginEntity(client *core.TrelloSDK, entopts map[string]any) *BoardPluginEntity {
	if entopts == nil {
		entopts = map[string]any{}
	}
...
func (e *BoardPluginEntity) GetName() string { return e.name }
...
func (e *BoardPluginEntity) MarkDeleted() {
	e.deleted = true
}


// Deleted reports whether a successful Remove has resolved on this instance.
func (e *BoardPluginEntity) Deleted() bool {
	return e.deleted
}


func (e *BoardPluginEntity) Make() core.Entity {
	opts := map[string]any{}
	for k, v := range e.entopts {
		opts[k] = v
	}
	return NewBoardPluginEntity(e.client, opts)
}

func (e *BoardPluginEntity) Data(args ...any) any {
...
func (e *BoardPluginEntity) Match(args ...any) any {
	if len(args) > 0 && args[0] != nil {
...
// argument it returns the current data as an BoardPlugin; with an argument it
// sets the data and returns the stored value. It delegates to the untyped Data
// (identical runtime) and converts at the typed boundary.
func (e *BoardPluginEntity) DataTyped(data ...BoardPlugin) BoardPlugin {
	if len(data) > 0 {
		return typedFrom[BoardPlugin](e.Data(asMap(data[0])))
	}
	return typedFrom[BoardPlugin](e.Data())
}

// MatchTyped mirrors DataTyped for the entity's match filter. The match is a
// partial of the entity, so it round-trips through BoardPlugin (all fields
// optional at the wire level).
func (e *BoardPluginEntity) MatchTyped(match ...BoardPlugin) BoardPlugin {
	if len(match) > 0 {
		return typedFrom[BoardPlugin](e.Match(asMap(match[0])))
	}
	return typedFrom[BoardPlugin](e.Match())
}
...
func (e *BoardPluginEntity) Stream(action string, args map[string]any, callopts map[string]any) <-chan any {
	out := make(chan any)
...
func (e *BoardPluginEntity) Load(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("load", e.name)
}


func (e *BoardPluginEntity) List(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("list", e.name)
}


func (e *BoardPluginEntity) Create(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("create", e.name)
}


func (e *BoardPluginEntity) Update(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("update", e.name)
}



func (e *BoardPluginEntity) Remove(reqmatch map[string]any, ctrl map[string]any) (any, error) {
	utility := e.utility
...
// BoardPluginRemoveMatch and returns an BoardPlugin. It delegates to the untyped
// Remove (identical runtime) and converts at the typed boundary.
func (e *BoardPluginEntity) RemoveTyped(reqmatch BoardPluginRemoveMatch, ctrl map[string]any) (BoardPlugin, error) {
	res, err := e.Remove(asMap(reqmatch), ctrl)
	if err != nil {
		return BoardPlugin{}, err
	}
	return typedFrom[BoardPlugin](res), nil
}



func (e *BoardPluginEntity) runOp(ctx *core.Context, postDone func()) (any, error) {
	utility := e.utility
