...
func NewCardListEntity(client *core.TrelloSDK, entopts map[string]any) *CardListEntity {
	if entopts == nil {
		entopts = map[string]any{}
	}
...
func (e *CardListEntity) Load(reqmatch map[string]any, ctrl map[string]any) (any, error) {
	utility := e.utility
...
// CardListLoadMatch and returns an CardList. It delegates to the untyped
// Load (identical runtime) and converts at the typed boundary.
func (e *CardListEntity) LoadTyped(reqmatch CardListLoadMatch, ctrl map[string]any) (CardList, error) {
...
func (e *CardListEntity) List(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("list", e.name)
}


func (e *CardListEntity) Create(_ map[string]any, _ map[string]any) (any, error) {
