...
func NewReadEntity(client *core.TrelloSDK, entopts map[string]any) *ReadEntity {
	if entopts == nil {
		entopts = map[string]any{}
	}
...
func (e *ReadEntity) GetName() string { return e.name }
...
func (e *ReadEntity) MarkDeleted() {
	e.deleted = true
}


// Deleted reports whether a successful Remove has resolved on this instance.
func (e *ReadEntity) Deleted() bool {
	return e.deleted
}


func (e *ReadEntity) Make() core.Entity {
	opts := map[string]any{}
	for k, v := range e.entopts {
		opts[k] = v
	}
	return NewReadEntity(e.client, opts)
}

func (e *ReadEntity) Data(args ...any) any {
...
func (e *ReadEntity) Match(args ...any) any {
	if len(args) > 0 && args[0] != nil {
...
// argument it returns the current data as an Read; with an argument it
// sets the data and returns the stored value. It delegates to the untyped Data
// (identical runtime) and converts at the typed boundary.
func (e *ReadEntity) DataTyped(data ...Read) Read {
	if len(data) > 0 {
		return typedFrom[Read](e.Data(asMap(data[0])))
	}
	return typedFrom[Read](e.Data())
}

// MatchTyped mirrors DataTyped for the entity's match filter. The match is a
// partial of the entity, so it round-trips through Read (all fields
// optional at the wire level).
func (e *ReadEntity) MatchTyped(match ...Read) Read {
	if len(match) > 0 {
		return typedFrom[Read](e.Match(asMap(match[0])))
	}
	return typedFrom[Read](e.Match())
}
...
func (e *ReadEntity) Stream(action string, args map[string]any, callopts map[string]any) <-chan any {
	out := make(chan any)
...
func (e *ReadEntity) Load(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("load", e.name)
}


func (e *ReadEntity) List(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("list", e.name)
}



func (e *ReadEntity) Create(reqdata map[string]any, ctrl map[string]any) (any, error) {
	utility := e.utility
...
// ReadCreateData and returns an Read. It delegates to the untyped
// Create (identical runtime) and converts at the typed boundary.
func (e *ReadEntity) CreateTyped(reqdata ReadCreateData, ctrl map[string]any) (Read, error) {
	res, err := e.Create(asMap(reqdata), ctrl)
	if err != nil {
		return Read{}, err
	}
	return typedFrom[Read](res), nil
}



func (e *ReadEntity) Update(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("update", e.name)
}


func (e *ReadEntity) Remove(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("remove", e.name)
}


func (e *ReadEntity) runOp(ctx *core.Context, postDone func()) (any, error) {
	utility := e.utility
