...
func NewLabelEntity(client *core.TrelloSDK, entopts map[string]any) *LabelEntity {
	if entopts == nil {
		entopts = map[string]any{}
	}
...
func (e *LabelEntity) List(_ map[string]any, _ map[string]any) (any, error) {
...
func (e *LabelEntity) Remove(reqmatch map[string]any, ctrl map[string]any) (any, error) {
	utility := e.utility
	ctx := utility.MakeContext(map[string]any{
		"opname":   "remove",
		"ctrl":     ctrl,
...
// LabelRemoveMatch and returns an Label. It delegates to the untyped
// Remove (identical runtime) and converts at the typed boundary.
func (e *LabelEntity) RemoveTyped(reqmatch LabelRemoveMatch, ctrl map[string]any) (Label, error) {
