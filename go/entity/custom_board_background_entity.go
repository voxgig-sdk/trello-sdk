...
type CustomBoardBackgroundEntity struct {
	name    string
...
func NewCustomBoardBackgroundEntity(client *core.TrelloSDK, entopts map[string]any) *CustomBoardBackgroundEntity {
	if entopts == nil {
		entopts = map[string]any{}
	}
...
func (e *CustomBoardBackgroundEntity) GetName() string { return e.name }
...
func (e *CustomBoardBackgroundEntity) MarkDeleted() {
	e.deleted = true
}


// Deleted reports whether a successful Remove has resolved on this instance.
func (e *CustomBoardBackgroundEntity) Deleted() bool {
	return e.deleted
}


func (e *CustomBoardBackgroundEntity) Make() core.Entity {
	opts := map[string]any{}
	for k, v := range e.entopts {
		opts[k] = v
	}
	return NewCustomBoardBackgroundEntity(e.client, opts)
}

func (e *CustomBoardBackgroundEntity) Data(args ...any) any {
...
func (e *CustomBoardBackgroundEntity) Match(args ...any) any {
	if len(args) > 0 && args[0] != nil {
...
// argument it returns the current data as an CustomBoardBackground; with an argument it
// sets the data and returns the stored value. It delegates to the untyped Data
// (identical runtime) and converts at the typed boundary.
func (e *CustomBoardBackgroundEntity) DataTyped(data ...CustomBoardBackground) CustomBoardBackground {
	if len(data) > 0 {
		return typedFrom[CustomBoardBackground](e.Data(asMap(data[0])))
	}
	return typedFrom[CustomBoardBackground](e.Data())
}

// MatchTyped mirrors DataTyped for the entity's match filter. The match is a
// partial of the entity, so it round-trips through CustomBoardBackground (all fields
// optional at the wire level).
func (e *CustomBoardBackgroundEntity) MatchTyped(match ...CustomBoardBackground) CustomBoardBackground {
	if len(match) > 0 {
		return typedFrom[CustomBoardBackground](e.Match(asMap(match[0])))
	}
	return typedFrom[CustomBoardBackground](e.Match())
}
...
func (e *CustomBoardBackgroundEntity) Stream(action string, args map[string]any, callopts map[string]any) <-chan any {
	out := make(chan any)
...
func (e *CustomBoardBackgroundEntity) Load(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("load", e.name)
}


func (e *CustomBoardBackgroundEntity) List(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("list", e.name)
}


func (e *CustomBoardBackgroundEntity) Create(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("create", e.name)
}


func (e *CustomBoardBackgroundEntity) Update(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("update", e.name)
}



func (e *CustomBoardBackgroundEntity) Remove(reqmatch map[string]any, ctrl map[string]any) (any, error) {
	utility := e.utility
...
// CustomBoardBackgroundRemoveMatch and returns an CustomBoardBackground. It delegates to the untyped
// Remove (identical runtime) and converts at the typed boundary.
func (e *CustomBoardBackgroundEntity) RemoveTyped(reqmatch CustomBoardBackgroundRemoveMatch, ctrl map[string]any) (CustomBoardBackground, error) {
	res, err := e.Remove(asMap(reqmatch), ctrl)
	if err != nil {
		return CustomBoardBackground{}, err
	}
	return typedFrom[CustomBoardBackground](res), nil
}



func (e *CustomBoardBackgroundEntity) runOp(ctx *core.Context, postDone func()) (any, error) {
	utility := e.utility
