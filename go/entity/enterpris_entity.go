...
func NewEnterprisEntity(client *core.TrelloSDK, entopts map[string]any) *EnterprisEntity {
	if entopts == nil {
		entopts = map[string]any{}
	}
...
func (e *EnterprisEntity) GetName() string { return e.name }
...
func (e *EnterprisEntity) MarkDeleted() {
	e.deleted = true
}


// Deleted reports whether a successful Remove has resolved on this instance.
func (e *EnterprisEntity) Deleted() bool {
	return e.deleted
}


func (e *EnterprisEntity) Make() core.Entity {
	opts := map[string]any{}
	for k, v := range e.entopts {
		opts[k] = v
	}
	return NewEnterprisEntity(e.client, opts)
}

func (e *EnterprisEntity) Data(args ...any) any {
...
func (e *EnterprisEntity) Match(args ...any) any {
	if len(args) > 0 && args[0] != nil {
...
// argument it returns the current data as an Enterpris; with an argument it
// sets the data and returns the stored value. It delegates to the untyped Data
// (identical runtime) and converts at the typed boundary.
func (e *EnterprisEntity) DataTyped(data ...Enterpris) Enterpris {
	if len(data) > 0 {
		return typedFrom[Enterpris](e.Data(asMap(data[0])))
	}
	return typedFrom[Enterpris](e.Data())
}

// MatchTyped mirrors DataTyped for the entity's match filter. The match is a
// partial of the entity, so it round-trips through Enterpris (all fields
// optional at the wire level).
func (e *EnterprisEntity) MatchTyped(match ...Enterpris) Enterpris {
	if len(match) > 0 {
		return typedFrom[Enterpris](e.Match(asMap(match[0])))
	}
	return typedFrom[Enterpris](e.Match())
}
...
func (e *EnterprisEntity) Stream(action string, args map[string]any, callopts map[string]any) <-chan any {
	out := make(chan any)
...
func (e *EnterprisEntity) Load(reqmatch map[string]any, ctrl map[string]any) (any, error) {
	utility := e.utility
...
// EnterprisLoadMatch and returns an Enterpris. It delegates to the untyped
// Load (identical runtime) and converts at the typed boundary.
func (e *EnterprisEntity) LoadTyped(reqmatch EnterprisLoadMatch, ctrl map[string]any) (Enterpris, error) {
	res, err := e.Load(asMap(reqmatch), ctrl)
	if err != nil {
		return Enterpris{}, err
	}
	return typedFrom[Enterpris](res), nil
}



func (e *EnterprisEntity) List(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("list", e.name)
}



func (e *EnterprisEntity) Create(reqdata map[string]any, ctrl map[string]any) (any, error) {
	utility := e.utility
	ctx := utility.MakeContext(map[string]any{
		"opname":  "create",
		"ctrl":    ctrl,
...
// EnterprisCreateData and returns an Enterpris. It delegates to the untyped
// Create (identical runtime) and converts at the typed boundary.
func (e *EnterprisEntity) CreateTyped(reqdata EnterprisCreateData, ctrl map[string]any) (Enterpris, error) {
...
func (e *EnterprisEntity) Update(reqdata map[string]any, ctrl map[string]any) (any, error) {
	utility := e.utility
	ctx := utility.MakeContext(map[string]any{
		"opname":  "update",
		"ctrl":    ctrl,
...
// EnterprisUpdateData and returns an Enterpris. It delegates to the untyped
// Update (identical runtime) and converts at the typed boundary.
func (e *EnterprisEntity) UpdateTyped(reqdata EnterprisUpdateData, ctrl map[string]any) (Enterpris, error) {
...
func (e *EnterprisEntity) Remove(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("remove", e.name)
}


func (e *EnterprisEntity) runOp(ctx *core.Context, postDone func()) (any, error) {
	utility := e.utility
