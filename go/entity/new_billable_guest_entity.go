...
type NewBillableGuestEntity struct {
	name    string
...
func NewNewBillableGuestEntity(client *core.TrelloSDK, entopts map[string]any) *NewBillableGuestEntity {
	if entopts == nil {
		entopts = map[string]any{}
	}
...
func (e *NewBillableGuestEntity) GetName() string { return e.name }
...
func (e *NewBillableGuestEntity) MarkDeleted() {
	e.deleted = true
}


// Deleted reports whether a successful Remove has resolved on this instance.
func (e *NewBillableGuestEntity) Deleted() bool {
	return e.deleted
}


func (e *NewBillableGuestEntity) Make() core.Entity {
	opts := map[string]any{}
	for k, v := range e.entopts {
		opts[k] = v
	}
	return NewNewBillableGuestEntity(e.client, opts)
}

func (e *NewBillableGuestEntity) Data(args ...any) any {
...
func (e *NewBillableGuestEntity) Match(args ...any) any {
	if len(args) > 0 && args[0] != nil {
...
// argument it returns the current data as an NewBillableGuest; with an argument it
// sets the data and returns the stored value. It delegates to the untyped Data
// (identical runtime) and converts at the typed boundary.
func (e *NewBillableGuestEntity) DataTyped(data ...NewBillableGuest) NewBillableGuest {
	if len(data) > 0 {
		return typedFrom[NewBillableGuest](e.Data(asMap(data[0])))
	}
	return typedFrom[NewBillableGuest](e.Data())
}

// MatchTyped mirrors DataTyped for the entity's match filter. The match is a
// partial of the entity, so it round-trips through NewBillableGuest (all fields
// optional at the wire level).
func (e *NewBillableGuestEntity) MatchTyped(match ...NewBillableGuest) NewBillableGuest {
	if len(match) > 0 {
		return typedFrom[NewBillableGuest](e.Match(asMap(match[0])))
	}
	return typedFrom[NewBillableGuest](e.Match())
}
...
func (e *NewBillableGuestEntity) Stream(action string, args map[string]any, callopts map[string]any) <-chan any {
	out := make(chan any)
...
func (e *NewBillableGuestEntity) Load(reqmatch map[string]any, ctrl map[string]any) (any, error) {
	utility := e.utility
...
// NewBillableGuestLoadMatch and returns an NewBillableGuest. It delegates to the untyped
// Load (identical runtime) and converts at the typed boundary.
func (e *NewBillableGuestEntity) LoadTyped(reqmatch NewBillableGuestLoadMatch, ctrl map[string]any) (NewBillableGuest, error) {
	res, err := e.Load(asMap(reqmatch), ctrl)
	if err != nil {
		return NewBillableGuest{}, err
	}
	return typedFrom[NewBillableGuest](res), nil
}



func (e *NewBillableGuestEntity) List(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("list", e.name)
}


func (e *NewBillableGuestEntity) Create(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("create", e.name)
}


func (e *NewBillableGuestEntity) Update(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("update", e.name)
}


func (e *NewBillableGuestEntity) Remove(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("remove", e.name)
}


func (e *NewBillableGuestEntity) runOp(ctx *core.Context, postDone func()) (any, error) {
	utility := e.utility
