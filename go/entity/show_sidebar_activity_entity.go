...
type ShowSidebarActivityEntity struct {
	name    string
...
func NewShowSidebarActivityEntity(client *core.TrelloSDK, entopts map[string]any) *ShowSidebarActivityEntity {
	if entopts == nil {
		entopts = map[string]any{}
	}
...
func (e *ShowSidebarActivityEntity) GetName() string { return e.name }
...
func (e *ShowSidebarActivityEntity) MarkDeleted() {
	e.deleted = true
}


// Deleted reports whether a successful Remove has resolved on this instance.
func (e *ShowSidebarActivityEntity) Deleted() bool {
	return e.deleted
}


func (e *ShowSidebarActivityEntity) Make() core.Entity {
	opts := map[string]any{}
	for k, v := range e.entopts {
		opts[k] = v
	}
	return NewShowSidebarActivityEntity(e.client, opts)
}

func (e *ShowSidebarActivityEntity) Data(args ...any) any {
...
func (e *ShowSidebarActivityEntity) Match(args ...any) any {
	if len(args) > 0 && args[0] != nil {
...
// argument it returns the current data as an ShowSidebarActivity; with an argument it
// sets the data and returns the stored value. It delegates to the untyped Data
// (identical runtime) and converts at the typed boundary.
func (e *ShowSidebarActivityEntity) DataTyped(data ...ShowSidebarActivity) ShowSidebarActivity {
	if len(data) > 0 {
		return typedFrom[ShowSidebarActivity](e.Data(asMap(data[0])))
	}
	return typedFrom[ShowSidebarActivity](e.Data())
}

// MatchTyped mirrors DataTyped for the entity's match filter. The match is a
// partial of the entity, so it round-trips through ShowSidebarActivity (all fields
// optional at the wire level).
func (e *ShowSidebarActivityEntity) MatchTyped(match ...ShowSidebarActivity) ShowSidebarActivity {
	if len(match) > 0 {
		return typedFrom[ShowSidebarActivity](e.Match(asMap(match[0])))
	}
	return typedFrom[ShowSidebarActivity](e.Match())
}
...
func (e *ShowSidebarActivityEntity) Stream(action string, args map[string]any, callopts map[string]any) <-chan any {
	out := make(chan any)
...
func (e *ShowSidebarActivityEntity) Load(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("load", e.name)
}


func (e *ShowSidebarActivityEntity) List(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("list", e.name)
}


func (e *ShowSidebarActivityEntity) Create(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("create", e.name)
}



func (e *ShowSidebarActivityEntity) Update(reqdata map[string]any, ctrl map[string]any) (any, error) {
	utility := e.utility
...
// ShowSidebarActivityUpdateData and returns an ShowSidebarActivity. It delegates to the untyped
// Update (identical runtime) and converts at the typed boundary.
func (e *ShowSidebarActivityEntity) UpdateTyped(reqdata ShowSidebarActivityUpdateData, ctrl map[string]any) (ShowSidebarActivity, error) {
	res, err := e.Update(asMap(reqdata), ctrl)
	if err != nil {
		return ShowSidebarActivity{}, err
	}
	return typedFrom[ShowSidebarActivity](res), nil
}



func (e *ShowSidebarActivityEntity) Remove(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("remove", e.name)
}


func (e *ShowSidebarActivityEntity) runOp(ctx *core.Context, postDone func()) (any, error) {
	utility := e.utility
