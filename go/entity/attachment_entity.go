...
func NewAttachmentEntity(client *core.TrelloSDK, entopts map[string]any) *AttachmentEntity {
	if entopts == nil {
		entopts = map[string]any{}
	}
...
func (e *AttachmentEntity) GetName() string { return e.name }
...
func (e *AttachmentEntity) MarkDeleted() {
	e.deleted = true
}


// Deleted reports whether a successful Remove has resolved on this instance.
func (e *AttachmentEntity) Deleted() bool {
	return e.deleted
}


func (e *AttachmentEntity) Make() core.Entity {
	opts := map[string]any{}
	for k, v := range e.entopts {
		opts[k] = v
	}
	return NewAttachmentEntity(e.client, opts)
}

func (e *AttachmentEntity) Data(args ...any) any {
...
func (e *AttachmentEntity) Match(args ...any) any {
	if len(args) > 0 && args[0] != nil {
...
// argument it returns the current data as an Attachment; with an argument it
// sets the data and returns the stored value. It delegates to the untyped Data
// (identical runtime) and converts at the typed boundary.
func (e *AttachmentEntity) DataTyped(data ...Attachment) Attachment {
	if len(data) > 0 {
		return typedFrom[Attachment](e.Data(asMap(data[0])))
	}
	return typedFrom[Attachment](e.Data())
}

// MatchTyped mirrors DataTyped for the entity's match filter. The match is a
// partial of the entity, so it round-trips through Attachment (all fields
// optional at the wire level).
func (e *AttachmentEntity) MatchTyped(match ...Attachment) Attachment {
	if len(match) > 0 {
		return typedFrom[Attachment](e.Match(asMap(match[0])))
	}
	return typedFrom[Attachment](e.Match())
}
...
func (e *AttachmentEntity) Stream(action string, args map[string]any, callopts map[string]any) <-chan any {
	out := make(chan any)
...
func (e *AttachmentEntity) Load(reqmatch map[string]any, ctrl map[string]any) (any, error) {
	utility := e.utility
...
// AttachmentLoadMatch and returns an Attachment. It delegates to the untyped
// Load (identical runtime) and converts at the typed boundary.
func (e *AttachmentEntity) LoadTyped(reqmatch AttachmentLoadMatch, ctrl map[string]any) (Attachment, error) {
	res, err := e.Load(asMap(reqmatch), ctrl)
	if err != nil {
		return Attachment{}, err
	}
	return typedFrom[Attachment](res), nil
}




func (e *AttachmentEntity) List(reqmatch map[string]any, ctrl map[string]any) (any, error) {
	utility := e.utility
	ctx := utility.MakeContext(map[string]any{
		"opname":   "list",
		"ctrl":     ctrl,
...
// AttachmentListMatch and returns []Attachment. It delegates to the untyped
// List (identical runtime) and converts at the typed boundary.
func (e *AttachmentEntity) ListTyped(reqmatch AttachmentListMatch, ctrl map[string]any) ([]Attachment, error) {
	res, err := e.List(asMap(reqmatch), ctrl)
	if err != nil {
		return nil, err
	}
	return typedSliceFrom[Attachment](res), nil
}



func (e *AttachmentEntity) Create(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("create", e.name)
}


func (e *AttachmentEntity) Update(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("update", e.name)
}



func (e *AttachmentEntity) Remove(reqmatch map[string]any, ctrl map[string]any) (any, error) {
	utility := e.utility
	ctx := utility.MakeContext(map[string]any{
		"opname":   "remove",
		"ctrl":     ctrl,
...
// AttachmentRemoveMatch and returns an Attachment. It delegates to the untyped
// Remove (identical runtime) and converts at the typed boundary.
func (e *AttachmentEntity) RemoveTyped(reqmatch AttachmentRemoveMatch, ctrl map[string]any) (Attachment, error) {
...
func (e *AttachmentEntity) runOp(ctx *core.Context, postDone func()) (any, error) {
	utility := e.utility
