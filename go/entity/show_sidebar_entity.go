...
func NewShowSidebarEntity(client *core.TrelloSDK, entopts map[string]any) *ShowSidebarEntity {
	if entopts == nil {
		entopts = map[string]any{}
	}
...
func (e *ShowSidebarEntity) GetName() string { return e.name }
...
func (e *ShowSidebarEntity) MarkDeleted() {
	e.deleted = true
}


// Deleted reports whether a successful Remove has resolved on this instance.
func (e *ShowSidebarEntity) Deleted() bool {
	return e.deleted
}


func (e *ShowSidebarEntity) Make() core.Entity {
	opts := map[string]any{}
	for k, v := range e.entopts {
		opts[k] = v
	}
	return NewShowSidebarEntity(e.client, opts)
}

func (e *ShowSidebarEntity) Data(args ...any) any {
...
func (e *ShowSidebarEntity) Match(args ...any) any {
	if len(args) > 0 && args[0] != nil {
...
// argument it returns the current data as an ShowSidebar; with an argument it
// sets the data and returns the stored value. It delegates to the untyped Data
// (identical runtime) and converts at the typed boundary.
func (e *ShowSidebarEntity) DataTyped(data ...ShowSidebar) ShowSidebar {
	if len(data) > 0 {
		return typedFrom[ShowSidebar](e.Data(asMap(data[0])))
	}
	return typedFrom[ShowSidebar](e.Data())
}

// MatchTyped mirrors DataTyped for the entity's match filter. The match is a
// partial of the entity, so it round-trips through ShowSidebar (all fields
// optional at the wire level).
func (e *ShowSidebarEntity) MatchTyped(match ...ShowSidebar) ShowSidebar {
	if len(match) > 0 {
		return typedFrom[ShowSidebar](e.Match(asMap(match[0])))
	}
	return typedFrom[ShowSidebar](e.Match())
}
...
func (e *ShowSidebarEntity) Stream(action string, args map[string]any, callopts map[string]any) <-chan any {
	out := make(chan any)
...
func (e *ShowSidebarEntity) Load(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("load", e.name)
}


func (e *ShowSidebarEntity) List(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("list", e.name)
}


func (e *ShowSidebarEntity) Create(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("create", e.name)
}



func (e *ShowSidebarEntity) Update(reqdata map[string]any, ctrl map[string]any) (any, error) {
	utility := e.utility
...
// ShowSidebarUpdateData and returns an ShowSidebar. It delegates to the untyped
// Update (identical runtime) and converts at the typed boundary.
func (e *ShowSidebarEntity) UpdateTyped(reqdata ShowSidebarUpdateData, ctrl map[string]any) (ShowSidebar, error) {
	res, err := e.Update(asMap(reqdata), ctrl)
	if err != nil {
		return ShowSidebar{}, err
	}
	return typedFrom[ShowSidebar](res), nil
}



func (e *ShowSidebarEntity) Remove(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("remove", e.name)
}


func (e *ShowSidebarEntity) runOp(ctx *core.Context, postDone func()) (any, error) {
	utility := e.utility
