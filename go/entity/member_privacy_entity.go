...
type MemberPrivacyEntity struct {
	name    string
...
func NewMemberPrivacyEntity(client *core.TrelloSDK, entopts map[string]any) *MemberPrivacyEntity {
	if entopts == nil {
		entopts = map[string]any{}
	}
...
func (e *MemberPrivacyEntity) GetName() string { return e.name }
...
func (e *MemberPrivacyEntity) MarkDeleted() {
	e.deleted = true
}


// Deleted reports whether a successful Remove has resolved on this instance.
func (e *MemberPrivacyEntity) Deleted() bool {
	return e.deleted
}


func (e *MemberPrivacyEntity) Make() core.Entity {
	opts := map[string]any{}
	for k, v := range e.entopts {
		opts[k] = v
	}
	return NewMemberPrivacyEntity(e.client, opts)
}

func (e *MemberPrivacyEntity) Data(args ...any) any {
...
func (e *MemberPrivacyEntity) Match(args ...any) any {
	if len(args) > 0 && args[0] != nil {
...
// argument it returns the current data as an MemberPrivacy; with an argument it
// sets the data and returns the stored value. It delegates to the untyped Data
// (identical runtime) and converts at the typed boundary.
func (e *MemberPrivacyEntity) DataTyped(data ...MemberPrivacy) MemberPrivacy {
	if len(data) > 0 {
		return typedFrom[MemberPrivacy](e.Data(asMap(data[0])))
	}
	return typedFrom[MemberPrivacy](e.Data())
}

// MatchTyped mirrors DataTyped for the entity's match filter. The match is a
// partial of the entity, so it round-trips through MemberPrivacy (all fields
// optional at the wire level).
func (e *MemberPrivacyEntity) MatchTyped(match ...MemberPrivacy) MemberPrivacy {
	if len(match) > 0 {
		return typedFrom[MemberPrivacy](e.Match(asMap(match[0])))
	}
	return typedFrom[MemberPrivacy](e.Match())
}
...
func (e *MemberPrivacyEntity) Stream(action string, args map[string]any, callopts map[string]any) <-chan any {
	out := make(chan any)
...
func (e *MemberPrivacyEntity) Load(reqmatch map[string]any, ctrl map[string]any) (any, error) {
	utility := e.utility
...
// MemberPrivacyLoadMatch and returns an MemberPrivacy. It delegates to the untyped
// Load (identical runtime) and converts at the typed boundary.
func (e *MemberPrivacyEntity) LoadTyped(reqmatch MemberPrivacyLoadMatch, ctrl map[string]any) (MemberPrivacy, error) {
	res, err := e.Load(asMap(reqmatch), ctrl)
	if err != nil {
		return MemberPrivacy{}, err
	}
	return typedFrom[MemberPrivacy](res), nil
}



func (e *MemberPrivacyEntity) List(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("list", e.name)
}


func (e *MemberPrivacyEntity) Create(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("create", e.name)
}


func (e *MemberPrivacyEntity) Update(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("update", e.name)
}


func (e *MemberPrivacyEntity) Remove(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("remove", e.name)
}


func (e *MemberPrivacyEntity) runOp(ctx *core.Context, postDone func()) (any, error) {
	utility := e.utility
