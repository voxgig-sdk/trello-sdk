...
func NewChecklistEntity(client *core.TrelloSDK, entopts map[string]any) *ChecklistEntity {
	if entopts == nil {
		entopts = map[string]any{}
	}
...
func (e *ChecklistEntity) GetName() string { return e.name }
...
func (e *ChecklistEntity) MarkDeleted() {
	e.deleted = true
}


// Deleted reports whether a successful Remove has resolved on this instance.
func (e *ChecklistEntity) Deleted() bool {
	return e.deleted
}


func (e *ChecklistEntity) Make() core.Entity {
	opts := map[string]any{}
	for k, v := range e.entopts {
		opts[k] = v
	}
	return NewChecklistEntity(e.client, opts)
}

func (e *ChecklistEntity) Data(args ...any) any {
...
func (e *ChecklistEntity) Match(args ...any) any {
	if len(args) > 0 && args[0] != nil {
...
// argument it returns the current data as an Checklist; with an argument it
// sets the data and returns the stored value. It delegates to the untyped Data
// (identical runtime) and converts at the typed boundary.
func (e *ChecklistEntity) DataTyped(data ...Checklist) Checklist {
	if len(data) > 0 {
		return typedFrom[Checklist](e.Data(asMap(data[0])))
	}
	return typedFrom[Checklist](e.Data())
}

// MatchTyped mirrors DataTyped for the entity's match filter. The match is a
// partial of the entity, so it round-trips through Checklist (all fields
// optional at the wire level).
func (e *ChecklistEntity) MatchTyped(match ...Checklist) Checklist {
	if len(match) > 0 {
		return typedFrom[Checklist](e.Match(asMap(match[0])))
	}
	return typedFrom[Checklist](e.Match())
}
...
func (e *ChecklistEntity) Stream(action string, args map[string]any, callopts map[string]any) <-chan any {
	out := make(chan any)
...
func (e *ChecklistEntity) Load(reqmatch map[string]any, ctrl map[string]any) (any, error) {
	utility := e.utility
...
// ChecklistLoadMatch and returns an Checklist. It delegates to the untyped
// Load (identical runtime) and converts at the typed boundary.
func (e *ChecklistEntity) LoadTyped(reqmatch ChecklistLoadMatch, ctrl map[string]any) (Checklist, error) {
	res, err := e.Load(asMap(reqmatch), ctrl)
	if err != nil {
		return Checklist{}, err
	}
	return typedFrom[Checklist](res), nil
}



func (e *ChecklistEntity) List(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("list", e.name)
}



func (e *ChecklistEntity) Create(reqdata map[string]any, ctrl map[string]any) (any, error) {
	utility := e.utility
	ctx := utility.MakeContext(map[string]any{
		"opname":  "create",
		"ctrl":    ctrl,
...
// ChecklistCreateData and returns an Checklist. It delegates to the untyped
// Create (identical runtime) and converts at the typed boundary.
func (e *ChecklistEntity) CreateTyped(reqdata ChecklistCreateData, ctrl map[string]any) (Checklist, error) {
...
func (e *ChecklistEntity) Update(reqdata map[string]any, ctrl map[string]any) (any, error) {
	utility := e.utility
	ctx := utility.MakeContext(map[string]any{
		"opname":  "update",
		"ctrl":    ctrl,
...
// ChecklistUpdateData and returns an Checklist. It delegates to the untyped
// Update (identical runtime) and converts at the typed boundary.
func (e *ChecklistEntity) UpdateTyped(reqdata ChecklistUpdateData, ctrl map[string]any) (Checklist, error) {
...
func (e *ChecklistEntity) Remove(reqmatch map[string]any, ctrl map[string]any) (any, error) {
	utility := e.utility
	ctx := utility.MakeContext(map[string]any{
		"opname":   "remove",
		"ctrl":     ctrl,
...
// ChecklistRemoveMatch and returns an Checklist. It delegates to the untyped
// Remove (identical runtime) and converts at the typed boundary.
func (e *ChecklistEntity) RemoveTyped(reqmatch ChecklistRemoveMatch, ctrl map[string]any) (Checklist, error) {
...
func (e *ChecklistEntity) runOp(ctx *core.Context, postDone func()) (any, error) {
	utility := e.utility
