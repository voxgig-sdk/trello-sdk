...
func NewListEntity(client *core.TrelloSDK, entopts map[string]any) *ListEntity {
	if entopts == nil {
		entopts = map[string]any{}
	}
...
func (e *ListEntity) List(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("list", e.name)
}



func (e *ListEntity) Create(reqdata map[string]any, ctrl map[string]any) (any, error) {
	utility := e.utility
	ctx := utility.MakeContext(map[string]any{
		"opname":  "create",
		"ctrl":    ctrl,
...
// ListCreateData and returns an List. It delegates to the untyped
// Create (identical runtime) and converts at the typed boundary.
func (e *ListEntity) CreateTyped(reqdata ListCreateData, ctrl map[string]any) (List, error) {
...
func (e *ListEntity) Update(reqdata map[string]any, ctrl map[string]any) (any, error) {
	utility := e.utility
	ctx := utility.MakeContext(map[string]any{
		"opname":  "update",
		"ctrl":    ctrl,
...
// ListUpdateData and returns an List. It delegates to the untyped
// Update (identical runtime) and converts at the typed boundary.
func (e *ListEntity) UpdateTyped(reqdata ListUpdateData, ctrl map[string]any) (List, error) {
