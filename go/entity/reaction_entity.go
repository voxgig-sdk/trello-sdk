...
func NewReactionEntity(client *core.TrelloSDK, entopts map[string]any) *ReactionEntity {
	if entopts == nil {
		entopts = map[string]any{}
	}
...
func (e *ReactionEntity) List(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("list", e.name)
}


func (e *ReactionEntity) Create(_ map[string]any, _ map[string]any) (any, error) {
