...
type EnterpriseAdminEntity struct {
	name    string
...
func NewEnterpriseAdminEntity(client *core.TrelloSDK, entopts map[string]any) *EnterpriseAdminEntity {
	if entopts == nil {
		entopts = map[string]any{}
	}
...
func (e *EnterpriseAdminEntity) GetName() string { return e.name }
...
func (e *EnterpriseAdminEntity) MarkDeleted() {
	e.deleted = true
}


// Deleted reports whether a successful Remove has resolved on this instance.
func (e *EnterpriseAdminEntity) Deleted() bool {
	return e.deleted
}


func (e *EnterpriseAdminEntity) Make() core.Entity {
	opts := map[string]any{}
	for k, v := range e.entopts {
		opts[k] = v
	}
	return NewEnterpriseAdminEntity(e.client, opts)
}

func (e *EnterpriseAdminEntity) Data(args ...any) any {
...
func (e *EnterpriseAdminEntity) Match(args ...any) any {
	if len(args) > 0 && args[0] != nil {
...
// argument it returns the current data as an EnterpriseAdmin; with an argument it
// sets the data and returns the stored value. It delegates to the untyped Data
// (identical runtime) and converts at the typed boundary.
func (e *EnterpriseAdminEntity) DataTyped(data ...EnterpriseAdmin) EnterpriseAdmin {
	if len(data) > 0 {
		return typedFrom[EnterpriseAdmin](e.Data(asMap(data[0])))
	}
	return typedFrom[EnterpriseAdmin](e.Data())
}

// MatchTyped mirrors DataTyped for the entity's match filter. The match is a
// partial of the entity, so it round-trips through EnterpriseAdmin (all fields
// optional at the wire level).
func (e *EnterpriseAdminEntity) MatchTyped(match ...EnterpriseAdmin) EnterpriseAdmin {
	if len(match) > 0 {
		return typedFrom[EnterpriseAdmin](e.Match(asMap(match[0])))
	}
	return typedFrom[EnterpriseAdmin](e.Match())
}
...
func (e *EnterpriseAdminEntity) Stream(action string, args map[string]any, callopts map[string]any) <-chan any {
	out := make(chan any)
...
func (e *EnterpriseAdminEntity) Load(reqmatch map[string]any, ctrl map[string]any) (any, error) {
	utility := e.utility
...
// EnterpriseAdminLoadMatch and returns an EnterpriseAdmin. It delegates to the untyped
// Load (identical runtime) and converts at the typed boundary.
func (e *EnterpriseAdminEntity) LoadTyped(reqmatch EnterpriseAdminLoadMatch, ctrl map[string]any) (EnterpriseAdmin, error) {
	res, err := e.Load(asMap(reqmatch), ctrl)
	if err != nil {
		return EnterpriseAdmin{}, err
	}
	return typedFrom[EnterpriseAdmin](res), nil
}



func (e *EnterpriseAdminEntity) List(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("list", e.name)
}


func (e *EnterpriseAdminEntity) Create(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("create", e.name)
}


func (e *EnterpriseAdminEntity) Update(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("update", e.name)
}


func (e *EnterpriseAdminEntity) Remove(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("remove", e.name)
}


func (e *EnterpriseAdminEntity) runOp(ctx *core.Context, postDone func()) (any, error) {
	utility := e.utility
