...
type OrgInviteRestrictEntity struct {
	name    string
...
func NewOrgInviteRestrictEntity(client *core.TrelloSDK, entopts map[string]any) *OrgInviteRestrictEntity {
	if entopts == nil {
		entopts = map[string]any{}
	}
...
func (e *OrgInviteRestrictEntity) GetName() string { return e.name }
...
func (e *OrgInviteRestrictEntity) MarkDeleted() {
	e.deleted = true
}


// Deleted reports whether a successful Remove has resolved on this instance.
func (e *OrgInviteRestrictEntity) Deleted() bool {
	return e.deleted
}


func (e *OrgInviteRestrictEntity) Make() core.Entity {
	opts := map[string]any{}
	for k, v := range e.entopts {
		opts[k] = v
	}
	return NewOrgInviteRestrictEntity(e.client, opts)
}

func (e *OrgInviteRestrictEntity) Data(args ...any) any {
...
func (e *OrgInviteRestrictEntity) Match(args ...any) any {
	if len(args) > 0 && args[0] != nil {
...
// argument it returns the current data as an OrgInviteRestrict; with an argument it
// sets the data and returns the stored value. It delegates to the untyped Data
// (identical runtime) and converts at the typed boundary.
func (e *OrgInviteRestrictEntity) DataTyped(data ...OrgInviteRestrict) OrgInviteRestrict {
	if len(data) > 0 {
		return typedFrom[OrgInviteRestrict](e.Data(asMap(data[0])))
	}
	return typedFrom[OrgInviteRestrict](e.Data())
}

// MatchTyped mirrors DataTyped for the entity's match filter. The match is a
// partial of the entity, so it round-trips through OrgInviteRestrict (all fields
// optional at the wire level).
func (e *OrgInviteRestrictEntity) MatchTyped(match ...OrgInviteRestrict) OrgInviteRestrict {
	if len(match) > 0 {
		return typedFrom[OrgInviteRestrict](e.Match(asMap(match[0])))
	}
	return typedFrom[OrgInviteRestrict](e.Match())
}
...
func (e *OrgInviteRestrictEntity) Stream(action string, args map[string]any, callopts map[string]any) <-chan any {
	out := make(chan any)
...
func (e *OrgInviteRestrictEntity) Load(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("load", e.name)
}


func (e *OrgInviteRestrictEntity) List(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("list", e.name)
}


func (e *OrgInviteRestrictEntity) Create(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("create", e.name)
}


func (e *OrgInviteRestrictEntity) Update(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("update", e.name)
}



func (e *OrgInviteRestrictEntity) Remove(reqmatch map[string]any, ctrl map[string]any) (any, error) {
	utility := e.utility
...
// OrgInviteRestrictRemoveMatch and returns an OrgInviteRestrict. It delegates to the untyped
// Remove (identical runtime) and converts at the typed boundary.
func (e *OrgInviteRestrictEntity) RemoveTyped(reqmatch OrgInviteRestrictRemoveMatch, ctrl map[string]any) (OrgInviteRestrict, error) {
	res, err := e.Remove(asMap(reqmatch), ctrl)
	if err != nil {
		return OrgInviteRestrict{}, err
	}
	return typedFrom[OrgInviteRestrict](res), nil
}



func (e *OrgInviteRestrictEntity) runOp(ctx *core.Context, postDone func()) (any, error) {
	utility := e.utility
