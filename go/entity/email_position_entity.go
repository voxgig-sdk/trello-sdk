...
type EmailPositionEntity struct {
	name    string
...
func NewEmailPositionEntity(client *core.TrelloSDK, entopts map[string]any) *EmailPositionEntity {
	if entopts == nil {
		entopts = map[string]any{}
	}
...
func (e *EmailPositionEntity) GetName() string { return e.name }
...
func (e *EmailPositionEntity) MarkDeleted() {
	e.deleted = true
}


// Deleted reports whether a successful Remove has resolved on this instance.
func (e *EmailPositionEntity) Deleted() bool {
	return e.deleted
}


func (e *EmailPositionEntity) Make() core.Entity {
	opts := map[string]any{}
	for k, v := range e.entopts {
		opts[k] = v
	}
	return NewEmailPositionEntity(e.client, opts)
}

func (e *EmailPositionEntity) Data(args ...any) any {
...
func (e *EmailPositionEntity) Match(args ...any) any {
	if len(args) > 0 && args[0] != nil {
...
// argument it returns the current data as an EmailPosition; with an argument it
// sets the data and returns the stored value. It delegates to the untyped Data
// (identical runtime) and converts at the typed boundary.
func (e *EmailPositionEntity) DataTyped(data ...EmailPosition) EmailPosition {
	if len(data) > 0 {
		return typedFrom[EmailPosition](e.Data(asMap(data[0])))
	}
	return typedFrom[EmailPosition](e.Data())
}

// MatchTyped mirrors DataTyped for the entity's match filter. The match is a
// partial of the entity, so it round-trips through EmailPosition (all fields
// optional at the wire level).
func (e *EmailPositionEntity) MatchTyped(match ...EmailPosition) EmailPosition {
	if len(match) > 0 {
		return typedFrom[EmailPosition](e.Match(asMap(match[0])))
	}
	return typedFrom[EmailPosition](e.Match())
}
...
func (e *EmailPositionEntity) Stream(action string, args map[string]any, callopts map[string]any) <-chan any {
	out := make(chan any)
...
func (e *EmailPositionEntity) Load(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("load", e.name)
}


func (e *EmailPositionEntity) List(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("list", e.name)
}


func (e *EmailPositionEntity) Create(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("create", e.name)
}



func (e *EmailPositionEntity) Update(reqdata map[string]any, ctrl map[string]any) (any, error) {
	utility := e.utility
...
// EmailPositionUpdateData and returns an EmailPosition. It delegates to the untyped
// Update (identical runtime) and converts at the typed boundary.
func (e *EmailPositionEntity) UpdateTyped(reqdata EmailPositionUpdateData, ctrl map[string]any) (EmailPosition, error) {
	res, err := e.Update(asMap(reqdata), ctrl)
	if err != nil {
		return EmailPosition{}, err
	}
	return typedFrom[EmailPosition](res), nil
}



func (e *EmailPositionEntity) Remove(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("remove", e.name)
}


func (e *EmailPositionEntity) runOp(ctx *core.Context, postDone func()) (any, error) {
	utility := e.utility
