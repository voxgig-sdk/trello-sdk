...
type CustomFieldItemEntity struct {
	name    string
...
func NewCustomFieldItemEntity(client *core.TrelloSDK, entopts map[string]any) *CustomFieldItemEntity {
	if entopts == nil {
		entopts = map[string]any{}
	}
...
func (e *CustomFieldItemEntity) GetName() string { return e.name }
...
func (e *CustomFieldItemEntity) MarkDeleted() {
	e.deleted = true
}


// Deleted reports whether a successful Remove has resolved on this instance.
func (e *CustomFieldItemEntity) Deleted() bool {
	return e.deleted
}


func (e *CustomFieldItemEntity) Make() core.Entity {
	opts := map[string]any{}
	for k, v := range e.entopts {
		opts[k] = v
	}
	return NewCustomFieldItemEntity(e.client, opts)
}

func (e *CustomFieldItemEntity) Data(args ...any) any {
...
func (e *CustomFieldItemEntity) Match(args ...any) any {
	if len(args) > 0 && args[0] != nil {
...
// argument it returns the current data as an CustomFieldItem; with an argument it
// sets the data and returns the stored value. It delegates to the untyped Data
// (identical runtime) and converts at the typed boundary.
func (e *CustomFieldItemEntity) DataTyped(data ...CustomFieldItem) CustomFieldItem {
	if len(data) > 0 {
		return typedFrom[CustomFieldItem](e.Data(asMap(data[0])))
	}
	return typedFrom[CustomFieldItem](e.Data())
}

// MatchTyped mirrors DataTyped for the entity's match filter. The match is a
// partial of the entity, so it round-trips through CustomFieldItem (all fields
// optional at the wire level).
func (e *CustomFieldItemEntity) MatchTyped(match ...CustomFieldItem) CustomFieldItem {
	if len(match) > 0 {
		return typedFrom[CustomFieldItem](e.Match(asMap(match[0])))
	}
	return typedFrom[CustomFieldItem](e.Match())
}
...
func (e *CustomFieldItemEntity) Stream(action string, args map[string]any, callopts map[string]any) <-chan any {
	out := make(chan any)
...
func (e *CustomFieldItemEntity) Load(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("load", e.name)
}



func (e *CustomFieldItemEntity) List(reqmatch map[string]any, ctrl map[string]any) (any, error) {
	utility := e.utility
...
// CustomFieldItemListMatch and returns []CustomFieldItem. It delegates to the untyped
// List (identical runtime) and converts at the typed boundary.
func (e *CustomFieldItemEntity) ListTyped(reqmatch CustomFieldItemListMatch, ctrl map[string]any) ([]CustomFieldItem, error) {
	res, err := e.List(asMap(reqmatch), ctrl)
	if err != nil {
		return nil, err
	}
	return typedSliceFrom[CustomFieldItem](res), nil
}



func (e *CustomFieldItemEntity) Create(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("create", e.name)
}


func (e *CustomFieldItemEntity) Update(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("update", e.name)
}


func (e *CustomFieldItemEntity) Remove(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("remove", e.name)
}


func (e *CustomFieldItemEntity) runOp(ctx *core.Context, postDone func()) (any, error) {
	utility := e.utility
