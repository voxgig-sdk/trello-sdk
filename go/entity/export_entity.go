...
func NewExportEntity(client *core.TrelloSDK, entopts map[string]any) *ExportEntity {
	if entopts == nil {
		entopts = map[string]any{}
	}
...
func (e *ExportEntity) Remove(reqmatch map[string]any, ctrl map[string]any) (any, error) {
	utility := e.utility
	ctx := utility.MakeContext(map[string]any{
		"opname":   "remove",
		"ctrl":     ctrl,
...
// ExportRemoveMatch and returns an Export. It delegates to the untyped
// Remove (identical runtime) and converts at the typed boundary.
func (e *ExportEntity) RemoveTyped(reqmatch ExportRemoveMatch, ctrl map[string]any) (Export, error) {
