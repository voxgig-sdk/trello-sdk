...
type NotificationsChannelSettingEntity struct {
	name    string
...
func NewNotificationsChannelSettingEntity(client *core.TrelloSDK, entopts map[string]any) *NotificationsChannelSettingEntity {
	if entopts == nil {
		entopts = map[string]any{}
	}
	...
	e := &NotificationsChannelSettingEntity{
...
func (e *NotificationsChannelSettingEntity) GetName() string { return e.name }
...
func (e *NotificationsChannelSettingEntity) MarkDeleted() {
	e.deleted = true
}


// Deleted reports whether a successful Remove has resolved on this instance.
func (e *NotificationsChannelSettingEntity) Deleted() bool {
	return e.deleted
}


func (e *NotificationsChannelSettingEntity) Make() core.Entity {
	opts := map[string]any{}
	for k, v := range e.entopts {
		opts[k] = v
	}
	return NewNotificationsChannelSettingEntity(e.client, opts)
}

func (e *NotificationsChannelSettingEntity) Data(args ...any) any {
...
func (e *NotificationsChannelSettingEntity) Match(args ...any) any {
	if len(args) > 0 && args[0] != nil {
...
// argument it returns the current data as an NotificationsChannelSetting; with an argument it
// sets the data and returns the stored value. It delegates to the untyped Data
// (identical runtime) and converts at the typed boundary.
func (e *NotificationsChannelSettingEntity) DataTyped(data ...NotificationsChannelSetting) NotificationsChannelSetting {
	if len(data) > 0 {
		return typedFrom[NotificationsChannelSetting](e.Data(asMap(data[0])))
	}
	return typedFrom[NotificationsChannelSetting](e.Data())
}

// MatchTyped mirrors DataTyped for the entity's match filter. The match is a
// partial of the entity, so it round-trips through NotificationsChannelSetting (all fields
// optional at the wire level).
func (e *NotificationsChannelSettingEntity) MatchTyped(match ...NotificationsChannelSetting) NotificationsChannelSetting {
	if len(match) > 0 {
		return typedFrom[NotificationsChannelSetting](e.Match(asMap(match[0])))
	}
	return typedFrom[NotificationsChannelSetting](e.Match())
}
...
func (e *NotificationsChannelSettingEntity) Stream(action string, args map[string]any, callopts map[string]any) <-chan any {
	out := make(chan any)
...
func (e *NotificationsChannelSettingEntity) Load(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("load", e.name)
}


func (e *NotificationsChannelSettingEntity) List(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("list", e.name)
}


func (e *NotificationsChannelSettingEntity) Create(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("create", e.name)
}


func (e *NotificationsChannelSettingEntity) Update(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("update", e.name)
}


func (e *NotificationsChannelSettingEntity) Remove(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("remove", e.name)
}


func (e *NotificationsChannelSettingEntity) runOp(ctx *core.Context, postDone func()) (any, error) {
	utility := e.utility
