...
const testSeed = `map[string]any{"entity": map[string]any{"action": map[string]any{"example_id": map[string]any{"id": "example_id"}}, "action_reactions_summary": map[string]any{"example_id": map[string]any{"id": "example_id"}}, "admin": map[string]any{"example_id": map[string]any{"id": "example_id"}}, "application": map[string]any{"example_id": map[string]any{"id": "example_id"}}, "application_compliance": map[string]any{"example_id": map[string]any{"id": "example_id"}}, "associated_domain": map[string]any{"example_id": map[string]any{"id": "example_id"}}, "attachment": map[string]any{"example_id": map[string]any{"id": "example_id"}}, "batch": map[string]any{"example_id": map[string]any{"id": "example_id"}}, "board": map[string]any{"example_id": map[string]any{"id": "example_id"}}, "board_background": map[string]any{"example_id": map[string]any{"id": "example_id"}}, "board_plugin": map[string]any{"example_id": map[string]any{"id": "example_id"}}, "board_star": map[string]any{"example_id": map[string]any{"id": "example_id"}}, "bulk": map[string]any{"example_id": map[string]any{"id": "example_id"}}, "card": map[string]any{"example_id": map[string]any{"id": "example_id"}}, "card_check_item_state": map[string]any{"example_id": map[string]any{"id": "example_id"}}, "card_list": map[string]any{"example_id": map[string]any{"id": "example_id"}}, "check_item": map[string]any{"example_id": map[string]any{"id": "example_id"}}, "checklist": map[string]any{"example_id": map[string]any{"id": "example_id"}}, "claimable_organization": map[string]any{"example_id": map[string]any{"id": "example_id"}}, "custom_board_background": map[string]any{"example_id": map[string]any{"id": "example_id"}}, "custom_emoji": map[string]any{"example_id": map[string]any{"id": "example_id"}}, "custom_field": map[string]any{"example_id": map[string]any{"id": "example_id"}}, "custom_field_item": map[string]any{"example_id": map[string]any{"id": "example_id"}}, "custom_sticker": map[string]any{"example_id": map[string]any{"id": "example_id"}}, "email_position": map[string]any{"example_id": map[string]any{"id": "example_id"}}, "emoji": map[string]any{"example_id": map[string]any{"id": "example_id"}}, "enterpris": map[string]any{"example_id": map[string]any{"id": "example_id"}}, "enterpris_signup_url": map[string]any{"example_id": map[string]any{"id": "example_id"}}, "enterprise_admin": map[string]any{"example_id": map[string]any{"id": "example_id"}}, "enterprise_audit_log": map[string]any{"example_id": map[string]any{"id": "example_id"}}, "export": map[string]any{"example_id": map[string]any{"id": "example_id"}}, "export_download": map[string]any{"example_id": map[string]any{"id": "example_id"}}, "generate": map[string]any{"example_id": map[string]any{"id": "example_id"}}, "id_email_list": map[string]any{"example_id": map[string]any{"id": "example_id"}}, "id_label": map[string]any{"example_id": map[string]any{"id": "example_id"}}, "id_member": map[string]any{"example_id": map[string]any{"id": "example_id"}}, "label": map[string]any{"example_id": map[string]any{"id": "example_id"}}, "list": map[string]any{"example_id": map[string]any{"id": "example_id"}}, "member": map[string]any{"example_id": map[string]any{"id": "example_id"}}, "member_privacy": map[string]any{"example_id": map[string]any{"id": "example_id"}}, "members_voted": map[string]any{"example_id": map[string]any{"id": "example_id"}}, "membership": map[string]any{"example_id": map[string]any{"id": "example_id"}}, "most_recent": map[string]any{"example_id": map[string]any{"id": "example_id"}}, "new_billable_guest": map[string]any{"example_id": map[string]any{"id": "example_id"}}, "notification": map[string]any{"example_id": map[string]any{"id": "example_id"}}, "notification_channel_setting": map[string]any{"example_id": map[string]any{"id": "example_id"}}, "notification_list": map[string]any{"example_id": map[string]any{"id": "example_id"}}, "notification_member_creator": map[string]any{"example_id": map[string]any{"id": "example_id"}}, "notifications_channel_setting": map[string]any{"example_id": map[string]any{"id": "example_id"}}, "option": map[string]any{"example_id": map[string]any{"id": "example_id"}}, "org_invite_restrict": map[string]any{"example_id": map[string]any{"id": "example_id"}}, "organization": map[string]any{"example_id": map[string]any{"id": "example_id"}}, "pending_organization": map[string]any{"example_id": map[string]any{"id": "example_id"}}, "plugin": map[string]any{"example_id": map[string]any{"id": "example_id"}}, "plugin_data": map[string]any{"example_id": map[string]any{"id": "example_id"}}, "plugin_listing": map[string]any{"example_id": map[string]any{"id": "example_id"}}, "reaction": map[string]any{"example_id": map[string]any{"id": "example_id"}}, "read": map[string]any{"example_id": map[string]any{"id": "example_id"}}, "saved_search": map[string]any{"example_id": map[string]any{"id": "example_id"}}, "search": map[string]any{"example_id": map[string]any{"id": "example_id"}}, "show_sidebar": map[string]any{"example_id": map[string]any{"id": "example_id"}}, "show_sidebar_activity": map[string]any{"example_id": map[string]any{"id": "example_id"}}, "show_sidebar_board_action": map[string]any{"example_id": map[string]any{"id": "example_id"}}, "show_sidebar_member": map[string]any{"example_id": map[string]any{"id": "example_id"}}, "sticker": map[string]any{"example_id": map[string]any{"id": "example_id"}}, "tag": map[string]any{"example_id": map[string]any{"id": "example_id"}}, "token": map[string]any{"example_id": map[string]any{"id": "example_id"}}, "transferrable_organization": map[string]any{"example_id": map[string]any{"id": "example_id"}}, "trello_list": map[string]any{"example_id": map[string]any{"id": "example_id"}}, "webhook": map[string]any{"example_id": map[string]any{"id": "example_id"}}}}`
