...
describe('CardCheckItemStateDirect', async () => {
  ...
  test('direct-load-card_check_item_state', async (t: any) => {
    const setup = directSetup({ id: 'direct01' })
    if (maybeSkipControl(t, 'direct', 'direct-load-card_check_item_state', setup.live)) return
...
function directSetup(mockres?: any) {
  ...
  if (live) {
    ...
    let idmap: any = env['TRELLO_TEST_CARD_CHECK_ITEM_STATE_ENTID']
