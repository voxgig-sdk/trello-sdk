...
describe('PendingOrganizationDirect', async () => {
  ...
  test('direct-list-pending_organization', async (t: any) => {
    const setup = directSetup([{ id: 'direct01' }, { id: 'direct02' }])
    if (maybeSkipControl(t, 'direct', 'direct-list-pending_organization', setup.live)) return
...
function directSetup(mockres?: any) {
  ...
  if (live) {
    ...
    let idmap: any = env['TRELLO_TEST_PENDING_ORGANIZATION_ENTID']
