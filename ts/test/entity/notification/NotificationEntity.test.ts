...
describe('NotificationEntity', async () => {
  ...
  test('basic', async (t) => {
    ...
    // UPDATE
    const notification_ref01_data_up0: any = {}
    ...
    ;(notification_ref01_data_up0 as any)[notification_ref01_markdef_up0.name] = notification_ref01_markdef_up0.value
    ...
    assert((notification_ref01_resdata_up0 as any)[notification_ref01_markdef_up0.name] === notification_ref01_markdef_up0.value)


    // LOAD
    const notification_ref01_match_dt0: any = {}
