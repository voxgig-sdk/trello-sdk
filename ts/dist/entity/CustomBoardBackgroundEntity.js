...
exports.CustomBoardBackgroundEntity = void 0;
const TrelloEntityBase_1 = require("../TrelloEntityBase");
// TODO: needs Entity superclass
class CustomBoardBackgroundEntity extends TrelloEntityBase_1.TrelloEntityBase {
    constructor(client, entopts) {
        super(client, entopts);
        this.name = 'custom_board_background';
        this.name_ = 'custom_board_background';
        this.Name = 'CustomBoardBackground';
    }
    make() {
        return new CustomBoardBackgroundEntity(this._client, this.entopts());
    }
    ...
    async remove(reqmatch, ctrl) {
        ...
        try {
            ...
            if (err) {
                ...
                // Promise<CustomBoardBackgroundEntity> return stays clean under strict null checks.
                return undefined;
            }
        }
    }
}
exports.CustomBoardBackgroundEntity = CustomBoardBackgroundEntity;
//# sourceMappingURL=CustomBoardBackgroundEntity.js.map