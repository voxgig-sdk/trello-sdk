...
exports.IdMemberEntity = void 0;
const TrelloEntityBase_1 = require("../TrelloEntityBase");
// TODO: needs Entity superclass
class IdMemberEntity extends TrelloEntityBase_1.TrelloEntityBase {
    constructor(client, entopts) {
        super(client, entopts);
        this.name = 'id_member';
        this.name_ = 'id_member';
        this.Name = 'IdMember';
    }
    make() {
        return new IdMemberEntity(this._client, this.entopts());
    }
    ...
    async remove(reqmatch, ctrl) {
        ...
        try {
            ...
            if (err) {
                ...
                // Promise<IdMemberEntity> return stays clean under strict null checks.
                return undefined;
            }
        }
    }
}
exports.IdMemberEntity = IdMemberEntity;
//# sourceMappingURL=IdMemberEntity.js.map