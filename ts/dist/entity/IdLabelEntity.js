...
exports.IdLabelEntity = void 0;
const TrelloEntityBase_1 = require("../TrelloEntityBase");
// TODO: needs Entity superclass
class IdLabelEntity extends TrelloEntityBase_1.TrelloEntityBase {
    ...
    make() {
        return new IdLabelEntity(this._client, this.entopts());
    }
    ...
    async remove(reqmatch, ctrl) {
        ...
        try {
            ...
            if (err) {
                ...
                // Promise<IdLabelEntity> return stays clean under strict null checks.
                return undefined;
            }
        }
    }
}
exports.IdLabelEntity = IdLabelEntity;
//# sourceMappingURL=IdLabelEntity.js.map