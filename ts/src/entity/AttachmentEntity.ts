...
class AttachmentEntity extends TrelloEntityBase<Attachment> {
  ...
  constructor(client: TrelloSDK, entopts: any) {
    ...
    this.name_ = 'attachment'
    this.Name = 'Attachment'
  }


  make(this: AttachmentEntity) {
    return new AttachmentEntity(this._client, this.entopts())
  }



  async load(this: any, reqmatch?: AttachmentLoadMatch, ctrl?: Control): Promise<AttachmentEntity> {
    ...
    try {
      ...
      if (err) {
        ...
        // Promise<Attachment> return stays clean under strict null checks.
  ...
  async list(this: any, reqmatch?: AttachmentListMatch, ctrl?: Control): Promise<AttachmentEntity[]> {
  ...
  async remove(
    ...
    try {
      ...
      if (err) {
        ...
        // Off-happy-path (throw disabled): typed as any so the method's
        // Promise<AttachmentEntity> return stays clean under strict null checks.
        return undefined as any
      }
    }
  }
