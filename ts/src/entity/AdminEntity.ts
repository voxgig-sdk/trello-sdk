...
class AdminEntity extends TrelloEntityBase<Admin> {
  ...
  async remove(
    this: any, reqmatch?: AdminRemoveMatch, ctrl?: Control,
  ): Promise<AdminEntity> {
    ...
    try {
      ...
      if (err) {
        ...
        // Off-happy-path (throw disabled): typed as any so the method's
        // Promise<AdminEntity> return stays clean under strict null checks.
        return undefined as any
      }
    }
  }
