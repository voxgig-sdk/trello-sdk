...
class BoardEntity extends TrelloEntityBase<Board> {
  ...
  async load(this: any, reqmatch?: BoardLoadMatch, ctrl?: Control): Promise<BoardEntity> {
  ...
  async create(this: any, reqdata?: BoardCreateData, ctrl?: Control): Promise<BoardEntity> {
  ...
  async update(this: any, reqdata?: BoardUpdateData, ctrl?: Control): Promise<BoardEntity> {
  ...
  async remove(
    this: any, reqmatch?: BoardRemoveMatch, ctrl?: Control,
  ): Promise<BoardEntity> {
    ...
    try {
      ...
      if (err) {
        ...
        // Off-happy-path (throw disabled): typed as any so the method's
        // Promise<BoardEntity> return stays clean under strict null checks.
        return undefined as any
      }
    }
  }
