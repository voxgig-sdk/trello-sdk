...
import type {
  BoardPlugin,
  BoardPluginRemoveMatch,
} from '../TrelloTypes'

// TODO: needs Entity superclass
class BoardPluginEntity extends TrelloEntityBase<BoardPlugin> {

  constructor(client: TrelloSDK, entopts: any) {
    super(client, entopts)
    this.name = 'board_plugin'
    this.name_ = 'board_plugin'
    this.Name = 'BoardPlugin'
  }


  make(this: BoardPluginEntity) {
    return new BoardPluginEntity(this._client, this.entopts())
  }
  ...
  async remove(
    this: any, reqmatch?: BoardPluginRemoveMatch, ctrl?: Control,
  ): Promise<BoardPluginEntity> {
    ...
    try {
      ...
      if (err) {
        ...
        // Promise<BoardPluginEntity> return stays clean under strict null checks.
