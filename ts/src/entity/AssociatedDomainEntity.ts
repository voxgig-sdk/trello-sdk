...
import type {
  AssociatedDomain,
  AssociatedDomainRemoveMatch,
} from '../TrelloTypes'

// TODO: needs Entity superclass
class AssociatedDomainEntity extends TrelloEntityBase<AssociatedDomain> {

  constructor(client: TrelloSDK, entopts: any) {
    super(client, entopts)
    this.name = 'associated_domain'
    this.name_ = 'associated_domain'
    this.Name = 'AssociatedDomain'
  }


  make(this: AssociatedDomainEntity) {
    return new AssociatedDomainEntity(this._client, this.entopts())
  }
  ...
  async remove(
    this: any, reqmatch?: AssociatedDomainRemoveMatch, ctrl?: Control,
  ): Promise<AssociatedDomainEntity> {
    ...
    try {
      ...
      if (err) {
        ...
        // Promise<AssociatedDomainEntity> return stays clean under strict null checks.
