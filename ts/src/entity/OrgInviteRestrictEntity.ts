...
import type {
  OrgInviteRestrict,
  OrgInviteRestrictRemoveMatch,
} from '../TrelloTypes'

// TODO: needs Entity superclass
class OrgInviteRestrictEntity extends TrelloEntityBase<OrgInviteRestrict> {

  constructor(client: TrelloSDK, entopts: any) {
    super(client, entopts)
    this.name = 'org_invite_restrict'
    this.name_ = 'org_invite_restrict'
    this.Name = 'OrgInviteRestrict'
  }


  make(this: OrgInviteRestrictEntity) {
    return new OrgInviteRestrictEntity(this._client, this.entopts())
  }
  ...
  async remove(
    this: any, reqmatch?: OrgInviteRestrictRemoveMatch, ctrl?: Control,
  ): Promise<OrgInviteRestrictEntity> {
    ...
    try {
      ...
      if (err) {
        ...
        // Promise<OrgInviteRestrictEntity> return stays clean under strict null checks.
