...
class ChecklistEntity extends TrelloEntityBase<Checklist> {
  ...
  constructor(client: TrelloSDK, entopts: any) {
    ...
    this.name = 'checklist'
    this.name_ = 'checklist'
    this.Name = 'Checklist'
  }


  make(this: ChecklistEntity) {
    return new ChecklistEntity(this._client, this.entopts())
  }



  async load(this: any, reqmatch?: ChecklistLoadMatch, ctrl?: Control): Promise<ChecklistEntity> {
    ...
    try {
      ...
      if (err) {
        ...
        // Promise<Checklist> return stays clean under strict null checks.
  ...
  async create(this: any, reqdata?: ChecklistCreateData, ctrl?: Control): Promise<ChecklistEntity> {
  ...
  async update(this: any, reqdata?: ChecklistUpdateData, ctrl?: Control): Promise<ChecklistEntity> {
  ...
  async remove(
    ...
    try {
      ...
      if (err) {
        ...
        // Off-happy-path (throw disabled): typed as any so the method's
        // Promise<ChecklistEntity> return stays clean under strict null checks.
        return undefined as any
      }
    }
  }
