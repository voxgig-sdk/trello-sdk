...
class StickerEntity extends TrelloEntityBase<Sticker> {
  ...
  make(this: StickerEntity) {
    return new StickerEntity(this._client, this.entopts())
  }



  async load(this: any, reqmatch?: StickerLoadMatch, ctrl?: Control): Promise<StickerEntity> {
    ...
    try {
      ...
      if (err) {
        ...
        // Promise<Sticker> return stays clean under strict null checks.
  ...
  async update(this: any, reqdata?: StickerUpdateData, ctrl?: Control): Promise<StickerEntity> {
  ...
  async remove(
    this: any, reqmatch?: StickerRemoveMatch, ctrl?: Control,
    ...
    try {
      ...
      if (err) {
        ...
        // Off-happy-path (throw disabled): typed as any so the method's
        // Promise<StickerEntity> return stays clean under strict null checks.
        return undefined as any
      }
    }
  }
