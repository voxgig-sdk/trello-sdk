...
class IdMemberEntity extends TrelloEntityBase<IdMember> {
  ...
  async remove(
    this: any, reqmatch?: IdMemberRemoveMatch, ctrl?: Control,
  ): Promise<IdMemberEntity> {
