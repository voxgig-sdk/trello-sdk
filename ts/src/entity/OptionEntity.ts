...
class OptionEntity extends TrelloEntityBase<Option> {
  ...
  async load(this: any, reqmatch?: OptionLoadMatch, ctrl?: Control): Promise<OptionEntity> {
  ...
  async remove(
    this: any, reqmatch?: OptionRemoveMatch, ctrl?: Control,
