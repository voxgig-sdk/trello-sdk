...
export interface BoardCreateData {
  ...
  // Selects a custom action instead of the plain create:
  //   'board_plugin' | 'id_tag' | 'label' | 'marked_as_viewed'
  // The remaining keys are that action's own payload.
  $action?: string
  [action: string]: any
}
...
export interface CardCreateData {
  ...
  // Selects a custom action instead of the plain create:
  //   'attachment' | 'checklist' | 'id_label' | 'id_member' | 'label' | 'mark_associated_notifications_read' | 'members_voted' | 'sticker'
  // The remaining keys are that action's own payload.
  $action?: string
  [action: string]: any
}
...
export interface MemberCreateData {
  ...
  // Selects a custom action instead of the plain create:
  //   'avatar' | 'board_background' | 'one_time_messages_dismissed'
  // The remaining keys are that action's own payload.
  $action?: string
  [action: string]: any
}
...
export interface MemberUpdateData {
  ...
  // Selects a custom action instead of the plain update:
  //   'deactivated' | 'deactivated' | 'licensed'
  // The remaining keys are that action's own payload.
  $action?: string
  [action: string]: any
}
