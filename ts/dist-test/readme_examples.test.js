...
const TEST_SEED = { "entity": { "action": { "test01": { "id": "test01" } }, "action_reactions_summary": { "test01": { "id": "test01" } }, "admin": { "test01": { "id": "test01" } }, "application": { "test01": { "id": "test01" } }, "application_compliance": { "test01": { "id": "test01" } }, "associated_domain": { "test01": { "id": "test01" } }, "attachment": { "test01": { "id": "test01" } }, "batch": { "test01": { "id": "test01" } }, "board": { "test01": { "id": "test01" } }, "board_background": { "test01": { "id": "test01" } }, "board_plugin": { "test01": { "id": "test01" } }, "board_star": { "test01": { "id": "test01" } }, "bulk": { "test01": { "id": "test01" } }, "card": { "test01": { "id": "test01" } }, "card_check_item_state": { "test01": { "id": "test01" } }, "card_list": { "test01": { "id": "test01" } }, "check_item": { "test01": { "id": "test01" } }, "checklist": { "test01": { "id": "test01" } }, "claimable_organization": { "test01": { "id": "test01" } }, "custom_board_background": { "test01": { "id": "test01" } }, "custom_emoji": { "test01": { "id": "test01" } }, "custom_field": { "test01": { "id": "test01" } }, "custom_field_item": { "test01": { "id": "test01" } }, "custom_sticker": { "test01": { "id": "test01" } }, "email_position": { "test01": { "id": "test01" } }, "emoji": { "test01": { "id": "test01" } }, "enterpris": { "test01": { "id": "test01" } }, "enterpris_signup_url": { "test01": { "id": "test01" } }, "enterprise_admin": { "test01": { "id": "test01" } }, "enterprise_audit_log": { "test01": { "id": "test01" } }, "export": { "test01": { "id": "test01" } }, "export_download": { "test01": { "id": "test01" } }, "generate": { "test01": { "id": "test01" } }, "id_email_list": { "test01": { "id": "test01" } }, "id_label": { "test01": { "id": "test01" } }, "id_member": { "test01": { "id": "test01" } }, "label": { "test01": { "id": "test01" } }, "list": { "test01": { "id": "test01" } }, "member": { "test01": { "id": "test01" } }, "member_privacy": { "test01": { "id": "test01" } }, "members_voted": { "test01": { "id": "test01" } }, "membership": { "test01": { "id": "test01" } }, "most_recent": { "test01": { "id": "test01" } }, "new_billable_guest": { "test01": { "id": "test01" } }, "notification": { "test01": { "id": "test01" } }, "notification_channel_setting": { "test01": { "id": "test01" } }, "notification_list": { "test01": { "id": "test01" } }, "notification_member_creator": { "test01": { "id": "test01" } }, "notifications_channel_setting": { "test01": { "id": "test01" } }, "option": { "test01": { "id": "test01" } }, "org_invite_restrict": { "test01": { "id": "test01" } }, "organization": { "test01": { "id": "test01" } }, "pending_organization": { "test01": { "id": "test01" } }, "plugin": { "test01": { "id": "test01" } }, "plugin_data": { "test01": { "id": "test01" } }, "plugin_listing": { "test01": { "id": "test01" } }, "reaction": { "test01": { "id": "test01" } }, "read": { "test01": { "id": "test01" } }, "saved_search": { "test01": { "id": "test01" } }, "search": { "test01": { "id": "test01" } }, "show_sidebar": { "test01": { "id": "test01" } }, "show_sidebar_activity": { "test01": { "id": "test01" } }, "show_sidebar_board_action": { "test01": { "id": "test01" } }, "show_sidebar_member": { "test01": { "id": "test01" } }, "sticker": { "test01": { "id": "test01" } }, "tag": { "test01": { "id": "test01" } }, "token": { "test01": { "id": "test01" } }, "transferrable_organization": { "test01": { "id": "test01" } }, "trello_list": { "test01": { "id": "test01" } }, "webhook": { "test01": { "id": "test01" } } } };
...
function isRunnable(code) {
    return (/new\s+TrelloSDK\b/.test(code) ||
        /\bTrelloSDK\.test\b/.test(code) ||
        /\bclient\s*\./.test(code));
}
...
function rewriteForRun(code) {
    ...
    out = out.replace(/new\s+TrelloSDK\s*\([^)]*\)/g, () => SEEDED_CTOR);
    out = out.replace(/TrelloSDK\.test\s*\([^)]*\)/g, () => SEEDED_CTOR);
