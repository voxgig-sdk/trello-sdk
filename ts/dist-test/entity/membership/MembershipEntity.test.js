...
function basicSetup(extra) {
    ...
    let idmap = transform(['membership01', 'membership02', 'membership03', 'board01', 'board02', 'board03', 'enterpris01', 'enterpris02', 'enterpris03', 'organization01', 'organization02', 'organization03'], {
        '`$PACK`': ['', {
                '`$KEY`': '`$COPY`',
