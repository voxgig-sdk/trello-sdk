...
(0, node_test_1.describe)('EnterprisEntity', async () => {
    ...
    (0, node_test_1.test)('basic', async (t) => {
        ...
        (0, node_assert_1.default)(null != enterpris_ref01_data.id);
        // UPDATE
        ...
        (0, node_assert_1.default)(enterpris_ref01_resdata_up0.id === enterpris_ref01_data_up0.id);
        (0, node_assert_1.default)(enterpris_ref01_resdata_up0[enterpris_ref01_markdef_up0.name] === enterpris_ref01_markdef_up0.value);
        // LOAD
        ...
        (0, node_assert_1.default)(enterpris_ref01_data_dt0.id === enterpris_ref01_data.id);
    });
});
function basicSetup(extra) {
    ...
    const entityDataFile = node_path_1.default.resolve(__dirname, '../../../../.sdk/test/entity/enterpris/EnterprisTestData.json');
    ...
    let idmap = transform(['enterpris01', 'enterpris02', 'enterpris03'], {
        '`$PACK`': ['', {
                '`$KEY`': '`$COPY`',
...
//# sourceMappingURL=EnterprisEntity.test.js.map