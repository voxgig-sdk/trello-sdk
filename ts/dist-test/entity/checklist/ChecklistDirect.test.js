...
(0, node_test_1.describe)('ChecklistDirect', async () => {
    ...
    (0, node_test_1.test)('direct-load-checklist', async (t) => {
        if (liveScenariosActive()) {
            t.skip('Covered by live operation scenarios');
            return;
        }
        const setup = directSetup({ id: 'direct01' });
        if ((0, utility_1.maybeSkipControl)(t, 'direct', 'direct-load-checklist', setup.live))
            return;
...
function directSetup(mockres) {
    ...
    if (live) {
        ...
        let idmap = env['TRELLO_TEST_CHECKLIST_ENTID'];
...
//# sourceMappingURL=ChecklistDirect.test.js.map