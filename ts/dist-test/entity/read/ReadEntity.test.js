...
(0, node_test_1.describe)('ReadEntity', async () => {
    ...
    (0, node_test_1.test)('basic', async (t) => {
        ...
        for (const op of ['create']) {
            if ((0, utility_1.maybeSkipControl)(t, 'entityOp', 'read.' + op, live))
                return;
        }
        ...
        (0, node_assert_1.default)(null != read_ref01_data);
    });
});
function basicSetup(extra) {
    ...
    const entityDataFile = node_path_1.default.resolve(__dirname, '../../../../.sdk/test/entity/read/ReadTestData.json');
    ...
    let idmap = transform(['read01', 'read02', 'read03'], {
        '`$PACK`': ['', {
                '`$KEY`': '`$COPY`',
    ...
    const idmapEnvVal = process.env['TRELLO_TEST_READ_ENTID'];
...
//# sourceMappingURL=ReadEntity.test.js.map