...
(0, node_test_1.describe)('CardCheckItemStateEntity', async () => {
    ...
    (0, node_test_1.test)('basic', async (t) => {
        ...
        for (const op of ['load']) {
            if ((0, utility_1.maybeSkipControl)(t, 'entityOp', 'card_check_item_state.' + op, live))
                return;
        }
...
function basicSetup(extra) {
    ...
    const entityDataFile = node_path_1.default.resolve(__dirname, '../../../../.sdk/test/entity/card_check_item_state/CardCheckItemStateTestData.json');
    ...
    let idmap = transform(['card_check_item_state01', 'card_check_item_state02', 'card_check_item_state03'], {
        '`$PACK`': ['', {
                '`$KEY`': '`$COPY`',
    ...
    const idmapEnvVal = process.env['TRELLO_TEST_CARD_CHECK_ITEM_STATE_ENTID'];
...
//# sourceMappingURL=CardCheckItemStateEntity.test.js.map