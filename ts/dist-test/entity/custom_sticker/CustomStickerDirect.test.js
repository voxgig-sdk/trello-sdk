...
(0, node_test_1.describe)('CustomStickerDirect', async () => {
    ...
    (0, node_test_1.test)('direct-load-custom_sticker', async (t) => {
        if (liveScenariosActive()) {
            t.skip('Covered by live operation scenarios');
            return;
        }
        const setup = directSetup({ id: 'direct01' });
        if ((0, utility_1.maybeSkipControl)(t, 'direct', 'direct-load-custom_sticker', setup.live))
            return;
    ...
    (0, node_test_1.test)('direct-list-custom_sticker', async (t) => {
        if (liveScenariosActive()) {
            t.skip('Covered by live operation scenarios');
            return;
        }
        const setup = directSetup([{ id: 'direct01' }, { id: 'direct02' }]);
        if ((0, utility_1.maybeSkipControl)(t, 'direct', 'direct-list-custom_sticker', setup.live))
            return;
...
function directSetup(mockres) {
    ...
    if (live) {
        ...
        let idmap = env['TRELLO_TEST_CUSTOM_STICKER_ENTID'];
...
//# sourceMappingURL=CustomStickerDirect.test.js.map