...
(0, node_test_1.describe)('ShowSidebarEntity', async () => {
    ...
    (0, node_test_1.test)('basic', async (t) => {
        ...
        for (const op of ['update']) {
            if ((0, utility_1.maybeSkipControl)(t, 'entityOp', 'show_sidebar.' + op, live))
                return;
        }
        ...
        (0, node_assert_1.default)(null != show_sidebar_ref01_resdata_up0);
    });
});
function basicSetup(extra) {
    ...
    const entityDataFile = node_path_1.default.resolve(__dirname, '../../../../.sdk/test/entity/show_sidebar/ShowSidebarTestData.json');
    ...
    let idmap = transform(['show_sidebar01', 'show_sidebar02', 'show_sidebar03', 'board01', 'board02', 'board03'], {
        '`$PACK`': ['', {
                '`$KEY`': '`$COPY`',
    ...
    const idmapEnvVal = process.env['TRELLO_TEST_SHOW_SIDEBAR_ENTID'];
...
//# sourceMappingURL=ShowSidebarEntity.test.js.map