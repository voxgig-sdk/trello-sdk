...
(0, node_test_1.describe)('EnterpriseAuditLogEntity', async () => {
    ...
    (0, node_test_1.test)('basic', async (t) => {
        ...
        for (const op of ['list']) {
            if ((0, utility_1.maybeSkipControl)(t, 'entityOp', 'enterprise_audit_log.' + op, live))
                return;
        }
...
function basicSetup(extra) {
    ...
    const entityDataFile = node_path_1.default.resolve(__dirname, '../../../../.sdk/test/entity/enterprise_audit_log/EnterpriseAuditLogTestData.json');
    ...
    let idmap = transform(['enterprise_audit_log01', 'enterprise_audit_log02', 'enterprise_audit_log03', 'enterpris01', 'enterpris02', 'enterpris03'], {
        '`$PACK`': ['', {
                '`$KEY`': '`$COPY`',
    ...
    const idmapEnvVal = process.env['TRELLO_TEST_ENTERPRISE_AUDIT_LOG_ENTID'];
...
//# sourceMappingURL=EnterpriseAuditLogEntity.test.js.map