...
(0, node_test_1.describe)('CustomFieldItemEntity', async () => {
    ...
    (0, node_test_1.test)('basic', async (t) => {
        ...
        for (const op of ['list']) {
            if ((0, utility_1.maybeSkipControl)(t, 'entityOp', 'custom_field_item.' + op, live))
                return;
        }
...
function basicSetup(extra) {
    ...
    const entityDataFile = node_path_1.default.resolve(__dirname, '../../../../.sdk/test/entity/custom_field_item/CustomFieldItemTestData.json');
    ...
    let idmap = transform(['custom_field_item01', 'custom_field_item02', 'custom_field_item03', 'card01', 'card02', 'card03'], {
        '`$PACK`': ['', {
                '`$KEY`': '`$COPY`',
    ...
    const idmapEnvVal = process.env['TRELLO_TEST_CUSTOM_FIELD_ITEM_ENTID'];
...
//# sourceMappingURL=CustomFieldItemEntity.test.js.map