...
(0, node_test_1.describe)('ExportDownloadEntity', async () => {
    ...
    (0, node_test_1.test)('basic', async (t) => {
        ...
        for (const op of ['load']) {
            if ((0, utility_1.maybeSkipControl)(t, 'entityOp', 'export_download.' + op, live))
                return;
        }
...
function basicSetup(extra) {
    ...
    const entityDataFile = node_path_1.default.resolve(__dirname, '../../../../.sdk/test/entity/export_download/ExportDownloadTestData.json');
    ...
    let idmap = transform(['export_download01', 'export_download02', 'export_download03', 'board01', 'board02', 'board03', 'export01', 'export02', 'export03'], {
        '`$PACK`': ['', {
                '`$KEY`': '`$COPY`',
    ...
    const idmapEnvVal = process.env['TRELLO_TEST_EXPORT_DOWNLOAD_ENTID'];
...
//# sourceMappingURL=ExportDownloadEntity.test.js.map