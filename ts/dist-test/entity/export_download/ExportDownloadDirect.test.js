...
(0, node_test_1.describe)('ExportDownloadDirect', async () => {
    ...
    (0, node_test_1.test)('direct-load-export_download', async (t) => {
        if (liveScenariosActive()) {
            t.skip('Covered by live operation scenarios');
            return;
        }
        const setup = directSetup({ id: 'direct01' });
        if ((0, utility_1.maybeSkipControl)(t, 'direct', 'direct-load-export_download', setup.live))
            return;
...
function directSetup(mockres) {
    ...
    if (live) {
        ...
        let idmap = env['TRELLO_TEST_EXPORT_DOWNLOAD_ENTID'];
...
//# sourceMappingURL=ExportDownloadDirect.test.js.map