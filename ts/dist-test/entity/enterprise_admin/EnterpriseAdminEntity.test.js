...
(0, node_test_1.describe)('EnterpriseAdminEntity', async () => {
    ...
    (0, node_test_1.test)('basic', async (t) => {
        ...
        (0, node_assert_1.default)(enterprise_admin_ref01_data_dt0.id === enterprise_admin_ref01_data.id);
    });
});
function basicSetup(extra) {
    ...
    const entityDataFile = node_path_1.default.resolve(__dirname, '../../../../.sdk/test/entity/enterprise_admin/EnterpriseAdminTestData.json');
    ...
    let idmap = transform(['enterprise_admin01', 'enterprise_admin02', 'enterprise_admin03', 'enterpris01', 'enterpris02', 'enterpris03'], {
        '`$PACK`': ['', {
                '`$KEY`': '`$COPY`',
...
//# sourceMappingURL=EnterpriseAdminEntity.test.js.map