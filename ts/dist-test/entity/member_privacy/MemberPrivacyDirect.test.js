...
(0, node_test_1.describe)('MemberPrivacyDirect', async () => {
    ...
    (0, node_test_1.test)('direct-load-member_privacy', async (t) => {
        if (liveScenariosActive()) {
            t.skip('Covered by live operation scenarios');
            return;
        }
        const setup = directSetup({ id: 'direct01' });
        if ((0, utility_1.maybeSkipControl)(t, 'direct', 'direct-load-member_privacy', setup.live))
            return;
...
function directSetup(mockres) {
    ...
    if (live) {
        ...
        let idmap = env['TRELLO_TEST_MEMBER_PRIVACY_ENTID'];
...
//# sourceMappingURL=MemberPrivacyDirect.test.js.map