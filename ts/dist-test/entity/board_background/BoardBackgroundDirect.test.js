...
(0, node_test_1.describe)('BoardBackgroundDirect', async () => {
    ...
    (0, node_test_1.test)('direct-load-board_background', async (t) => {
        if (liveScenariosActive()) {
            t.skip('Covered by live operation scenarios');
            return;
        }
        const setup = directSetup({ id: 'direct01' });
        if ((0, utility_1.maybeSkipControl)(t, 'direct', 'direct-load-board_background', setup.live))
            return;
    ...
    (0, node_test_1.test)('direct-list-board_background', async (t) => {
        if (liveScenariosActive()) {
            t.skip('Covered by live operation scenarios');
            return;
        }
        const setup = directSetup([{ id: 'direct01' }, { id: 'direct02' }]);
        if ((0, utility_1.maybeSkipControl)(t, 'direct', 'direct-list-board_background', setup.live))
            return;
...
function directSetup(mockres) {
    ...
    if (live) {
        ...
        let idmap = env['TRELLO_TEST_BOARD_BACKGROUND_ENTID'];
...
//# sourceMappingURL=BoardBackgroundDirect.test.js.map