...
(0, node_test_1.describe)('BoardBackgroundEntity', async () => {
    ...
    (0, node_test_1.test)('basic', async (t) => {
        ...
        for (const op of ['create', 'list', 'update', 'load', 'remove']) {
            if ((0, utility_1.maybeSkipControl)(t, 'entityOp', 'board_background.' + op, live))
                return;
        }
...
function basicSetup(extra) {
    ...
    let idmap = transform(['board_background01', 'board_background02', 'board_background03', 'member01', 'member02', 'member03', 'member01', 'member02', 'member03', 'custom_board_background01', 'custom_board_background02', 'custom_board_background03'], {
        '`$PACK`': ['', {
                '`$KEY`': '`$COPY`',
    ...
    const idmapEnvVal = process.env['TRELLO_TEST_BOARD_BACKGROUND_ENTID'];
