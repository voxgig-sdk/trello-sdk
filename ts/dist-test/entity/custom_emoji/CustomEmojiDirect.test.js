...
(0, node_test_1.describe)('CustomEmojiDirect', async () => {
    ...
    (0, node_test_1.test)('direct-load-custom_emoji', async (t) => {
        if (liveScenariosActive()) {
            t.skip('Covered by live operation scenarios');
            return;
        }
        const setup = directSetup({ id: 'direct01' });
        if ((0, utility_1.maybeSkipControl)(t, 'direct', 'direct-load-custom_emoji', setup.live))
            return;
    ...
    (0, node_test_1.test)('direct-list-custom_emoji', async (t) => {
        if (liveScenariosActive()) {
            t.skip('Covered by live operation scenarios');
            return;
        }
        const setup = directSetup([{ id: 'direct01' }, { id: 'direct02' }]);
        if ((0, utility_1.maybeSkipControl)(t, 'direct', 'direct-list-custom_emoji', setup.live))
            return;
...
function directSetup(mockres) {
    ...
    if (live) {
        ...
        let idmap = env['TRELLO_TEST_CUSTOM_EMOJI_ENTID'];
...
//# sourceMappingURL=CustomEmojiDirect.test.js.map