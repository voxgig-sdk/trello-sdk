...
(0, node_test_1.describe)('AttachmentDirect', async () => {
    ...
    (0, node_test_1.test)('direct-load-attachment', async (t) => {
        if (liveScenariosActive()) {
            t.skip('Covered by live operation scenarios');
            return;
        }
        const setup = directSetup({ id: 'direct01' });
        if ((0, utility_1.maybeSkipControl)(t, 'direct', 'direct-load-attachment', setup.live))
            return;
    ...
    (0, node_test_1.test)('direct-list-attachment', async (t) => {
        if (liveScenariosActive()) {
            t.skip('Covered by live operation scenarios');
            return;
        }
        const setup = directSetup([{ id: 'direct01' }, { id: 'direct02' }]);
        if ((0, utility_1.maybeSkipControl)(t, 'direct', 'direct-list-attachment', setup.live))
            return;
...
function directSetup(mockres) {
    ...
    if (live) {
        ...
        let idmap = env['TRELLO_TEST_ATTACHMENT_ENTID'];
...
//# sourceMappingURL=AttachmentDirect.test.js.map