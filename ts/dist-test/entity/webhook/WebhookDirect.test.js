...
(0, node_test_1.describe)('WebhookDirect', async () => {
    ...
    (0, node_test_1.test)('direct-load-webhook', async (t) => {
        ...
        if ((0, utility_1.maybeSkipControl)(t, 'direct', 'direct-load-webhook', setup.live))
            return;
        if ((0, utility_1.skipIfMissingIds)(t, setup, ["field01"]))
            return;
    ...
    (0, node_test_1.test)('direct-list-webhook', async (t) => {
        ...
        if ((0, utility_1.maybeSkipControl)(t, 'direct', 'direct-list-webhook', setup.live))
            return;
        if ((0, utility_1.skipIfMissingIds)(t, setup, ["token01"]))
            return;
        const { client, calls } = setup;
        const params = {};
        const query = {};
        if (setup.live) {
            params.token_id = setup.idmap['token01'];
        }
        else {
            params.token_id = 'direct01';
        }
        const result = await client.direct({
            path: 'tokens/{token_id}/webhooks',
            method: 'GET',
...
function directSetup(mockres) {
    ...
    if (live) {
        ...
        let idmap = env['TRELLO_TEST_WEBHOOK_ENTID'];
