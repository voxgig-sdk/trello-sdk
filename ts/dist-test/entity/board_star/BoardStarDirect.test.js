...
(0, node_test_1.describe)('BoardStarDirect', async () => {
    ...
    (0, node_test_1.test)('direct-load-board_star', async (t) => {
        if (liveScenariosActive()) {
            t.skip('Covered by live operation scenarios');
            return;
        }
        const setup = directSetup({ id: 'direct01' });
        if ((0, utility_1.maybeSkipControl)(t, 'direct', 'direct-load-board_star', setup.live))
            return;
    ...
    (0, node_test_1.test)('direct-list-board_star', async (t) => {
        if (liveScenariosActive()) {
            t.skip('Covered by live operation scenarios');
            return;
        }
        const setup = directSetup([{ id: 'direct01' }, { id: 'direct02' }]);
        if ((0, utility_1.maybeSkipControl)(t, 'direct', 'direct-list-board_star', setup.live))
            return;
        if ((0, utility_1.skipIfMissingIds)(t, setup, ["board_star01"]))
            return;
        const { client, calls } = setup;
        const params = {};
        const query = {};
...
function directSetup(mockres) {
    ...
    if (live) {
        ...
        let idmap = env['TRELLO_TEST_BOARD_STAR_ENTID'];
...
//# sourceMappingURL=BoardStarDirect.test.js.map