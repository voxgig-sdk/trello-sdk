...
(0, node_test_1.describe)('BoardStarEntity', async () => {
    ...
    (0, node_test_1.test)('basic', async (t) => {
        ...
        for (const op of ['create', 'list', 'update', 'load', 'remove']) {
            if (!live && (0, utility_1.maybeSkipControl)(t, 'entityOp', 'board_star.' + op, live))
                return;
        }
        ...
        (0, node_assert_1.default)(null != board_star_ref01_data.id);
        // LIST
        ...
        (0, node_assert_1.default)(!isempty(select(board_star_ref01_list, { id: board_star_ref01_data.id })));
        // UPDATE
        ...
        (0, node_assert_1.default)(board_star_ref01_resdata_up0.id === board_star_ref01_data_up0.id);
        (0, node_assert_1.default)(board_star_ref01_resdata_up0[board_star_ref01_markdef_up0.name] === board_star_ref01_markdef_up0.value);
        // LOAD
        ...
        (0, node_assert_1.default)(board_star_ref01_data_dt0.id === board_star_ref01_data.id);
        // REMOVE
        const board_star_ref01_match_rm0 = { id: board_star_ref01_data.id };
        ...
        (0, node_assert_1.default)(isempty(select(board_star_ref01_list_rt0, { id: board_star_ref01_data.id })));
    });
});
function basicSetup(extra) {
    ...
    const entityDataFile = node_path_1.default.resolve(__dirname, '../../../../.sdk/test/entity/board_star/BoardStarTestData.json');
    ...
    let idmap = transform(['board_star01', 'board_star02', 'board_star03', 'member01', 'member02', 'member03'], {
        '`$PACK`': ['', {
                '`$KEY`': '`$COPY`',
...
//# sourceMappingURL=BoardStarEntity.test.js.map