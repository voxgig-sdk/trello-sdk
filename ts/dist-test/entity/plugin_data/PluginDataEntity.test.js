...
(0, node_test_1.describe)('PluginDataEntity', async () => {
    ...
    (0, node_test_1.test)('basic', async (t) => {
        ...
        for (const op of ['list', 'load']) {
            if ((0, utility_1.maybeSkipControl)(t, 'entityOp', 'plugin_data.' + op, live))
                return;
        }
...
function basicSetup(extra) {
    ...
    const entityDataFile = node_path_1.default.resolve(__dirname, '../../../../.sdk/test/entity/plugin_data/PluginDataTestData.json');
    ...
    let idmap = transform(['plugin_data01', 'plugin_data02', 'plugin_data03', 'card01', 'card02', 'card03', 'organization01', 'organization02', 'organization03'], {
        '`$PACK`': ['', {
                '`$KEY`': '`$COPY`',
    ...
    const idmapEnvVal = process.env['TRELLO_TEST_PLUGIN_DATA_ENTID'];
...
//# sourceMappingURL=PluginDataEntity.test.js.map