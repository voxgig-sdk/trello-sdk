...
(0, node_test_1.describe)('PluginDataDirect', async () => {
    ...
    (0, node_test_1.test)('direct-load-plugin_data', async (t) => {
        if (liveScenariosActive()) {
            t.skip('Covered by live operation scenarios');
            return;
        }
        const setup = directSetup({ id: 'direct01' });
        if ((0, utility_1.maybeSkipControl)(t, 'direct', 'direct-load-plugin_data', setup.live))
            return;
    ...
    (0, node_test_1.test)('direct-list-plugin_data', async (t) => {
        if (liveScenariosActive()) {
            t.skip('Covered by live operation scenarios');
            return;
        }
        const setup = directSetup([{ id: 'direct01' }, { id: 'direct02' }]);
        if ((0, utility_1.maybeSkipControl)(t, 'direct', 'direct-list-plugin_data', setup.live))
            return;
...
function directSetup(mockres) {
    ...
    if (live) {
        ...
        let idmap = env['TRELLO_TEST_PLUGIN_DATA_ENTID'];
...
//# sourceMappingURL=PluginDataDirect.test.js.map