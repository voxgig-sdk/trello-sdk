...
(0, node_test_1.describe)('ListDirect', async () => {
    ...
    (0, node_test_1.test)('direct-load-list', async (t) => {
        if (liveScenariosActive()) {
            t.skip('Covered by live operation scenarios');
            return;
        }
        const setup = directSetup({ id: 'direct01' });
        if ((0, utility_1.maybeSkipControl)(t, 'direct', 'direct-load-list', setup.live))
            return;
        if ((0, utility_1.skipIfMissingIds)(t, setup, ["board_id01", "id01"]))
            return;
...
function directSetup(mockres) {
    ...
    if (live) {
        ...
        let idmap = env['TRELLO_TEST_LIST_ENTID'];
