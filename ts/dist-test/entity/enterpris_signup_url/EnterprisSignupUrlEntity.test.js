...
(0, node_test_1.describe)('EnterprisSignupUrlEntity', async () => {
    ...
    (0, node_test_1.test)('basic', async (t) => {
        ...
        for (const op of ['load']) {
            if ((0, utility_1.maybeSkipControl)(t, 'entityOp', 'enterpris_signup_url.' + op, live))
                return;
        }
        ...
        (0, node_assert_1.default)(enterpris_signup_url_ref01_data_dt0.id === enterpris_signup_url_ref01_data.id);
    });
});
function basicSetup(extra) {
    ...
    const entityDataFile = node_path_1.default.resolve(__dirname, '../../../../.sdk/test/entity/enterpris_signup_url/EnterprisSignupUrlTestData.json');
    ...
    let idmap = transform(['enterpris_signup_url01', 'enterpris_signup_url02', 'enterpris_signup_url03'], {
        '`$PACK`': ['', {
                '`$KEY`': '`$COPY`',
    ...
    const idmapEnvVal = process.env['TRELLO_TEST_ENTERPRIS_SIGNUP_URL_ENTID'];
...
//# sourceMappingURL=EnterprisSignupUrlEntity.test.js.map