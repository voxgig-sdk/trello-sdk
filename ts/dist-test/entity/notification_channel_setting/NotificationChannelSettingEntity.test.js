...
function basicSetup(extra) {
    ...
    let idmap = transform(['notification_channel_setting01', 'notification_channel_setting02', 'notification_channel_setting03', 'member01', 'member02', 'member03', 'member01', 'member02', 'member03', 'notifications_channel_setting01', 'notifications_channel_setting02', 'notifications_channel_setting03'], {
        '`$PACK`': ['', {
                '`$KEY`': '`$COPY`',
