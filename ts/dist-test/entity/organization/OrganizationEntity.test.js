...
function basicSetup(extra) {
    ...
    let idmap = transform(['organization01', 'organization02', 'organization03', 'action01', 'action02', 'action03', 'enterpris01', 'enterpris02', 'enterpris03', 'member01', 'member02', 'member03', 'notification01', 'notification02', 'notification03'], {
        '`$PACK`': ['', {
                '`$KEY`': '`$COPY`',
