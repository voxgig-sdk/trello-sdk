...
(0, node_test_1.describe)('TokenDirect', async () => {
    ...
    (0, node_test_1.test)('direct-load-token', async (t) => {
        if (liveScenariosActive()) {
            t.skip('Covered by live operation scenarios');
            return;
        }
        const setup = directSetup({ id: 'direct01' });
        if ((0, utility_1.maybeSkipControl)(t, 'direct', 'direct-load-token', setup.live))
            return;
    ...
    (0, node_test_1.test)('direct-list-token', async (t) => {
        if (liveScenariosActive()) {
            t.skip('Covered by live operation scenarios');
            return;
        }
        const setup = directSetup([{ id: 'direct01' }, { id: 'direct02' }]);
        if ((0, utility_1.maybeSkipControl)(t, 'direct', 'direct-list-token', setup.live))
            return;
...
function directSetup(mockres) {
    ...
    if (live) {
        ...
        let idmap = env['TRELLO_TEST_TOKEN_ENTID'];
...
//# sourceMappingURL=TokenDirect.test.js.map