...
(0, node_test_1.describe)('TrelloListDirect', async () => {
    ...
    (0, node_test_1.test)('direct-load-trello_list', async (t) => {
        if (liveScenariosActive()) {
            t.skip('Covered by live operation scenarios');
            return;
        }
        const setup = directSetup({ id: 'direct01' });
        if ((0, utility_1.maybeSkipControl)(t, 'direct', 'direct-load-trello_list', setup.live))
            return;
    ...
    (0, node_test_1.test)('direct-list-trello_list', async (t) => {
        if (liveScenariosActive()) {
            t.skip('Covered by live operation scenarios');
            return;
        }
        const setup = directSetup([{ id: 'direct01' }, { id: 'direct02' }]);
        if ((0, utility_1.maybeSkipControl)(t, 'direct', 'direct-list-trello_list', setup.live))
            return;
...
function directSetup(mockres) {
    ...
    if (live) {
        ...
        let idmap = env['TRELLO_TEST_TRELLO_LIST_ENTID'];
...
//# sourceMappingURL=TrelloListDirect.test.js.map