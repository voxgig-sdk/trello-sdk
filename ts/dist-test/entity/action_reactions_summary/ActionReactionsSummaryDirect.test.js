...
(0, node_test_1.describe)('ActionReactionsSummaryDirect', async () => {
    ...
    (0, node_test_1.test)('direct-load-action_reactions_summary', async (t) => {
        if (liveScenariosActive()) {
            t.skip('Covered by live operation scenarios');
            return;
        }
        const setup = directSetup({ id: 'direct01' });
        if ((0, utility_1.maybeSkipControl)(t, 'direct', 'direct-load-action_reactions_summary', setup.live))
            return;
...
function directSetup(mockres) {
    ...
    if (live) {
        ...
        let idmap = env['TRELLO_TEST_ACTION_REACTIONS_SUMMARY_ENTID'];
...
//# sourceMappingURL=ActionReactionsSummaryDirect.test.js.map