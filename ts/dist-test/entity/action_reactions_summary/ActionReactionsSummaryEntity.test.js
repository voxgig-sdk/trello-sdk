...
(0, node_test_1.describe)('ActionReactionsSummaryEntity', async () => {
    ...
    (0, node_test_1.test)('basic', async (t) => {
        ...
        for (const op of ['load']) {
            if ((0, utility_1.maybeSkipControl)(t, 'entityOp', 'action_reactions_summary.' + op, live))
                return;
        }
...
function basicSetup(extra) {
    ...
    const entityDataFile = node_path_1.default.resolve(__dirname, '../../../../.sdk/test/entity/action_reactions_summary/ActionReactionsSummaryTestData.json');
    ...
    let idmap = transform(['action_reactions_summary01', 'action_reactions_summary02', 'action_reactions_summary03', 'action01', 'action02', 'action03'], {
        '`$PACK`': ['', {
                '`$KEY`': '`$COPY`',
    ...
    const idmapEnvVal = process.env['TRELLO_TEST_ACTION_REACTIONS_SUMMARY_ENTID'];
...
//# sourceMappingURL=ActionReactionsSummaryEntity.test.js.map