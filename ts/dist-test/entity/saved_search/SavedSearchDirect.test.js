...
(0, node_test_1.describe)('SavedSearchDirect', async () => {
    ...
    (0, node_test_1.test)('direct-load-saved_search', async (t) => {
        if (liveScenariosActive()) {
            t.skip('Covered by live operation scenarios');
            return;
        }
        const setup = directSetup({ id: 'direct01' });
        if ((0, utility_1.maybeSkipControl)(t, 'direct', 'direct-load-saved_search', setup.live))
            return;
    ...
    (0, node_test_1.test)('direct-list-saved_search', async (t) => {
        if (liveScenariosActive()) {
            t.skip('Covered by live operation scenarios');
            return;
        }
        const setup = directSetup([{ id: 'direct01' }, { id: 'direct02' }]);
        if ((0, utility_1.maybeSkipControl)(t, 'direct', 'direct-list-saved_search', setup.live))
            return;
        if ((0, utility_1.skipIfMissingIds)(t, setup, ["member01"]))
            return;
        const { client, calls } = setup;
...
function directSetup(mockres) {
    ...
    if (live) {
        ...
        let idmap = env['TRELLO_TEST_SAVED_SEARCH_ENTID'];
...
//# sourceMappingURL=SavedSearchDirect.test.js.map