...
(0, node_test_1.describe)('NotificationListEntity', async () => {
    ...
    (0, node_test_1.test)('basic', async (t) => {
        ...
        for (const op of ['load']) {
            if ((0, utility_1.maybeSkipControl)(t, 'entityOp', 'notification_list.' + op, live))
                return;
        }
        ...
        (0, node_assert_1.default)(notification_list_ref01_data_dt0.id === notification_list_ref01_data.id);
    });
});
function basicSetup(extra) {
    ...
    const entityDataFile = node_path_1.default.resolve(__dirname, '../../../../.sdk/test/entity/notification_list/NotificationListTestData.json');
    ...
    let idmap = transform(['notification_list01', 'notification_list02', 'notification_list03'], {
        '`$PACK`': ['', {
                '`$KEY`': '`$COPY`',
    ...
    const idmapEnvVal = process.env['TRELLO_TEST_NOTIFICATION_LIST_ENTID'];
...
//# sourceMappingURL=NotificationListEntity.test.js.map