...
(0, node_test_1.describe)('NotificationListDirect', async () => {
    ...
    (0, node_test_1.test)('direct-load-notification_list', async (t) => {
        if (liveScenariosActive()) {
            t.skip('Covered by live operation scenarios');
            return;
        }
        const setup = directSetup({ id: 'direct01' });
        if ((0, utility_1.maybeSkipControl)(t, 'direct', 'direct-load-notification_list', setup.live))
            return;
...
function directSetup(mockres) {
    ...
    if (live) {
        ...
        let idmap = env['TRELLO_TEST_NOTIFICATION_LIST_ENTID'];
...
//# sourceMappingURL=NotificationListDirect.test.js.map