...
(0, node_test_1.describe)('BulkDirect', async () => {
    ...
    (0, node_test_1.test)('direct-load-bulk', async (t) => {
        if (liveScenariosActive()) {
            t.skip('Covered by live operation scenarios');
            return;
        }
        const setup = directSetup({ id: 'direct01' });
        if ((0, utility_1.maybeSkipControl)(t, 'direct', 'direct-load-bulk', setup.live))
            return;
        if ((0, utility_1.skipIfMissingIds)(t, setup, ["enterpris_id01", "id01"]))
            return;
...
//# sourceMappingURL=BulkDirect.test.js.map