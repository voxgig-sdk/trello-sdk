...
(0, node_test_1.describe)('CheckItemEntity', async () => {
    ...
    (0, node_test_1.test)('basic', async (t) => {
        ...
        for (const op of ['update', 'load']) {
            if ((0, utility_1.maybeSkipControl)(t, 'entityOp', 'check_item.' + op, live))
                return;
        }
...
function basicSetup(extra) {
    ...
    let idmap = transform(['check_item01', 'check_item02', 'check_item03', 'card01', 'card02', 'card03', 'card01', 'card02', 'card03', 'checklist01', 'checklist02', 'checklist03'], {
        '`$PACK`': ['', {
                '`$KEY`': '`$COPY`',
