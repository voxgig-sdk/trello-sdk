...
(0, node_test_1.describe)('NotificationEntity', async () => {
    ...
    (0, node_test_1.test)('basic', async (t) => {
        ...
        (0, node_assert_1.default)(notification_ref01_resdata_up0.id === notification_ref01_data_up0.id);
        (0, node_assert_1.default)(notification_ref01_resdata_up0[notification_ref01_markdef_up0.name] === notification_ref01_markdef_up0.value);
        // LOAD
...
function basicSetup(extra) {
    ...
    let idmap = transform(['notification01', 'notification02', 'notification03', 'member01', 'member02', 'member03'], {
        '`$PACK`': ['', {
                '`$KEY`': '`$COPY`',
    ...
    const idmapEnvVal = process.env['TRELLO_TEST_NOTIFICATION_ENTID'];
