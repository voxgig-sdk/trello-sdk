...
(0, node_test_1.describe)('TransferrableOrganizationDirect', async () => {
    ...
    (0, node_test_1.test)('direct-load-transferrable_organization', async (t) => {
        if (liveScenariosActive()) {
            t.skip('Covered by live operation scenarios');
            return;
        }
        const setup = directSetup({ id: 'direct01' });
        if ((0, utility_1.maybeSkipControl)(t, 'direct', 'direct-load-transferrable_organization', setup.live))
            return;
...
function directSetup(mockres) {
    ...
    if (live) {
        ...
        let idmap = env['TRELLO_TEST_TRANSFERRABLE_ORGANIZATION_ENTID'];
...
//# sourceMappingURL=TransferrableOrganizationDirect.test.js.map