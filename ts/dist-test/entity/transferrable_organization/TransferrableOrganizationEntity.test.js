...
(0, node_test_1.describe)('TransferrableOrganizationEntity', async () => {
    ...
    (0, node_test_1.test)('basic', async (t) => {
        ...
        for (const op of ['load']) {
            if ((0, utility_1.maybeSkipControl)(t, 'entityOp', 'transferrable_organization.' + op, live))
                return;
        }
...
function basicSetup(extra) {
    ...
    let idmap = transform(['transferrable_organization01', 'transferrable_organization02', 'transferrable_organization03', 'enterpris01', 'enterpris02', 'enterpris03'], {
        '`$PACK`': ['', {
                '`$KEY`': '`$COPY`',
    ...
    const idmapEnvVal = process.env['TRELLO_TEST_TRANSFERRABLE_ORGANIZATION_ENTID'];
